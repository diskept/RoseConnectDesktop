#include "QobuzAlbumTrackDelegate.h"
...
namespace qobuz {
    ...
    /**
     * @brief QobuzAlbumTrackDelegate::QobuzAlbumTrackDelegate
     * @param section
     * @param flagShowBtn_addCollection
     * @param parent
     */
    QobuzAlbumTrackDelegate::QobuzAlbumTrackDelegate(int section, UseMode useMode, QObject *parent)
    ...
    /**
     * @brief QobuzAlbumTrackDelegate::paint
     * @param painter
     * @param option
     * @param index
     */
    void QobuzAlbumTrackDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const {
        ...
        /*
                ...
                int tmp_titleWidth = (int)(tmp_stretch_width * RATE_TITLE_OF_STRETCH_WIDTH)+100;//cheon210812-work
                //int tmp_titleWidth = (int)(tmp_stretch_width * RATE_TITLE_OF_STRETCH_WIDTH);//cheon210812-work
                ...
                qDebug() << "QobuzAlbumTrackDelegate::paint--data.work---" << data.work;//cheon210812-work
                ...
                }else{//cheon210812-work
                    painter->drawText(rect.left(), rect.top(), tmp_titleWidth, rect.height(), Qt::AlignTop|Qt::AlignLeft, ellipseString( data.work+"-"+data.title, tmp_titleWidth, font_16), &rect);//cheon210812-work
                }
                ...
                if(data.hires == true){
                    ...
                    //rect = option.rect.adjusted(title_width, 25, -width + title_width + 25, -20);
                    rect = option.rect.adjusted(title_width, 25, -width + title_width + 20, -25);
                    //rect = option.rect.adjusted(title_width, 20, -width + title_width + 25, -25);
                ...
                */
                ...
                // to debug
                qobuz::TrackItemData data = ConvertData::convertData_trackItemData(index.data(Qt::UserRole).toJsonObject());//cheon210812-work
                ...
                QString tmp_title = data.work + "-" + data.title;
                if(tmp_title.size() > 90){//cheon210812-work
                ...
                if(data.work ==""){
                    ...
                    if(tmp_title.size() > 90){//cheon210812-work
                        ...
                        painter->drawText(rect.left(), rect.top(), tmp_titleWidth, rect.height()+25, Qt::AlignTop|Qt::AlignLeft, ellipseString(tmp_title, tmp_titleWidth, font_16), &rect);//cheon210812-work
                    }else{
                        painter->drawText(rect.left(), rect.top(), tmp_titleWidth, rect.height(), Qt::AlignTop|Qt::AlignLeft, ellipseString(tmp_title, tmp_titleWidth, font_16), &rect);//cheon210812-work
                    }
                }
                ...
                // MQA image
                if(data.hires == true){
                    int title_width = 800 + 10;//cheon210812-work
                    //int title_width = space_fixed + rect.width() + 10;
                    //rect = option.rect.adjusted(title_width, 25, -width + title_width + 25, -20);
                    rect = option.rect.adjusted(title_width, 25, -width + title_width + 20, -25);
                    //rect = option.rect.adjusted(title_width, 20, -width + title_width + 25, -25);
