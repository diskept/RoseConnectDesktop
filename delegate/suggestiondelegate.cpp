...
/**
 * @brief SuggestionDelegate::SuggestionDelegate : 검색 제안단어 delegate
 * @param parent
 */
...
/**
 * @brief SuggestionDelegate::setInit : 초기 세팅
 */
void SuggestionDelegate::setInit(){
...
/**
 * @brief SuggestionDelegate::paint : 페인트 Draw
 * @param painter
 * @param option
 * @param index
 */
void SuggestionDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const//c220620-search
{
 ...
 * @return
 */
QSize SuggestionDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const{
    Q_UNUSED(option);
    Q_UNUSED(index);
    //return QSize(500,70);
 ...
 * @return
 */
QString SuggestionDelegate::ellipseString(const QString &p_str, const int &p_width, const QFont &p_font) const{
...
/**
 * @brief SuggestionDelegate::editorEvent : 마우스 이벤트 처리
 ...
 * @return
 */
bool SuggestionDelegate::editorEvent(QEvent *event, QAbstractItemModel *model, const QStyleOptionViewItem &option, const QModelIndex &index)//c220629
{
