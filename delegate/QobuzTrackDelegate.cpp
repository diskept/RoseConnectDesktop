...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzTrackDelegate::QobuzTrackDelegate(int section, UseMode useMode, QObject *parent)
     ...
     * @param index
     */
    void QobuzTrackDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const {
