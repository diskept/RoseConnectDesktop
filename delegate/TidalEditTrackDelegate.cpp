#include "TidalEditTrackDelegate.h"
...
//    const int DURATION_WIDTH_MIN = 60;                      ///< Duration 데이터의 최소 보장 사이즈
    ...
    /**
     * @brief TidalEditTrackDelegate::TidalEditTrackDelegate
     * @param parent
     */
    TidalEditTrackDelegate::TidalEditTrackDelegate(QObject *parent)
     ...
     * @param index
     */
    void TidalEditTrackDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const {
