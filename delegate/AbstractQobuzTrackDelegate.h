#ifndef ABSTRACTQOBUZTRACKDELEGATE_H
#define ABSTRACTQOBUZTRACKDELEGATE_H
...
namespace qobuz {
    ...
    /**
     * @brief 일반 트랙 리스트 처리하는 abstract delegate 클래스 (Qobuz, Bugs 파트에서 상속받아서 사용)
     */
    class AbstractQobuzTrackDelegate : public QAbstractItemDelegate
    {
        Q_OBJECT
    public:
        enum ClickMode{
        ...
        enum UseMode_Flag{
            ...
            , Qobuz_Track_Mine = More                           ///< My Created Playlist 에서는 AddCollection 사용하지 않음
        ...
        explicit AbstractQobuzTrackDelegate(int section, UseMode useMode, QObject *parent = nullptr);
    ...
    protected:
        ...
        bool flagShowBtn_like;                  ///< 좋아요 버튼 사용할지 말지의 여부. 기본값은 false. (Qobuz에선 false. Bugs에선 true)
...
#endif // ABSTRACTQOBUZTRACKDELEGATE_H
