#ifndef SHAREFOLDERDELEGATE_H
#define SHAREFOLDERDELEGATE_H
 ...
 */
class SharefolderDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    ...
    explicit SharefolderDelegate(QObject *parent = nullptr);
