...
namespace tidal {
    ...
    const QString TIDAL_API_PATH_PLAYLIST = "featured/top/playlists";
    const QString TIDAL_API_PATH_VIDEO = "featured/top/videos";

    const QString TIDAL_MAIN_TITLE = "TOP";
    const QString TIDAL_SUB_TITLE___album = "Top Albums";
    const QString TIDAL_SUB_TITLE___track = "Top Tracks";
    const QString TIDAL_SUB_TITLE___playlist = "Top Playlists";
    const QString TIDAL_SUB_TITLE___video = "Top Videos";
     ...
     * @param parent
     */
    TidalTop20Main::TidalTop20Main(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_filter, parent){
     ...
     * @param jsonObj
     */
    void TidalTop20Main::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(pageCode != this->page){
            ...
            connect(proc_album, &ProcCommon::completeReq_list_albums, this, &TidalTop20Main::slot_applyResult_albums);
            proc_album->request_tidal_getList_albums(TIDAL_API_PATH_ALBUM, 10, 0);

            ProcCommon *proc_track = new ProcCommon(this);
            connect(proc_track, &ProcCommon::completeReq_list_tracks, this, &TidalTop20Main::slot_applyResult_tracks);
            proc_track->request_tidal_getList_tracks(TIDAL_API_PATH_TRACK, 5, 0);

//            ProcCommon *proc_playlist = new ProcCommon(this);
//            connect(proc_playlist, &ProcCommon::completeReq_list_playlists, this, &TidalTop20Main::slot_applyResult_playlists);
//            proc_playlist->request_tidal_getList_playlists(TIDAL_API_PATH_PLAYLIST,10,0);

            ProcCommon *proc_video = new ProcCommon(this);
            connect(proc_video, &ProcCommon::completeReq_list_videos, this, &TidalTop20Main::slot_applyResult_videos);
    ...
    void TidalTop20Main::setActivePage(){
        ...
        if(this->flagNeedReload == true){
            ...
            for(int i = 0; i < 10; i++){
                this->top20_album[i] = new tidal::ItemAlbum(i, SECTION_FOR_MORE_POPUP___albums, tidal::AbstractItem::ImageSizeMode::Square_200x200);
                connect(this->top20_album[i], &tidal::ItemAlbum::signal_clicked, this, &TidalTop20Main::slot_clickedItemAlbum);
            }

            for (int i = 0; i < 5; i++) {
                this->top20_track[i] = new PlaylistTrackDetailInfo_RHV;
                connect(this->top20_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &TidalTop20Main::slot_clickedItemTrack_inList);
                this->top20_track[i]->setProperty("index", i);
                this->top20_track[i]->setObjectName("top20_tracks");
            }

//            for(int i = 0; i < 10; i++){
//                this->top20_playlist[i] = new tidal::ItemPlaylist(i, SECTION_FOR_MORE_POPUP___playlists, tidal::AbstractItem::ImageSizeMode::Square_200x200);
//                connect(this->top20_playlist[i], &tidal::ItemPlaylist::signal_clicked, this, &TidalTop20Main::slot_clickedItemPlaylist);
//            }

            for(int i = 0; i < 10; i++){
                this->top20_video[i] = new tidal::ItemVideo(i, SECTION_FOR_MORE_POPUP___videos, tidal::AbstractItem::ImageSizeMode::Ractangle_284x157);
                connect(this->top20_video[i], &tidal::ItemVideo::signal_clicked, this, &TidalTop20Main::slot_clickedItemVideo);
            }
        }
    }
    ...
    void TidalTop20Main::setUIControl_appendWidget(){
        ...
        if(this->flag_album[0] == true && this->flag_track[0] == true /*&& this->flag_playlist[0] == true*/ && this->flag_video[0] == true){
            ...
            if(this->flag_track[1] == true){
                ...
                this->widget_track = this->setUIControl_subTitle_withSideBtn(QString("Top Tracks (%1)").arg(this->list_track->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_tracks, this->vBox_track);
                ...
                for(int i = 0; i < maxCount; i++){
                    this->top20_track[i]->setDataTrackInfo_Tidal(this->list_track->at(i));
                    this->top20_track[i]->resize(1550, 70);

                    this->vBox_track->addWidget(this->top20_track[i]);
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &TidalTop20Main::slot_applyResult_getRating_track);
                proc_fav_track->request_rose_getRating_Track("TIDAL", tmp_clientkey);
            }
            else{
                this->widget_track = new QWidget();
                this->widget_track = this->setUIControl_subTitle_withSideBtn(QString("Top Tracks (0)"), "View All", BTN_IDX_SUBTITLE_tracks, this->vBox_track);
            ...
            if(this->flag_album[1] == true){
                ...
                this->widget_album = this->setUIControl_subTitle_withSideBtn(QString("Top Albums (%1)").arg(this->list_album->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_albums, this->vBox_album);
                ...
                for(int i = 0; i < this->list_album->size(); i++){
                    this->top20_album[i]->setData(this->list_album->at(i));
                    this->hBox_album->addWidget(this->top20_album[i]);
                }
                ...
                this->widget_album = new QWidget();
                this->widget_album = this->setUIControl_subTitle_withSideBtn(QString("Top Albums (0)"), "View All", BTN_IDX_SUBTITLE_albums, this->vBox_album);
...
//                this->widget_playlist = this->setUIControl_subTitle_withSideBtn(QString("Top Playlists (%1)").arg(this->list_playlist->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_playlists, this->vBox_playlist);
...
//                    this->top20_playlist[i]->setData(this->list_playlist->at(i));
//                    this->hBox_playlist->addWidget(this->top20_playlist[i]);
//                }
...
//            else{
//                this->widget_playlist = new QWidget();
//                this->widget_playlist = this->setUIControl_subTitle_withSideBtn(QString("Top Playlists (0)"), "View All", BTN_IDX_SUBTITLE_playlists, this->vBox_playlist);
...
//            }
            ...
            if(this->flag_video[1] == true){
                ...
                this->widget_video = this->setUIControl_subTitle_withSideBtn(QString("Top Videos (%1)").arg(this->list_video->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_videos, this->vBox_video);
                this->vBox_video->addSpacing(10);

                this->hBox_video = this->setUIControl_hBoxLayout_forVideo(this->vBox_video);

                int max = list_video->size();
                if(max > 10){
                    max = 10;
                }

                for(int i = 0; i < max; i++){
                    this->top20_video[i]->setData(this->list_video->at(i));
                    this->hBox_video->addWidget(this->top20_video[i]);
                }
                ...
                this->widget_video = new QWidget();
                this->widget_video = this->setUIControl_subTitle_withSideBtn(QString("Top Videos (0)"), "View All", BTN_IDX_SUBTITLE_videos, this->vBox_video);
    ...
    QWidget* TidalTop20Main::setUIControl_subTitle_withSideBtn(const QString subTitle, const QString btnText, const int btnId, QLayout *p_layout){
    ...
    QHBoxLayout* TidalTop20Main::setUIControl_hBoxLayout_forAlbum(QLayout *p_layout){
    ...
    QHBoxLayout* TidalTop20Main::setUIControl_hBoxLayout_forPlaylists(QLayout *p_layout){
    ...
    QHBoxLayout* TidalTop20Main::setUIControl_hBoxLayout_forVideo(QLayout *p_layout){
    ...
    void TidalTop20Main::slot_clickBtn_subTitle_viewAll(){
    ...
    void TidalTop20Main::slot_tidal_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        ...
        if(p_jsonObj.contains("flagOk") && ProcJsonEasy::get_flagOk(p_jsonObj)){
            ...
            if(this->flag_send_track == true){
                ...
                if(status == true && this->flag_track_fav == false){
                    ...
                    connect(proc, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalTop20Main::slot_tidal_completeReq_listAll_myFavoritesIds);
    ...
    void TidalTop20Main::slot_applyResult_checkRating_track(const QJsonObject &jsonObj){
        ...
        if(jsonObj.contains("id")){
            ...
            if(id > 0){
                ...
                // request HTTP API - get favorite for Rose Server
                roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
                connect(proc_fav_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalTop20Main::slot_applyResult_addRating_track);
    ...
    void TidalTop20Main::slot_applyResult_addRating_track(const QJsonObject &jsonObj){
    ...
    void TidalTop20Main::slot_applyResult_getRating_track(const QJsonArray &contents){
        ...
        if(contents.size() > 0){
            ...
            if(track_info.contains("star")){
                for(int i = 0; i < contents.size(); i++){
                    ...
                    this->top20_track[i]->setFavoritesIds(flag, star);
                }
            }
    ...
    void TidalTop20Main::slot_applyResult_playlists(const QList<tidal::PlaylistItemData>& list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TidalTop20Main::slot_applyResult_videos(const QList<tidal::VideoItemData>& list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void TidalTop20Main::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                this->track_star_fav = this->top20_track[idx]->getFavoritesStars();
                ...
                connect(proc_fav, &ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalTop20Main::slot_tidal_completeReq_listAll_myFavoritesIds);
                ...
                connect(proc_favCheck_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalTop20Main::slot_applyResult_checkRating_track);
                proc_favCheck_track->request_rose_checkRating_Track("TIDAL", QString("%1").arg(this->track_id_fav));
                this->flag_check_track = true;

                this->top20_track[idx]->setFavoritesIds(this->flag_track_fav, this->track_star_fav);
            }
    ...
    void TidalTop20Main::slot_clickedItemPlaylist(const ItemPlaylist::ClickMode clickMode){
    ...
    void TidalTop20Main::slot_clickedItemVideo(const AbstractItem::ClickMode clickMode){
