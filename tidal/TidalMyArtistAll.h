...
namespace tidal {
    ...
    /**
     * @brief RoseHome의 최근 재생 아티스트 전체보기 화면 클래스
     */
    class TidalRecenltyArtistAll : public AbstractTidalSubWidget
    {
        Q_OBJECT
    public:
        explicit TidalRecenltyArtistAll(QWidget *parent = nullptr);
        ~TidalRecenltyArtistAll();
    ...
    */
    class TidalArtistHistoryAll : public AbstractTidalSubWidget
    {
        Q_OBJECT
    public:
        explicit TidalArtistHistoryAll(QWidget *parent = nullptr);
        ~TidalArtistHistoryAll();
