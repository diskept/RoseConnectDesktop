#ifndef TIDALNEWMAIN_H
#define TIDALNEWMAIN_H
...
namespace tidal {
    ...
    /**
     * @brief Tidal > 탐색 > New 선택한 화면
     */
    class TidalNewMain : public AbstractTidalSubWidget
    {
        Q_OBJECT
    public:
        explicit TidalNewMain(QWidget *parent = nullptr);
        ~TidalNewMain();
    ...
    private :
        ...
        PlaylistTrackDetailInfo_RHV *new_track[5];
        tidal::ItemAlbum *new_album[10];
        tidal::ItemPlaylist *new_playlist[10];
        tidal::ItemVideo *new_video[10];
