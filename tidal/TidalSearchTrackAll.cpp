...
namespace tidal {
     ...
     * @param parent
     */
    TidalSearchTrackAll::TidalSearchTrackAll(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_rosefilter, parent) {
     ...
     * @brief 소멸자.
     */
    TidalSearchTrackAll::~TidalSearchTrackAll(){
    ...
    void TidalSearchTrackAll::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(btn_playAll, &QPushButton::clicked, this, &TidalSearchTrackAll::slot_btnClicked_playAll);
            ...
            connect(btn_shuffleAll, &QPushButton::clicked, this, &TidalSearchTrackAll::slot_btnClicked_playShuffle);
     ...
     * @brief 기본 UI 구성함
     */
    void TidalSearchTrackAll::setUIControl_tracks(){
        ...
        connect(this->chooseFilterOpt, &bugs::BugsChooseFilterOpt::signal_clicked_filterOpt, this, &TidalSearchTrackAll::slot_chooseFilterOption);
     ...
     */
    void TidalSearchTrackAll::setUiControl_filter(){
        ...
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &TidalSearchTrackAll::slot_filterClicked);
     ...
     * @brief 데이터 , UI 초기화
     */
    void TidalSearchTrackAll::initAll(){
     ...
     * @param event
     */
    void TidalSearchTrackAll::resizeEvent(QResizeEvent *event){
     ...
     */
    void TidalSearchTrackAll::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void TidalSearchTrackAll::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
    ...
    void TidalSearchTrackAll::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->track_listAll[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &TidalSearchTrackAll::slot_clickedItemTrack_inList);
    ...
    void TidalSearchTrackAll::slot_applyResult_tracks(const QList<tidal::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            if(start_index == 0){
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &TidalSearchTrackAll::slot_applyResult_getRating_track);
    ...
    void TidalSearchTrackAll::slot_tidal_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        ...
        if(p_jsonObj.contains("flagOk") && ProcJsonEasy::get_flagOk(p_jsonObj)){
            ...
            if(this->flag_send_track == true){
                ...
                if(status == true && this->flag_track_fav == false){
                    ...
                    ProcCommon *proc = new ProcCommon(this);
                    connect(proc, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalSearchTrackAll::slot_tidal_completeReq_listAll_myFavoritesIds);
    ...
    void TidalSearchTrackAll::slot_applyResult_checkRating_track(const QJsonObject &jsonObj){
        ...
        if(id <= 0){
            ...
            // request HTTP API - get favorite for Rose Server
            roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
            connect(proc_fav_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalSearchTrackAll::slot_applyResult_addRating_track);
    ...
    void TidalSearchTrackAll::slot_applyResult_addRating_track(const QJsonObject &jsonObj){
    ...
    void TidalSearchTrackAll::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void TidalSearchTrackAll::slot_btnClicked_playAll(){

        // 전체재생
        ProcRosePlay_withTidal *procRosePlay = new ProcRosePlay_withTidal(this);
        procRosePlay->requestPlayRose_byTracks(jsonArr_tracks_toPlay,0, OptMorePopup::ClickMode::Play_RightNow, ProcRosePlay_withTidal::PlayShuffleMode::JustPlay);
    }


    void TidalSearchTrackAll::slot_btnClicked_playShuffle(){

        // 셔플재생
        ProcRosePlay_withTidal *procRosePlay = new ProcRosePlay_withTidal(this);
        procRosePlay->requestPlayRose_byTracks(jsonArr_tracks_toPlay,0, OptMorePopup::ClickMode::Play_RightNow, ProcRosePlay_withTidal::PlayShuffleMode::ShufflePlay);
    }
     ...
     * @param clickMode
     */
    void TidalSearchTrackAll::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                connect(proc_fav, &ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalSearchTrackAll::slot_tidal_completeReq_listAll_myFavoritesIds);
                ...
                connect(proc_favCheck_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalSearchTrackAll::slot_applyResult_checkRating_track);
            ...
            this->proc_clicked_itemTrack_inList(this->list_track, this->jsonArr_tracks_toPlay, clickMode, idx, SECTION_FOR_MORE_POPUP___search_tracks);
        }
    }
    ...
    void TidalSearchTrackAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
        ...
        if(section == SECTION_FOR_MORE_POPUP___search_tracks){
