#ifndef TIDALHISTORYDETAIL_H
#define TIDALHISTORYDETAIL_H
...
namespace tidal {
     ...
     */
    class TidalHistoryDetail : public AbstractTidalSubWidget
    {
        Q_OBJECT
    public:
        explicit TidalHistoryDetail(QWidget *parent = nullptr);
        ~TidalHistoryDetail();
