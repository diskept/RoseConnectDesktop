...
namespace tidal {
     ...
     * @param parent
     */
    TidalVideoListAll::TidalVideoListAll(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_viewAll, parent) {
     ...
     * @brief 소멸자.
     */
    TidalVideoListAll::~TidalVideoListAll(){
     ...
     * @param jsonObj
     */
    void TidalVideoListAll::setJsonObject_forData(const QJsonObject &jsonObj){

        tidal::PageInfo_VideoAllView data_pageInfo = ConvertData::convertData_pageInfo_videoAllView(jsonObj);
     ...
     * @brief 화면 활성화
     */
    void TidalVideoListAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void TidalVideoListAll::setUIControl_video(){
     ...
     */
    void TidalVideoListAll::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void TidalVideoListAll::request_more_videoData(){
        ...
        if(!this->flagReqMore_video && !this->flag_lastPage_video){
            ...
            connect(proc, &ProcCommon::completeReq_list_videos, this, &TidalVideoListAll::slot_applyResult_videos);
            proc->request_tidal_getList_videos(this->api_subPath, this->video_widget_cnt, this->next_offset);             // 우선 최대 30까지만.
    ...
    void TidalVideoListAll::request_more_videoDraw(){
        ...
        for(int i = start_index; i < this->video_draw_cnt; i++){
            ...
            connect(this->listVideo_all[i], &tidal::ItemVideo::signal_clicked, this, &TidalVideoListAll::slot_clickedItemVideo);
        }
     ...
     * @param list_data
     */
    void TidalVideoListAll::slot_applyResult_videos(const QList<tidal::VideoItemData> &list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void TidalVideoListAll::slot_clickedItemVideo(const AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void TidalVideoListAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
