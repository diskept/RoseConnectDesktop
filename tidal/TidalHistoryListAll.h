#ifndef TIDALHISTORYLISTALL_H
#define TIDALHISTORYLISTALL_H
...
namespace tidal {
     ...
     */
    class TidalHistoryListAll : public AbstractTidalSubWidget
    {
        Q_OBJECT
    public:
        explicit TidalHistoryListAll(QWidget *parent = nullptr);
        ~TidalHistoryListAll();
