...
namespace tidal {
     ...
     */
    ItemImage_Video::ItemImage_Video(int imageWidth, int imageHeight, QWidget *parent)
     ...
     * @return
     */
    QString ItemImage_Video::getImagePath_default(){
        //return ":images/def_tube_340.png";
        return ":images/tidal/tidal_def_video.png";
    }
     ...
     */
    void ItemImage_Video::setUIControl_duration(){
     ...
     * @param duration
     */
    void ItemImage_Video::setDuration(const int duration){
        if(duration > 0){
