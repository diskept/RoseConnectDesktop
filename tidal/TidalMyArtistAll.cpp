...
namespace tidal {
     ...
     * @param parent
     */
    TidalMyArtistAll::TidalMyArtistAll(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_viewAll, parent) {
     ...
     * @brief 소멸자.
     */
    TidalMyArtistAll::~TidalMyArtistAll(){

        this->deleteLater();
    }


    void TidalMyArtistAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void TidalMyArtistAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void TidalMyArtistAll::setUIControl_artists(){
        ...
        connect(this->chooseFilterOpt, &bugs::BugsChooseFilterOpt::signal_clicked_filterOpt, this, &TidalMyArtistAll::slot_chooseFilterOption);
        this->chooseFilterOpt->hideFilterBox();
    }


    /**
     * @brief TidalMyArtistAll::setUIControl_filter
     */
    void TidalMyArtistAll::setUIControl_filter(){
        // 필터링 부분
        this->filterWidget = new FilterWidget();
        QString def_code = this->list_filterOpt_sort.first().opt_code.toString();
        QString def_name = this->list_filterOpt_sort.first().opt_name;
        this->filterWidget->add_filter(def_code, def_name);
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &TidalMyArtistAll::slot_filterClicked);
     ...
     */
    void TidalMyArtistAll::proc_wheelEvent_to_getMoreData(){

        if((this->artist_total_cnt > this->artist_draw_cnt) && (this->flag_artist_draw == false)
     ...
     * @param event
     */
    void TidalMyArtistAll::resizeEvent(QResizeEvent *event){
     ...
     */
    void TidalMyArtistAll::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void TidalMyArtistAll::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
     ...
     * @param page
     */
    void TidalMyArtistAll::request_more_artistData(){
        ...
        if(!this->flagReqMore_artist && !this->flag_lastPage_artist){
            ...
            connect(proc, &ProcCommon::completeReq_list_myFavoriteArtists, this, &TidalMyArtistAll::slot_applyResult_myFavoriteArtists);
            proc->request_tidal_getList_myFavoriteArtists(sortOpt, orderDirection, this->artist_draw_cnt, this->next_offset);
        }
    }


    void TidalMyArtistAll::request_more_artistDraw(){
        ...
        for(int i = start_index; i < this->artist_draw_cnt; i++){
            ...
            connect(this->listArtist_all[i], &tidal::ItemArtist::signal_clicked, this, &TidalMyArtistAll::slot_clickedItemArtist);
        }
     ...
     * @param list_data
     */
    void TidalMyArtistAll::slot_applyResult_myFavoriteArtists(const QList<tidal::ArtistItemData> &list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void TidalMyArtistAll::slot_clickedItemArtist(const AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void TidalMyArtistAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
    ...
    /**
     * @brief TidalRecenltyArtistAll::TidalRecenltyArtistAll
     * @param parent
     */
    TidalRecenltyArtistAll::TidalRecenltyArtistAll(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_roseviewAll, parent) {
     ...
     * @brief 소멸자.
     */
    TidalRecenltyArtistAll::~TidalRecenltyArtistAll(){
     ...
     * @param jsonObj
     */
    void TidalRecenltyArtistAll::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(this->page != pageCode || this->title != mainTitle){
            ...
            connect(proc, &roseHome::ProcCommon::completeReq_list_artists, this, &TidalRecenltyArtistAll::slot_applyResult_artistlistCheck);
            proc->request_rose_getList_recentlyArtists("member/artist/recent", "TIDAL", 0, 10);
        }
    }
     ...
     * HTTP API 호출한다.
     */
    void TidalRecenltyArtistAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void TidalRecenltyArtistAll::setUIControl_artists(){
        ...
        connect(this->btn_mainTitle, &QPushButton::clicked, this, &TidalRecenltyArtistAll::slot_btnClicked_Delete);
     ...
     * @brief 데이터 , UI 초기화
     */
    void TidalRecenltyArtistAll::initAll(){
     ...
     * @brief 스크롤링에 대해서, get more data 처리
     */
    void TidalRecenltyArtistAll::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void TidalRecenltyArtistAll::request_more_artistData(){
        ...
        // request HTTP API
        roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
        connect(proc, &roseHome::ProcCommon::completeReq_list_artists, this, &TidalRecenltyArtistAll::slot_applyResult_recentlyArtists);
        proc->setProperty("idx", this->next_offset);
        proc->request_rose_getList_recentlyArtists("member/artist/recent", "TIDAL", next_offset, 200);
    ...
    void TidalRecenltyArtistAll::request_more_artistDraw(){
        ...
        for(int i = start_index; i < this->artist_draw_cnt; i++){
            this->flowLayout_artists->addWidget(this->listArtist_all[i]);
            connect(this->listArtist_all[i], &roseHome::ItemArtist_rosehome::signal_clicked, this, &TidalRecenltyArtistAll::slot_clickedItemArtist);
        }
     ...
     * @param list_data
     */
    void TidalRecenltyArtistAll::slot_applyResult_recentlyArtists(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TidalRecenltyArtistAll::slot_applyResult_artistlistCheck(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TidalRecenltyArtistAll::slot_btnClicked_Delete(){
     ...
     * @param clickMode
     */
    void TidalRecenltyArtistAll::slot_clickedItemArtist(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void TidalRecenltyArtistAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
    ...
    /**
     * @brief TidalRecenltyArtistAll::resizeEvent
     * @param event
     */
    void TidalRecenltyArtistAll::resizeEvent(QResizeEvent *event){
        Q_UNUSED(event);
    ...
    /**
     * @brief TidalArtistHistoryAll::RoseHomeartistListAll
     * @param parent
     */
    TidalArtistHistoryAll::TidalArtistHistoryAll(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_roseviewAll, parent) {
     ...
     * @brief 소멸자.
     */
    TidalArtistHistoryAll::~TidalArtistHistoryAll(){
     ...
     * @param jsonObj
     */
    void TidalArtistHistoryAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void TidalArtistHistoryAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void TidalArtistHistoryAll::setUIControl_artists(){
     ...
     * @brief 스크롤링에 대해서, get more data 처리
     */
    void TidalArtistHistoryAll::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void TidalArtistHistoryAll::request_more_artistData(){
        ...
        connect(proc_artist, &roseHome::ProcCommon::completeReq_list_artists, this, &TidalArtistHistoryAll::slot_applyResult_historyArtist);
    ...
    void TidalArtistHistoryAll::request_more_artistDraw(){
        ...
        for(int i = start_index; i < this->artist_draw_cnt; i++){
            connect(this->listArtist_all[i], &roseHome::ItemArtist_rosehome::signal_clicked, this, &TidalArtistHistoryAll::slot_clickedItemArtist);
            this->flowLayout_artists->addWidget(this->listArtist_all[i]);
        }
     ...
     * @param list_data
     */
    void TidalArtistHistoryAll::slot_applyResult_historyArtist(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
...
//            }
     ...
     * @param clickMode
     */
    void TidalArtistHistoryAll::slot_clickedItemArtist(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void TidalArtistHistoryAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
     ...
     * @param event
     */
    void TidalArtistHistoryAll::resizeEvent(QResizeEvent *event){
