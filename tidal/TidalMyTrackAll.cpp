...
namespace tidal {
     ...
     * @param parent
     */
    TidalMyTrackAll::TidalMyTrackAll(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll, parent) {
    ...
    void TidalMyTrackAll::setUIControl_tracks(){
        ...
        // delegate & listWidget for tracks
        this->delegate = new TidalTrackDelegate(SECTION_FOR_MORE_POPUP___tracks, TidalTrackDelegate::Tidal_Track_General, this);
        connect(delegate, &TidalTrackDelegate::clicked, this, &TidalMyTrackAll::slot_clickedItemTrack_inList);
     ...
     */
    void TidalMyTrackAll::slot_thumbnailDownloaded_fotListWidget_track(){
     ...
     * @param clickMode
     */
    void TidalMyTrackAll::slot_clickedItemTrack_inList(const int idx, const tidal::TidalTrackDelegate::ClickMode clickMode){
    ...
    void TidalRecentlyTrackAll::slot_qobuz_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        ...
        if(p_jsonObj.contains("flagOk") && ProcJsonEasy::get_flagOk(p_jsonObj)){
            ...
            if(this->flag_send_track == true){
                if((status == true && this->flag_track_fav == false) || (status == false && this->flag_track_fav == true)){
                    ...
                    //ProcCommon *proc = new ProcCommon(this);
                    //connect(proc, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalRecentlyTrackAll::slot_qobuz_completeReq_listAll_myFavoritesIds);
