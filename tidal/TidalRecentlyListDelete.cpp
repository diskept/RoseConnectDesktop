...
namespace tidal {
     ...
     * @param parent
     */
    TidalRecentlyListDelete::TidalRecentlyListDelete(QWidget *parent) : AbstractTidalSubWidget(VerticalScroll_rosefilter, parent) {
    ...
    * @brief 소멸자.
    */
    TidalRecentlyListDelete::~TidalRecentlyListDelete(){
     ...
     * @param jsonObj
     */
    void TidalRecentlyListDelete::setJsonObject_forData(const QJsonObject &jsonObj){
    ...
    /**
     * @brief TidalRecentlyListDelete::setActivePage
     */
    void TidalRecentlyListDelete::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void TidalRecentlyListDelete::setUIControl_lists(){
        ...
        connect(this->btn_deleteAll, &QPushButton::clicked, this, &TidalRecentlyListDelete::slot_clicked_DeleteAll);
        ...
        connect(this->btn_delete, &QPushButton::clicked, this, &TidalRecentlyListDelete::slot_clicked_Delete);
        ...
        connect(this->btn_selectAll, &QPushButton::clicked, this, &TidalRecentlyListDelete::slot_clicked_btnSelectAll);
        ...
        connect(this->checkbox_selectAll, &QCheckBox::stateChanged, this, &TidalRecentlyListDelete::slot_clickedSelected);
     ...
     */
    void TidalRecentlyListDelete::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void TidalRecentlyListDelete::request_more_listData(){
        ...
        if(!this->flagReqMore_data && !this->flag_lastPage_data){
            ...
            if(this->list_type == "ALBUM"){
                ...
                connect(proc, &roseHome::ProcCommon::completeReq_list_albums, this, &TidalRecentlyListDelete::slot_applyResult_albumlists);
                ...
                connect(proc_recently, &roseHome::ProcCommon::completeReq_list_playlists, this, &TidalRecentlyListDelete::slot_applyResult_playlistLists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_rosetubes, this, &TidalRecentlyListDelete::slot_applyResult_rosetubelists);
                proc->request_rose_getList_recentlyRosetube("member/track/recent", "YOUTUBE", this->next_offset, 50);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_tracks, this, &TidalRecentlyListDelete::slot_applyResult_tracklists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_artists, this, &TidalRecentlyListDelete::slot_applyResult_artistlists);
    ...
    void TidalRecentlyListDelete::request_more_listDraw(){
    ...
    inline void TidalRecentlyListDelete::iniDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
    ...
    inline void TidalRecentlyListDelete::setDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
     ...
     * @param list_data
     */
    void TidalRecentlyListDelete::slot_applyResult_albumlists(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void TidalRecentlyListDelete::slot_applyResult_playlistLists(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void TidalRecentlyListDelete::slot_applyResult_rosetubelists(const QJsonArray &jsonArr_dataToPlay, const int &totalCnt, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void TidalRecentlyListDelete::slot_applyResult_tracklists(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void TidalRecentlyListDelete::slot_applyResult_artistlists(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TidalRecentlyListDelete::slot_thumbnailDownload_list(){
    ...
    void TidalRecentlyListDelete::slot_clickedSelected(int state){
    ...
    void TidalRecentlyListDelete::slot_clicked_btnSelectAll(){
    ...
    void TidalRecentlyListDelete::slot_clicked_Delete(){
        ...
        if(this->selectIds.count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "album", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "playlist", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "track", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "artist", "", "Ids", this->selectIds);
            }
        }
    }


    void TidalRecentlyListDelete::slot_clicked_DeleteAll(){
        ...
        if(this->listWidget_recentlyList->count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "album", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "playlist", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "track", "YOUTUBE", "All", this->selectIds);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "track", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &TidalRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("TIDAL", "artist", this->filter_type, "All", this->selectIds);
            }
        }
    }


    bool TidalRecentlyListDelete::selectDelete_DialogConfirm(const QString type){
    ...
    void TidalRecentlyListDelete::slot_applyResult_getDeleteList(const bool flag){
    ...
    /**
     * @brief TidalRecentlyListDelete::resizeEvent
     * @param event
     */
    void TidalRecentlyListDelete::resizeEvent(QResizeEvent *event){
        Q_UNUSED(event);
