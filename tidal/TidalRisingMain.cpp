...
namespace tidal {
     ...
     * @param parent
     */
    TidalRisingMain::TidalRisingMain(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll, parent){
    ...
    void TidalRisingMain::setActivePage(){
        ...
        if(this->flagInitDraw){
            ...
            connect(proc, &ProcCommon::completeReq_list_albums, this, &TidalRisingMain::slot_applyResult_albums);
            connect(proc, &ProcCommon::completeReq_list_tracks, this, &TidalRisingMain::slot_applyResult_tracks);
     ...
     */
    void TidalRisingMain::setUIControl_track(){
        ...
        connect(delegate, &TidalTrackDelegate::clicked, this, &TidalRisingMain::slot_clickedItemTrack_inList);
     ...
     */
    void TidalRisingMain::setUIControl_album(){
     ...
     */
    void TidalRisingMain::slot_thumbnailDownloaded_fotListWidget_track(){
     ...
     * @param clickMode
     */
    void TidalRisingMain::slot_clickedItemAlbum(const ItemAlbum::ClickMode clickMode){
     ...
     * @param clickMode
     */
    void TidalRisingMain::slot_clickedItemTrack_inList(const int idx, const tidal::AbstractTidalTrackDelegate::ClickMode clickMode){
