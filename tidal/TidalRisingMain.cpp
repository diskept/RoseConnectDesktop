...
namespace tidal {
    ...
    const QString TIDAL_API_PATH_ALBUM = "rising/new/albums";
    const QString TIDAL_API_PATH_TRACK = "rising/new/tracks";
    const QString TIDAL_API_PATH_PLAYLIST = "rising/new/playlists";
    const QString TIDAL_API_PATH_VIDEO = "rising/new/videos";

    const QString TIDAL_MAIN_TITLE = "TIDAL Rising";
    const QString TIDAL_SUB_TITLE___album = "Rising Albums";
    const QString TIDAL_SUB_TITLE___track = "Rising Tracks";
    const QString TIDAL_SUB_TITLE___playlist = "Rising Playlists";
    const QString TIDAL_SUB_TITLE___video = "Rising Videos";


    /**
     * @brief "TIDAL > 탐색 > TIDAL Rising 메인" 화면의 생성자
     * @param parent
     */
    TidalRisingMain::TidalRisingMain(QWidget *parent) : AbstractTidalSubWidget(MainUIType::VerticalScroll_filter, parent){
     ...
     * @brief 소멸자.
     */
    TidalRisingMain::~TidalRisingMain(){
     ...
     * @param jsonObj
     */
    void TidalRisingMain::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(pageCode != this->page){
            ...
            connect(proc_album, &ProcCommon::completeReq_list_albums, this, &TidalRisingMain::slot_applyResult_albums);
            proc_album->request_tidal_getList_albums(TIDAL_API_PATH_ALBUM, 10, 0);

            ProcCommon *proc_track = new ProcCommon(this);
            connect(proc_track, &ProcCommon::completeReq_list_tracks, this, &TidalRisingMain::slot_applyResult_tracks);
            proc_track->request_tidal_getList_tracks(TIDAL_API_PATH_TRACK, 5, 0);

            ProcCommon *proc_playlist = new ProcCommon(this);
            connect(proc_playlist, &ProcCommon::completeReq_list_playlists, this, &TidalRisingMain::slot_applyResult_playlists);
            proc_playlist->request_tidal_getList_playlists(TIDAL_API_PATH_PLAYLIST, 10, 0);

//            ProcCommon *proc_video = new ProcCommon(this);
//            connect(proc_video, &ProcCommon::completeReq_list_videos, this, &TidalRisingMain::slot_applyResult_videos);
//            proc_video->request_tidal_getList_videos(TIDAL_API_PATH_VIDEO, 10, 0);
     ...
     * HTTP API 호출한다.
     */
    void TidalRisingMain::setActivePage(){
        ...
        if(this->flagNeedReload == true){
            ...
            for(int i = 0; i < 10; i++){
                this->rising_album[i] = new tidal::ItemAlbum(i, SECTION_FOR_MORE_POPUP___albums, tidal::AbstractItem::ImageSizeMode::Square_200x200);
                connect(this->rising_album[i], &tidal::ItemAlbum::signal_clicked, this, &TidalRisingMain::slot_clickedItemAlbum);
            }

            for (int i = 0; i < 5; i++) {
                this->rising_track[i] = new PlaylistTrackDetailInfo_RHV;
                connect(this->rising_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &TidalRisingMain::slot_clickedItemTrack_inList);
                this->rising_track[i]->setProperty("index", i);
                this->rising_track[i]->setObjectName("rising_tracks");
            }

            for(int i = 0; i < 10; i++){
                this->rising_playlist[i] = new tidal::ItemPlaylist(i, SECTION_FOR_MORE_POPUP___playlists, tidal::AbstractItem::ImageSizeMode::Square_200x200);
                connect(this->rising_playlist[i], &tidal::ItemPlaylist::signal_clicked, this, &TidalRisingMain::slot_clickedItemPlaylist);
            }

//            for(int i = 0; i < 10; i++){
//                this->rising_video[i] = new tidal::ItemVideo(i, SECTION_FOR_MORE_POPUP___videos, tidal::AbstractItem::ImageSizeMode::Ractangle_284x157);
//                connect(this->rising_video[i], &tidal::ItemVideo::signal_clicked, this, &TidalRisingMain::slot_clickedItemVideo);
//            }
        }
    }
    ...
    void TidalRisingMain::setUIControl_appendWidget(){
        ...
        if(this->flag_album[0] == true && this->flag_track[0] == true && this->flag_playlist[0] == true /*&& this->flag_video[0] == true*/){
            ...
            if(this->flag_track[1] == true){
                ...
                this->widget_track = this->setUIControl_subTitle_withSideBtn(QString("Rising Tracks (%1)").arg(this->list_track->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_tracks, this->vBox_track);
                ...
                for(int i = 0; i < maxCount; i++){
                    this->rising_track[i]->setDataTrackInfo_Tidal(this->list_track->at(i));
                    this->rising_track[i]->resize(1550, 70);

                    this->vBox_track->addWidget(this->rising_track[i]);
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &TidalRisingMain::slot_applyResult_getRating_track);
                proc_fav_track->request_rose_getRating_Track("TIDAL", tmp_clientkey);
            }
            else{
                this->widget_track = new QWidget();
                this->widget_track = this->setUIControl_subTitle_withSideBtn(QString("Rising Tracks (0)"), "View All", BTN_IDX_SUBTITLE_tracks, this->vBox_track);
            ...
            if(this->flag_album[1] == true){
                ...
                this->widget_album = this->setUIControl_subTitle_withSideBtn(QString("Rising Albums (%1)").arg(this->list_album->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_albums, this->vBox_album);
                ...
                for(int i = 0; i < this->list_album->size(); i++){
                    this->rising_album[i]->setData(this->list_album->at(i));
                    this->hBox_album->addWidget(this->rising_album[i]);
                }
                ...
                this->widget_album = new QWidget();
                this->widget_album = this->setUIControl_subTitle_withSideBtn(QString("Rising Albums (0)"), "View All", BTN_IDX_SUBTITLE_albums, this->vBox_album);
            ...
            if(this->flag_playlist[1] == true){
                ...
                this->widget_playlist = this->setUIControl_subTitle_withSideBtn(QString("Rising Playlists (%1)").arg(this->list_playlist->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_playlists, this->vBox_playlist);
                ...
                for(int i = 0; i < this->list_playlist->size(); i++){
                    this->rising_playlist[i]->setData(this->list_playlist->at(i));
                    this->hBox_playlist->addWidget(this->rising_playlist[i]);
                }
                ...
                this->widget_playlist = new QWidget();
                this->widget_playlist = this->setUIControl_subTitle_withSideBtn(QString("Rising Playlists (0)"), "View All", BTN_IDX_SUBTITLE_playlists, this->vBox_playlist);
...
//                this->widget_video = this->setUIControl_subTitle_withSideBtn(QString("Rising Videos (%1)").arg(this->list_video->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_videos, this->vBox_video);
...
//                    this->rising_video[i]->setData(this->list_video->at(i));
//                    this->hBox_video->addWidget(this->rising_video[i]);
//                }
...
//            else{
//                this->widget_video = new QWidget();
//                this->widget_video = this->setUIControl_subTitle_withSideBtn(QString("Rising Videos (0)"), "View All", BTN_IDX_SUBTITLE_videos, this->vBox_video);
...
//            }
    ...
    QWidget* TidalRisingMain::setUIControl_subTitle_withSideBtn(const QString subTitle, const QString btnText, const int btnId, QLayout *p_layout){
    ...
    QHBoxLayout* TidalRisingMain::setUIControl_hBoxLayout_forAlbum(QLayout *p_layout){
    ...
    QHBoxLayout* TidalRisingMain::setUIControl_hBoxLayout_forPlaylists(QLayout *p_layout){
    ...
    QHBoxLayout* TidalRisingMain::setUIControl_hBoxLayout_forVideo(QLayout *p_layout){
     ...
     * @param btnId
     */
    //void TidalRisingMain::slot_clickBtn_subTitle_side(const int btnId){
    void TidalRisingMain::slot_clickBtn_subTitle_viewAll(){
    ...
    void TidalRisingMain::slot_tidal_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        ...
        if(p_jsonObj.contains("flagOk") && ProcJsonEasy::get_flagOk(p_jsonObj)){
            ...
            if(this->flag_send_track == true){
                ...
                if(status == true && this->flag_track_fav == false){
                    ...
                    connect(proc, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalRisingMain::slot_tidal_completeReq_listAll_myFavoritesIds);
    ...
    void TidalRisingMain::slot_applyResult_checkRating_track(const QJsonObject &jsonObj){
        ...
        if(jsonObj.contains("id")){
            ...
            if(id > 0){
                ...
                // request HTTP API - get favorite for Rose Server
                roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
                connect(proc_fav_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalRisingMain::slot_applyResult_addRating_track);
    ...
    void TidalRisingMain::slot_applyResult_addRating_track(const QJsonObject &jsonObj){
    ...
    void TidalRisingMain::slot_applyResult_getRating_track(const QJsonArray &contents){
        ...
        if(contents.size() > 0){
            ...
            if(track_info.contains("star")){
                for(int i = 0; i < contents.size(); i++){
                    ...
                    this->rising_track[i]->setFavoritesIds(flag, star);
                }
            }
     ...
     */
    void TidalRisingMain::slot_applyResult_albums(const QList<tidal::AlbumItemData>& list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void TidalRisingMain::slot_applyResult_tracks(const QList<tidal::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TidalRisingMain::slot_applyResult_playlists(const QList<tidal::PlaylistItemData>& list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TidalRisingMain::slot_applyResult_videos(const QList<tidal::VideoItemData>& list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void TidalRisingMain::slot_clickedItemAlbum(const AbstractItem::ClickMode clickMode){
     ...
     * @param clickMode
     */
    void TidalRisingMain::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                this->track_star_fav = this->rising_track[idx]->getFavoritesStars();
                ...
                connect(proc_fav, &ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalRisingMain::slot_tidal_completeReq_listAll_myFavoritesIds);
                ...
                connect(proc_favCheck_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalRisingMain::slot_applyResult_checkRating_track);
                proc_favCheck_track->request_rose_checkRating_Track("TIDAL", QString("%1").arg(this->track_id_fav));
                this->flag_check_track = true;

                this->rising_track[idx]->setFavoritesIds(this->flag_track_fav, this->track_star_fav);
            }
    ...
    void TidalRisingMain::slot_clickedItemPlaylist(const ItemPlaylist::ClickMode clickMode){
    ...
    void TidalRisingMain::slot_clickedItemVideo(const AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void TidalRisingMain::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
