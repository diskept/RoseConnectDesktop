...
namespace tidal {
     ...
     * @param parent
     */
    TidalGenresMain::TidalGenresMain(QWidget *parent) : AbstractTidalSubWidget(VerticalScroll_filter, parent){
    ...
    void TidalGenresMain::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(this->curr_genre_path != tmp_genre_path){
            ...
            this->genre_name = ProcJsonEasy::getString(jsonObj, "name", "Noname genre");
            this->label_mainTitle->setText(this->genre_name);
            ...
            this->genre_api_video = QString("genres/%1/videos").arg(this->curr_genre_path);
            ...
            connect(proc_album, &ProcCommon::completeReq_list_albums, this, &TidalGenresMain::slot_applyResult_albums);
            proc_album->request_tidal_getList_albums(this->genre_api_album, 10, 0);

            ProcCommon *proc_track = new ProcCommon(this);
            connect(proc_track, &ProcCommon::completeReq_list_tracks, this, &TidalGenresMain::slot_applyResult_tracks);
            proc_track->request_tidal_getList_tracks(this->genre_api_track, 5, 0);

            ProcCommon *proc_playlist = new ProcCommon(this);
            connect(proc_playlist, &ProcCommon::completeReq_list_playlists, this, &TidalGenresMain::slot_applyResult_playlists);
            proc_playlist->request_tidal_getList_playlists(this->genre_api_playlist,10,0);

            ProcCommon *proc_video = new ProcCommon(this);
            connect(proc_video, &ProcCommon::completeReq_list_videos, this, &TidalGenresMain::slot_applyResult_videos);
            proc_video->request_tidal_getList_videos(this->genre_api_video, 10, 0);
        }
        else{
    ...
    void TidalGenresMain::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            for(int i = 0; i < 10; i++){
                this->genre_album[i] = new tidal::ItemAlbum(i, SECTION_FOR_MORE_POPUP___albums, tidal::AbstractItem::ImageSizeMode::Square_200x200);
                connect(this->genre_album[i], &tidal::ItemAlbum::signal_clicked, this, &TidalGenresMain::slot_clickedItemAlbum);
            }

            for (int i = 0; i < 5; i++) {
                this->genre_track[i] = new PlaylistTrackDetailInfo_RHV;
                connect(this->genre_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &TidalGenresMain::slot_clickedItemTrack_inList);
                this->genre_track[i]->setProperty("index", i);
                this->genre_track[i]->setObjectName("genre_tracks");
            }

            for(int i = 0; i < 10; i++){
                this->genre_playlist[i] = new tidal::ItemPlaylist(i, SECTION_FOR_MORE_POPUP___playlists, tidal::AbstractItem::ImageSizeMode::Square_200x200);
                connect(this->genre_playlist[i], &tidal::ItemPlaylist::signal_clicked, this, &TidalGenresMain::slot_clickedItemPlaylist);
            }

            for(int i = 0; i < 10; i++){
                this->genre_video[i] = new tidal::ItemVideo(i, SECTION_FOR_MORE_POPUP___videos, tidal::AbstractItem::ImageSizeMode::Ractangle_284x157);
                connect(this->genre_video[i], &tidal::ItemVideo::signal_clicked, this, &TidalGenresMain::slot_clickedItemVideo);
            }
        }
    }
    ...
    void TidalGenresMain::setUIControl_appendWidget(){
        ...
        if(this->flag_album[0] == true && this->flag_track[0] == true && this->flag_playlist[0] == true && this->flag_video[0] == true){
            ...
            if(this->flag_track[1] == true){
                ...
                this->widget_track = this->setUIControl_subTitle_withSideBtn(QString("Tracks (%1)").arg(this->list_track->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_tracks, this->vBox_track);
                ...
                for(int i = 0; i < maxCount; i++){
                    this->genre_track[i]->setDataTrackInfo_Tidal(this->list_track->at(i));
                    this->genre_track[i]->resize(1550, 70);

                    this->vBox_track->addWidget(this->genre_track[i]);
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &TidalGenresMain::slot_applyResult_getRating_track);
                proc_fav_track->request_rose_getRating_Track("TIDAL", tmp_clientkey);
            }
            else{
                this->widget_track = new QWidget();
                this->widget_track = this->setUIControl_subTitle_withSideBtn(QString("Tracks (0)"), "View All", BTN_IDX_SUBTITLE_tracks, this->vBox_track);
            ...
            if(this->flag_album[1] == true){
                ...
                for(int i = 0; i < this->list_album->size(); i++){
                    this->genre_album[i]->setData(this->list_album->at(i));
                    this->hBox_album->addWidget(this->genre_album[i]);
                }
            ...
            if(this->flag_playlist[1] == true){
                ...
                for(int i = 0; i < this->list_playlist->size(); i++){
                    this->genre_playlist[i]->setData(this->list_playlist->at(i));
                    this->hBox_playlist->addWidget(this->genre_playlist[i]);
                }
            ...
            if(this->flag_video[1] == true){
                ...
                this->widget_video = this->setUIControl_subTitle_withSideBtn(QString("Videos (%1)").arg(this->list_video->at(0).totalCount), "View All", BTN_IDX_SUBTITLE_videos, this->vBox_video);
                ...
                for(int i = 0; i < this->list_video->size(); i++){
                    this->genre_video[i]->setData(this->list_video->at(i));
                    this->hBox_video->addWidget(this->genre_video[i]);
                }
                ...
                this->widget_video = new QWidget();
                this->widget_video = this->setUIControl_subTitle_withSideBtn(QString("Videos (0)"), "View All", BTN_IDX_SUBTITLE_videos, this->vBox_video);
    ...
    QWidget* TidalGenresMain::setUIControl_subTitle_withSideBtn(const QString subTitle, const QString btnText, const int btnId, QLayout *p_layout){
    ...
    QHBoxLayout* TidalGenresMain::setUIControl_hBoxLayout_forAlbum(QLayout *p_layout){
    ...
    QHBoxLayout* TidalGenresMain::setUIControl_hBoxLayout_forPlaylists(QLayout *p_layout){
    ...
    QHBoxLayout* TidalGenresMain::setUIControl_hBoxLayout_forVideo(QLayout *p_layout){
    ...
    void TidalGenresMain::slot_clickBtn_subTitle_viewAll(){

        int btnId = sender()->property("idx").toInt();

        if(btnId == BTN_IDX_SUBTITLE_tracks){
            PageInfo_TrackAllView data_page;
            data_page.pathTitle = QString("%1 Tracks").arg(this->genre_name);
            ...
            data_page.pathTitle = QString("%1 Albums").arg(this->genre_name);
            ...
            data_page.pathTitle = QString("%1 Playlists").arg(this->genre_name);
            ...
            data_page.pathTitle = QString("%1 Videos").arg(this->genre_name);
            data_page.api_subPath = this->genre_api_video;
            this->movePage_video_allView(data_page);
        }
    }


    void TidalGenresMain::slot_tidal_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        ...
        if(p_jsonObj.contains("flagOk") && ProcJsonEasy::get_flagOk(p_jsonObj)){
            ...
            if(this->flag_send_track == true){
                ...
                if(status == true && this->flag_track_fav == false){
                    ...
                    connect(proc, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalGenresMain::slot_tidal_completeReq_listAll_myFavoritesIds);
    ...
    void TidalGenresMain::slot_applyResult_checkRating_track(const QJsonObject &jsonObj){
        ...
        if(jsonObj.contains("id")){
            ...
            if(id > 0){
                ...
                // request HTTP API - get favorite for Rose Server
                roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
                connect(proc_fav_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalGenresMain::slot_applyResult_addRating_track);
    ...
    void TidalGenresMain::slot_applyResult_addRating_track(const QJsonObject &jsonObj){
    ...
    void TidalGenresMain::slot_applyResult_getRating_track(const QJsonArray &contents){
        ...
        if(contents.size() > 0){
            ...
            if(track_info.contains("star")){
                for(int i = 0; i < contents.size(); i++){
                    ...
                    this->genre_track[i]->setFavoritesIds(flag, star);
                }
            }
    ...
    void TidalGenresMain::slot_applyResult_videos(const QList<tidal::VideoItemData>& list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void TidalGenresMain::slot_clickedItemAlbum(const AbstractItem::ClickMode clickMode){
     ...
     * @param clickMode
     */
    void TidalGenresMain::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                this->track_star_fav = this->genre_track[idx]->getFavoritesStars();
                ...
                connect(proc_fav, &ProcCommon::completeReq_listAll_myFavoritesIds, this, &TidalGenresMain::slot_tidal_completeReq_listAll_myFavoritesIds);
                ...
                connect(proc_favCheck_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &TidalGenresMain::slot_applyResult_checkRating_track);
                proc_favCheck_track->request_rose_checkRating_Track("TIDAL", QString("%1").arg(this->track_id_fav));
                this->flag_check_track = true;

                this->genre_track[idx]->setFavoritesIds(this->flag_track_fav, this->track_star_fav);
            }
    ...
    void TidalGenresMain::slot_clickedItemVideo(const AbstractItem::ClickMode clickMode){
