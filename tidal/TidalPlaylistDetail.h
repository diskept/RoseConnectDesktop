#ifndef TIDALPLAYLISTDETAIL_H
#define TIDALPLAYLISTDETAIL_H
...
namespace tidal {
     ...
     */
    class TidalPlaylistDetail : public AbstractTidalSubWidget
    {
        Q_OBJECT
    public:
        explicit TidalPlaylistDetail(QWidget *parent = nullptr);
        ~TidalPlaylistDetail();
    ...
    private slots:
        void slot_applyResult_playlist(const tidal::PlaylistItemData&);
        void slot_applyResult_similarPlaylist(const QList<tidal::PlaylistItemData>&, const QJsonArray&, const bool);
