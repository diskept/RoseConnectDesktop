...
#include "tidal/ItemImage_Artist.h"
...
namespace tidal {
     ...
     * @param parent
     */
    ItemArtist::ItemArtist(int index, int section, ImageSizeMode imageSizeMode, QWidget *parent)
     ...
     */
    void ItemArtist::setUIControl(){

        int base_height = 0;
        int img_width = 0;

        this->itemImage = new ItemImage_Artist(this->get_imageWidth(this->m_imageSizeMode));
        connect(this->itemImage, &ItemImage_Artist::signal_clickedBtn, this, &ItemArtist::slot_itemImage_clickedBtn);
     ...
     */
    void ItemArtist::setData(const tidal::ArtistItemData &p_data_artist){
     ...
     * @return
     */
    int ItemArtist::get_fixedHeight(){
    ...
    int ItemArtist::get_rightMargin(){
     ...
     * @param event
     */
    void ItemArtist::paintEvent(QPaintEvent *event){
