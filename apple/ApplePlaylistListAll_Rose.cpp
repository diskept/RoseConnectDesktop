...
namespace apple {
    ...
    /**
     * @brief ApplePlaylistListAll_Rose::ApplePlaylistListAll_Rose
     * @param parent
     */
    ApplePlaylistListAll_Rose::ApplePlaylistListAll_Rose(QWidget *parent) : AbstractAppleSubWidget(MainUIType::VerticalScroll_viewAll, parent) {
     ...
     * @brief 소멸자.
     */
    ApplePlaylistListAll_Rose::~ApplePlaylistListAll_Rose(){
     ...
     * @param jsonObj
     */
    void ApplePlaylistListAll_Rose::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void ApplePlaylistListAll_Rose::setActivePage(){
    ...
    /**
     * @brief ApplePlaylistListAll_Rose::setUIControll_basic
     */
    void ApplePlaylistListAll_Rose::setUIControl_playlist(){
        ...
        connect(this->chooseFilterOpt, &bugs::BugsChooseFilterOpt::signal_clicked_filterOpt, this, &ApplePlaylistListAll_Rose::slot_chooseFilterOption);
    ...
    void ApplePlaylistListAll_Rose::setUIControl_filter(){
        ...
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &ApplePlaylistListAll_Rose::slot_filterClicked);
     ...
     */
    void ApplePlaylistListAll_Rose::proc_wheelEvent_to_getMoreData(){
     ...
     * @param event
     */
    void ApplePlaylistListAll_Rose::resizeEvent(QResizeEvent *event){
     ...
     */
    void ApplePlaylistListAll_Rose::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void ApplePlaylistListAll_Rose::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
     ...
     */
    void ApplePlaylistListAll_Rose::request_more_playlistData(){
        ...
        if(!this->flagReqMore_playlist && !this->flag_lastPage_playlist){
            ...
            connect(proc, &roseHome::ProcCommon::completeReq_list_playlists, this, &ApplePlaylistListAll_Rose::slot_applyResult_myPlaylist_rose);
            proc->request_rose_getList_recentlyPlaylists("member/playlist/recent", "APPLE_MUSIC", this->next_offset, GET_ITEM_SIZE___ONCE);
    ...
    void ApplePlaylistListAll_Rose::request_more_playlistDraw(){
        ...
        for(int i = start_index; i < this->playlist_draw_cnt; i++){
            this->listPlaylist_all[i] = new roseHome::ItemPlaylist_rosehome(i, SECTION_FOR_MORE_POPUP___playlists, tidal::AbstractItem::ImageSizeMode::Square_200x200, 2, true);
            connect(this->listPlaylist_all[i], &roseHome::ItemPlaylist_rosehome::signal_clicked, this, &ApplePlaylistListAll_Rose::slot_clickedItemPlaylist);
        }
     ...
     * @param list_data
     */
    void ApplePlaylistListAll_Rose::slot_applyResult_myPlaylist_rose(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void ApplePlaylistListAll_Rose::slot_clickedItemPlaylist(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void ApplePlaylistListAll_Rose::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
        ...
        if(section == SECTION_FOR_MORE_POPUP___playlists){
            ...
            {
                if(this->list_playlist->at(index).isRose == false){
                    apple::ProcRosePlay_withApple *procRosePlay = new apple::ProcRosePlay_withApple(this);
                    procRosePlay->requestPlayRose_byPlaylistID(this->list_playlist->at(index).clientKey, OptMorePopup::ClickMode::Play_RightNow);
                }
                else{
                    roseHome::ProcRosePlay_withRosehome *procRosePlay = new roseHome::ProcRosePlay_withRosehome(this);
