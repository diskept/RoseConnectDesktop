...
namespace apple {
     ...
     * @param parent
     */
    ApplePlaylistDetail_Rose::ApplePlaylistDetail_Rose(QWidget *parent) : AbstractAppleSubWidget(MainUIType::VerticalScroll_filter, parent) {
     ...
     * @brief 소멸자.
     */
    ApplePlaylistDetail_Rose::~ApplePlaylistDetail_Rose(){
    ...
    /**
     * @brief ApplePlaylistDetail_Rose::setJsonObject_forData
     * @param jsonObj
     */
    void ApplePlaylistDetail_Rose::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(tmp_data_playlist.id != this->data_playlist.id){
            ...
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_tracks, this, &ApplePlaylistDetail_Rose::slot_applyResult_playlist_tracks);
            ...
            if(this->ownerId_chk != global.user.getSub().toInt()){
                ...
                connect(proc_thumb_playlist, &roseHome::ProcCommon::completeReq_rating_thumbup, this, &ApplePlaylistDetail_Rose::slot_applyResult_getRating_thumbup);
    ...
    /**
     * @brief ApplePlaylistDetail_Rose 선택이 되었을 때, 페이지 활성화를 처리하는 함수임.
     * HTTP API 호출한다.
     */
    void ApplePlaylistDetail_Rose::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(this->playlist_detail_info, &AbstractImageDetailContents_RHV::signal_clicked, this, &ApplePlaylistDetail_Rose::slot_detailInfo_btnClicked);
     ...
     */
    void ApplePlaylistDetail_Rose::proc_wheelEvent_to_getMoreData(){
    ...
    void ApplePlaylistDetail_Rose::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->playlist_track_info[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &ApplePlaylistDetail_Rose::slot_clickedItemTrack_inList);
    ...
    void ApplePlaylistDetail_Rose::request_more_trackData(){
    ...
    void ApplePlaylistDetail_Rose::slot_applyResult_playlist(const roseHome::PlaylistItemData &playlist_data){
     ...
     */
    void ApplePlaylistDetail_Rose::slot_applyResult_playlist_tracks(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void ApplePlaylistDetail_Rose::slot_applyResult_getRating_playlist(const QJsonArray &contents){
    ...
    void ApplePlaylistDetail_Rose::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void ApplePlaylistDetail_Rose::slot_applyResult_getRating_thumbup(const QJsonObject &jsonObj){
     ...
     * @param clickMode
     */
    void ApplePlaylistDetail_Rose::slot_detailInfo_btnClicked(const AbstractImageDetailContents_RHV::BtnClickMode clickMode){
        ...
        if(clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAdd || clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAddx2 ||
            ...
            if(this->flag_check_playlist == false){
                ...
                connect(proc_fav_playlist, &roseHome::ProcCommon::completeReq_rating_playlist, this, &ApplePlaylistDetail_Rose::slot_applyResult_getRating_playlist);
     ...
     * @param clickMode
     */
    void ApplePlaylistDetail_Rose::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &ApplePlaylistDetail_Rose::slot_applyResult_getRating_track);
     ...
     * @param section
     */
    void ApplePlaylistDetail_Rose::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
