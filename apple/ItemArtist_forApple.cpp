#include "apple/ItemArtist_forApple.h"
...
namespace apple {
     ...
     * @param parent
     */
    ItemArtist_apple::ItemArtist_apple(int index, int section, ImageSizeMode imageSizeMode, QWidget *parent)
     ...
     */
    void ItemArtist_apple::setUIControl(){

        int base_height = 0;
        int img_width = 0;

        this->itemImage = new ItemImage_Artist_apple(this->get_imageWidth(this->m_imageSizeMode));
        connect(this->itemImage, &ItemImage_Artist_apple::signal_clickedBtn, this, &ItemArtist_apple::slot_itemImage_clickedBtn);
     ...
     */
    /*void ItemArtist_apple::setData(const qobuz::ArtistItemData &p_data_artist){
     ...
     * @return
     */
    int ItemArtist_apple::get_fixedHeight(){
     ...
     * @param event
     */
    void ItemArtist_apple::paintEvent(QPaintEvent *event){
