#ifndef APPLEMYPLAYLISTLISTALL_ROSE_H
#define APPLEMYPLAYLISTLISTALL_ROSE_H
...
namespace apple {
    ...
    /**
     * @brief APPLEMUSIC의 My Playlist 전체목록 화면
     */
    class AppleMyPlaylistListAll_Rose : public AbstractAppleSubWidget
    {
        Q_OBJECT

    public:
        explicit AppleMyPlaylistListAll_Rose(QWidget *parent = nullptr);
        ~AppleMyPlaylistListAll_Rose();
...
#endif // APPLEMYPLAYLISTLISTALL_ROSE_H
