#ifndef APPLEUSERPLAYLISTLISTALL_ROSE_H
#define APPLEUSERPLAYLISTLISTALL_ROSE_H
...
namespace apple {
    ...
    /**
     * @brief APPLEMUSIC의 User Playlist 전체목록 화면
     */
    class AppleUserPlaylistListAll_Rose : public AbstractAppleSubWidget
    {
        Q_OBJECT

    public:
        explicit AppleUserPlaylistListAll_Rose(QWidget *parent = nullptr);
        ~AppleUserPlaylistListAll_Rose();
...
#endif // APPLEUSERPLAYLISTLISTALL_ROSE_H
