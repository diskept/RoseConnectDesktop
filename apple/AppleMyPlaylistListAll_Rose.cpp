...
namespace apple {
     ...
     * @param parent
     */
    AppleMyPlaylistListAll_Rose::AppleMyPlaylistListAll_Rose(QWidget *parent) : AbstractAppleSubWidget(MainUIType::VerticalScroll_viewAll, parent) {
     ...
     * @brief 소멸자.
     */
    AppleMyPlaylistListAll_Rose::~AppleMyPlaylistListAll_Rose(){
     ...
     * @param jsonObj
     */
    void AppleMyPlaylistListAll_Rose::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void AppleMyPlaylistListAll_Rose::setActivePage(){
     ...
     */
    void AppleMyPlaylistListAll_Rose::setUIControl_playlist(){
        ...
        connect(this->chooseFilterOpt, &bugs::BugsChooseFilterOpt::signal_clicked_filterOpt, this, &AppleMyPlaylistListAll_Rose::slot_chooseFilterOption);
     ...
     */
    void AppleMyPlaylistListAll_Rose::setUIControl_filter(){
        ...
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &AppleMyPlaylistListAll_Rose::slot_filterClicked);
     ...
     */
    void AppleMyPlaylistListAll_Rose::proc_wheelEvent_to_getMoreData(){
     ...
     * @param event
     */
    void AppleMyPlaylistListAll_Rose::resizeEvent(QResizeEvent *event){
     ...
     */
    void AppleMyPlaylistListAll_Rose::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void AppleMyPlaylistListAll_Rose::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
     ...
     */
    void AppleMyPlaylistListAll_Rose::request_more_playlistData(){
        ...
        if(!this->flagReqMore_playlist && !this->flag_lastPage_playlist){
            ...
            connect(proc, &roseHome::ProcCommon::completeReq_list_myplaylists, this, &AppleMyPlaylistListAll_Rose::slot_applyResult_myPlaylist_rose);
            proc->request_rose_getList_myPlaylists("member/playlist", "APPLE_MUSIC", this->next_offset, GET_ITEM_SIZE___ONCE);
    ...
    void AppleMyPlaylistListAll_Rose::request_more_playlistDraw(){
        ...
        for(int i = start_index; i < this->playlist_draw_cnt; i++){
            ...
            connect(this->listPlaylist_all[i], &roseHome::ItemPlaylist_rosehome::signal_clicked, this, &AppleMyPlaylistListAll_Rose::slot_clickedItemPlaylist);
        }
 ...
 * @param list_data
 */
void AppleMyPlaylistListAll_Rose::slot_applyResult_myPlaylist_rose(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
 ...
 * @param clickMode
 */
void AppleMyPlaylistListAll_Rose::slot_clickedItemPlaylist(const tidal::AbstractItem::ClickMode clickMode){
 ...
 * @param section
 */
void AppleMyPlaylistListAll_Rose::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
    ...
    if(section == SECTION_FOR_MORE_POPUP___playlists){
        if(clickMode == OptMorePopup::ClickMode::Share){//c220823
                ...
                if(this->shareLink.size()<=0){
                    ...
                    //emit linker->signal_checkQueue(34, "");
                }
