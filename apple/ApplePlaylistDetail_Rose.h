#ifndef APPLEPLAYLISTDETAIL_ROSE_H
#define APPLEPLAYLISTDETAIL_ROSE_H
...
namespace apple {
     ...
     */
    class ApplePlaylistDetail_Rose : public AbstractAppleSubWidget
    {
        Q_OBJECT
    public:
        explicit ApplePlaylistDetail_Rose(QWidget *parent = nullptr);
        ~ApplePlaylistDetail_Rose();
...
#endif // APPLEPLAYLISTDETAIL_ROSE_H
