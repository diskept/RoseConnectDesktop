#ifndef APPLEALBUMLISTALL_ROSE_H
#define APPLEALBUMLISTALL_ROSE_H
...
namespace apple {
    ...
    /**
     * @brief APPLEMUSIC의 Recently Album 전체목록 화면
     */
    class AppleAlbumListAll_Rose : public AbstractAppleSubWidget
    {
        Q_OBJECT
    public:
        explicit AppleAlbumListAll_Rose(QWidget *parent = nullptr);
        ~AppleAlbumListAll_Rose();
...
#endif // APPLEALBUMLISTALL_ROSE_H
