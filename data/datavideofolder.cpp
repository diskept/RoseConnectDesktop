 ...
 */
DataVideoFolder::DataVideoFolder(QObject *parent)
    : QObject(parent)
{

}

DataVideoFolder::~DataVideoFolder(){

}

void DataVideoFolder::setData(const QJsonObject &p_json){
...
QString DataVideoFolder::getExt() const
{
    return ext;
}

QString DataVideoFolder::getId() const
{
    return id;
}

QString DataVideoFolder::getIp() const
{
    return ip;
}

bool DataVideoFolder::getIsCloud() const
{
    return isCloud;
}

bool DataVideoFolder::getIsDir() const
{
    return isDir;
}
bool DataVideoFolder::getIsFile() const
{
    return isFile;
}

bool DataVideoFolder::getIsServer() const
{
    return isServer;
}

bool DataVideoFolder::getIsShare() const
{
    return isShare;
}

bool DataVideoFolder::getIsUp() const
{
    return isUp;
}

QString DataVideoFolder::getName() const
{
    return name;
}

QString DataVideoFolder::getPath() const
{
    return path;
}

QString DataVideoFolder::getPw() const
{
    return pw;
}

QString DataVideoFolder::getRcloneServe() const
{
    return rcloneServe;
}

QString DataVideoFolder::getSmbParamPath() const
{
    return smbParamPath;
}

QString DataVideoFolder::getThumbnail() const
{
    return thumbnail;
}
