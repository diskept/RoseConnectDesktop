 ...
 *
 */
DialogRoseFmHelp::DialogRoseFmHelp(QWidget *parent)
    : QDialog(parent)
{
...
DialogRoseFmHelp::~DialogRoseFmHelp(){
 ...
 */
void DialogRoseFmHelp::setUIControl(){
    lb_title = new QLabel;
    ...
    connect(btn_save, SIGNAL(clicked()), this, SLOT(slot_confirm()));
 ...
 * @param p_title
 */
void DialogRoseFmHelp::setTitle(const QString &p_title){
 ...
 * @param p_text
 */
void DialogRoseFmHelp::setText(const QString &p_text){
    lb_text->setText(p_text);
}

void DialogRoseFmHelp::slot_confirm(){
    this->hide();
}
