#ifndef ROSETUBE_MYFAVORITE_H
#define ROSETUBE_MYFAVORITE_H
...
namespace rosetube {
    ...
    class RoseTubeFavorite : public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:

        explicit RoseTubeFavorite(QWidget *parent = nullptr);
        ~RoseTubeFavorite();
    ...
    private:
        ...
        //---------------------------------------------------------------------------------------  Filter : START
        QHBoxLayout *box_order_filter;
        FlowLayout *flowLayout_order;           ///< Order part

        QWidget *widget_filter;                 ///< Order filter
        QPushButton *btn_filter_ico;            ///< Order filter icon
        QPushButton *btn_order[10];             ///< Order button
