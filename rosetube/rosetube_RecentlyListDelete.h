#ifndef ROSETUBE_RECENTLYLISTDELETE_H
#define ROSETUBE_RECENTLYLISTDELETE_H
...
namespace rosetube {
     ...
     */
    class RoseTubeRecentlyListDelete: public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RoseTubeRecentlyListDelete(QWidget *parent = nullptr);
        ~RoseTubeRecentlyListDelete();
...
#endif // ROSETUBE_RECENTLYLISTDELETE_H
