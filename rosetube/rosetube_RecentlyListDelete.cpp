#include "rosetube/rosetube_RecentlyListDelete.h"
...
namespace rosetube {
     ...
     * @param parent
     */
    RoseTubeRecentlyListDelete::RoseTubeRecentlyListDelete(QWidget *parent) : AbstractRoseHomeSubWidget(VerticalScroll_rosefilter, parent) {
    ...
    * @brief 소멸자.
    */
    RoseTubeRecentlyListDelete::~RoseTubeRecentlyListDelete(){
     ...
     * @param jsonObj
     */
    void RoseTubeRecentlyListDelete::setJsonObject_forData(const QJsonObject &jsonObj){
    ...
    /**
     * @brief RoseTubeRecentlyListDelete::setActivePage
     */
    void RoseTubeRecentlyListDelete::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void RoseTubeRecentlyListDelete::setUIControl_lists(){
        ...
        connect(this->btn_deleteAll, &QPushButton::clicked, this, &RoseTubeRecentlyListDelete::slot_clicked_DeleteAll);
        ...
        connect(this->btn_delete, &QPushButton::clicked, this, &RoseTubeRecentlyListDelete::slot_clicked_Delete);
        ...
        connect(this->btn_selectAll, &QPushButton::clicked, this, &RoseTubeRecentlyListDelete::slot_clicked_btnSelectAll);
        ...
        connect(this->checkbox_selectAll, &QCheckBox::stateChanged, this, &RoseTubeRecentlyListDelete::slot_clickedSelected);
     ...
     */
    void RoseTubeRecentlyListDelete::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void RoseTubeRecentlyListDelete::request_more_listData(){
        ...
        if(!this->flagReqMore_data && !this->flag_lastPage_data){
            ...
            if(this->list_type == "ALBUM"){
                ...
                connect(proc, &roseHome::ProcCommon::completeReq_list_albums, this, &RoseTubeRecentlyListDelete::slot_applyResult_albumlists);
                ...
                connect(proc_recently, &roseHome::ProcCommon::completeReq_list_playlists, this, &RoseTubeRecentlyListDelete::slot_applyResult_playlistLists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_rosetubes, this, &RoseTubeRecentlyListDelete::slot_applyResult_rosetubelists);
                proc->request_rose_getList_recentlyRosetube("member/track/recent", "YOUTUBE", this->next_offset, 50);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_tracks, this, &RoseTubeRecentlyListDelete::slot_applyResult_tracklists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_artists, this, &RoseTubeRecentlyListDelete::slot_applyResult_artistlists);
    ...
    void RoseTubeRecentlyListDelete::request_more_listDraw(){
    ...
    inline void RoseTubeRecentlyListDelete::iniDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
    ...
    inline void RoseTubeRecentlyListDelete::setDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
     ...
     * @param list_data
     */
    void RoseTubeRecentlyListDelete::slot_applyResult_albumlists(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseTubeRecentlyListDelete::slot_applyResult_playlistLists(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseTubeRecentlyListDelete::slot_applyResult_rosetubelists(const QJsonArray &jsonArr_dataToPlay, const int &totalCnt, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseTubeRecentlyListDelete::slot_applyResult_tracklists(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseTubeRecentlyListDelete::slot_applyResult_artistlists(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseTubeRecentlyListDelete::slot_thumbnailDownload_list(){
    ...
    void RoseTubeRecentlyListDelete::slot_clickedSelected(int state){
    ...
    void RoseTubeRecentlyListDelete::slot_clicked_btnSelectAll(){
    ...
    void RoseTubeRecentlyListDelete::slot_clicked_Delete(){
        ...
        if(this->selectIds.count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "album", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "playlist", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "track", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "artist", "", "Ids", this->selectIds);
            }
        }
    }


    void RoseTubeRecentlyListDelete::slot_clicked_DeleteAll(){
        ...
        if(this->listWidget_recentlyList->count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "album", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "playlist", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "track", "YOUTUBE", "All", this->selectIds);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("YOUTUBE", "artist", this->filter_type, "All", this->selectIds);
            }
        }
    }


    bool RoseTubeRecentlyListDelete::selectDelete_DialogConfirm(const QString type){
    ...
    void RoseTubeRecentlyListDelete::slot_applyResult_getDeleteList(const bool flag){
    ...
    /**
     * @brief RoseTubeRecentlyListDelete::resizeEvent
     * @param event
     */
    void RoseTubeRecentlyListDelete::resizeEvent(QResizeEvent *event){
        Q_UNUSED(event);
