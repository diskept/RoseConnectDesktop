#ifndef ROSETUBE_HISTORYDETAIL_H
#define ROSETUBE_HISTORYDETAIL_H
...
namespace rosetube {
     ...
     */
    class RoseTubeHistoryDetail : public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RoseTubeHistoryDetail(QWidget *parent = nullptr);
        ~RoseTubeHistoryDetail();
    ...
    private:
        ...
        rosetube::ItemTrack_rosetube *home_history_rosetube[15];
...
#endif //ROSETUBE_HISTORYDETAIL_H
