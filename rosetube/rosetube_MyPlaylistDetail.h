#ifndef ROSETUBE_MYPLAYLISTDETAIL_H
#define ROSETUBE_MYPLAYLISTDETAIL_H
...
namespace rosetube {
     ...
     */
    class RosetubeMyPlaylistDetail : public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RosetubeMyPlaylistDetail(QWidget *parent = nullptr);
        ~RosetubeMyPlaylistDetail();
...
#endif // ROSETUBE_MYPLAYLISTDETAIL_H
