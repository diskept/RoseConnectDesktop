...
SettingRoseTube::SettingRoseTube(QWidget *parent) : QWidget(parent)
{
    this->setUIControl();
}

void SettingRoseTube::setUIControl()
{
    // 전체
    ...
    vl_total->addWidget(GSCommon::getUIControlTitleForSetting(tr("RoseTube Option")));
    //vl_total->addWidget(GSCommon::getUIControlTitleForSetting(tr("로즈튜브 옵션")));
