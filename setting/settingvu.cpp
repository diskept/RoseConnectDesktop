...
void SettingVU::setUIControl(){
    ...
    //this->btn_2_lb = GSCommon::getUILabelImg(":/images/setting/vu_blue_off.png");         ///< j230330 저자권 문제로 삭제
    this->btn_2_lb = GSCommon::getUILabelImg(":/images/setting/vu_mint_off.png");
    this->btn_3_lb = GSCommon::getUILabelImg(":/images/setting/vu_purple_off.png");
    this->btn_4_lb = GSCommon::getUILabelImg(":/images/setting/vu_red_off.png");
    this->btn_5_lb = GSCommon::getUILabelImg(":/images/setting/vu_white_off.png");
    this->btn_6_lb = GSCommon::getUILabelImg(":/images/setting/vu_4_off.png");
    this->btn_7_lb = GSCommon::getUILabelImg(":/images/setting/vu_3_off.png");
    this->btn_8_lb = GSCommon::getUILabelImg(":/images/setting/vu_1_off.png");
    this->btn_9_lb = GSCommon::getUILabelImg(":/images/setting/vu_2_off.png");
    this->btn_10_lb = GSCommon::getUILabelImg(":/images/setting/vu_7_off.png");
    this->btn_11_lb = GSCommon::getUILabelImg(":/images/setting/vu_8_off.png");
    this->btn_12_lb = GSCommon::getUILabelImg(":/images/setting/vu_5_off.png");
    this->btn_13_lb = GSCommon::getUILabelImg(":/images/setting/vu_6_off.png");


    if(global.device.getDeviceType() == "RS201" || global.device.getDeviceType() == "RS250" || global.device.getDeviceType() == "RS250A"){
        this->btn_1 = this->getUIControlButton(tr("ROSE Style"), 1, this->btn_1_lb);
        //this->btn_2 = this->getUIControlButton(tr("Macintosh Style"), 2, this->btn_2_lb);
        this->btn_2 = this->getUIControlButton(tr("Green Style"), 2, this->btn_2_lb);
        this->btn_3 = this->getUIControlButton(tr("Purple Style"), 3, this->btn_3_lb);
        this->btn_4 = this->getUIControlButton(tr("Red Style"), 4, this->btn_4_lb);
        this->btn_5 = this->getUIControlButton(tr("White Style"), 5, this->btn_5_lb);
        this->btn_6 = this->getUIControlButton(tr("A style"), 6, this->btn_6_lb);
        this->btn_7 = this->getUIControlButton(tr("B Style"), 7, this->btn_7_lb);
        this->btn_8 = this->getUIControlButton(tr("C Style"), 8, this->btn_8_lb);
        this->btn_9 = this->getUIControlButton(tr("D Style"), 9, this->btn_9_lb);
        this->btn_10 = this->getUIControlButton(tr("RA180 Style"), 10, this->btn_10_lb);
        this->btn_11 = this->getUIControlButton(tr("Level Meter Style"), 11, this->btn_11_lb);
    }
    else if(global.device.getDeviceType() == "RS150" || global.device.getDeviceType() == "RS150B"){
        this->btn_1 = this->getUIControlButton(tr("ROSE Style"), 1, this->btn_1_lb);
        //this->btn_2 = this->getUIControlButton(tr("Macintosh Style"), 2, this->btn_2_lb);
        this->btn_2 = this->getUIControlButton(tr("Green Style"), 2, this->btn_2_lb);
        this->btn_3 = this->getUIControlButton(tr("Purple Style"), 3, this->btn_3_lb);
        ...
        this->btn_6 = this->getUIControlButton(tr("A style"), 6, this->btn_6_lb);
        this->btn_7 = this->getUIControlButton(tr("B Style"), 7, this->btn_7_lb);
        this->btn_8 = this->getUIControlButton(tr("C Style"), 8, this->btn_10_lb);
        this->btn_9 = this->getUIControlButton(tr("D Style"), 9, this->btn_13_lb);
        this->btn_10 = this->getUIControlButton(tr("E Style"), 10, this->btn_8_lb);
        this->btn_11 = this->getUIControlButton(tr("F Style"), 11, this->btn_9_lb);
        this->btn_12 = this->getUIControlButton(tr("RA180 Style"), 12, this->btn_12_lb);
    }
    ...
    else if(global.device.getDeviceType() == "RS130"){
        this->btn_1 = this->getUIControlButton(tr("ROSE Style"), 1, this->btn_1_lb);
        //this->btn_2 = this->getUIControlButton(tr("Macintosh Style"), 2, this->btn_2_lb);
        this->btn_2 = this->getUIControlButton(tr("Green Style"), 2, this->btn_2_lb);
        this->btn_3 = this->getUIControlButton(tr("Purple Style"), 3, this->btn_3_lb);
    ...
    if(global.device.getDeviceType()=="RS201" || global.device.getDeviceType() == "RS250" || global.device.getDeviceType() == "RS250A"){
        fl_vu->addWidget(this->btn_1);
        fl_vu->addWidget(this->btn_2);
        fl_vu->addWidget(this->btn_3);
        fl_vu->addWidget(this->btn_4);
        fl_vu->addWidget(this->btn_5);
        fl_vu->addWidget(this->btn_6);
        fl_vu->addWidget(this->btn_7);
        fl_vu->addWidget(this->btn_8);
        fl_vu->addWidget(this->btn_9);
        fl_vu->addWidget(this->btn_10);
        fl_vu->addWidget(this->btn_11);
    }
    else if(global.device.getDeviceType()=="RS150" || global.device.getDeviceType()=="RS150B"){
        fl_vu->addWidget(this->btn_1);
        fl_vu->addWidget(this->btn_2);
...
void SettingVU::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
    ...
    case HTTP_VLC_GET :
        if(p_jsonObject.contains("vu_mode")){
            //qDebug() << "[Debug]" << __FUNCTION__ << __LINE__ << this->curr_vu_sytle << p_jsonObject["vu_mode"].toInt();
...
void SettingVU::clearUnSelectMode(){
    ...
    this->btn_2_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_mint_off.png"));
    this->btn_3_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_purple_off.png"));
    this->btn_4_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_red_off.png"));
    this->btn_5_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_white_off.png"));
    this->btn_6_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_4_off.png"));
    this->btn_7_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_3_off.png"));
    this->btn_8_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_1_off.png"));
    this->btn_9_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_2_off.png"));
    this->btn_10_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_7_off.png"));
    this->btn_11_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_8_off.png"));
    this->btn_12_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_5_off.png"));
    this->btn_13_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_6_off.png"));
...
void SettingVU::setVUMode(int p_vu_mode){//c220713
    ...
    if(global.device.getDeviceType() == "RS201" || global.device.getDeviceType() == "RS250" || global.device.getDeviceType() == "RS250A"){
        ...
        /*else if(p_vu_mode ==2){
            ...
            this->btn_10_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_7.png"));
            ...
            this->btn_11_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_8.png"));
        ...
        /*else if(p_vu_mode ==2){
            ...
            this->btn_13_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_6.png"));
            this->btn_9->setStyleSheet(this->btn_9->styleSheet().replace("border:1px solid #707070;", "border:3px solid #B18658;"));
        }
        else if(p_vu_mode == 10){
            this->btn_8_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_1.png"));
            ...
            this->btn_12_lb->setPixmap(*GSCommon::getUIPixmapImg(":/images/setting/vu_5.png"));
