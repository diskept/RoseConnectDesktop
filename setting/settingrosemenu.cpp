...
SettingRoseMenu::SettingRoseMenu(QWidget *parent) : QWidget(parent)
{
    this->setUIControl();
}

void SettingRoseMenu::setUIControl()
{
    // 전체
    ...
    vl_total->addWidget(GSCommon::getUIControlTitleForSetting(tr("Edit Device Menu")));
    //vl_total->addWidget(GSCommon::getUIControlTitleForSetting(tr("기기 메뉴 편집")));
