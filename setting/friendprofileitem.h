#ifndef FRIENDPROFILEITEM_H
#define FRIENDPROFILEITEM_H
 ...
 */
class FriendProfileItem : public QWidget
{
    Q_OBJECT
public:
    enum ProfileBtnType{
    ...
    explicit FriendProfileItem(ProfileBtnType p_type, QWidget *parent = nullptr);
