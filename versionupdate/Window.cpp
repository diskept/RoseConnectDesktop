...
#include <QDebug>
#include "versionupdate/QSimpleUpdater.h"
...
//==============================================================================
//static const QString DEFS_URL = "https://drive.google.com/file/d/1YaZP4Z-mxwgkJViKWcm9MK0uhx5EKSBP/view?usp=sharing";
...
static const QString DEFS_URL = "http://192.168.1.3:280/updates_win.json";
#endif
#if defined(Q_OS_MAC)
...
//resetFields();//cheon210721-update
  ...
  //           this,                SLOT (resetFields()));
    connect (m_ui->closeButton, SIGNAL (clicked()),
             this,                SLOT (mainwindow_start_afterclose()));//cheon210721-update
      //       this,                SLOT (close()));//cheon210721-update
...
void Window::mainwindow_start_afterclose()
{
    print_debug();
    close();
   // QApplication::quit();
...
{
    /*
    m_ui->installedVersion->setText (rosesettings.APPLICATION_VERSION);
...
void Window::checkForUpdates()
{
   ...
   // QString version = m_ui->installedVersion->text();//cheon210721-update
    ...
    qDebug() << "Window::checkForUpdates---version = " << version;
