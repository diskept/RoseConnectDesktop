...
namespace qobuz {
    ...
    /**
     * @brief QobuzSearchAlbumAll::QobuzSearchAlbumAll
     * @param parent
     */
    QobuzSearchAlbumAll::QobuzSearchAlbumAll(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll_viewAll, parent) {
     ...
     * @brief 소멸자.
     */
    QobuzSearchAlbumAll::~QobuzSearchAlbumAll(){
     ...
     * @param jsonObj
     */
    void QobuzSearchAlbumAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void QobuzSearchAlbumAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void QobuzSearchAlbumAll::setUIControl_albums(){
     ...
     */
    void QobuzSearchAlbumAll::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void QobuzSearchAlbumAll::request_more_albumData(){
        ...
        if(!this->flagReqMore_album && !this->flag_lastPage_album){
            ...
            connect(proc, &ProcCommon::completeReq_list_albums, this, &QobuzSearchAlbumAll::slot_applyResult_albums);
            proc->request_qobuz_searchAllItems(this->data_search.search_keyword, this->album_widget_cnt, this->next_offset, ProcCommon::QobuzSearch_ContentType::Albums);
    ...
    void QobuzSearchAlbumAll::request_more_albumDraw(){
        ...
        for(int i = start_index; i < this->album_draw_cnt; i++){
            ...
            connect(this->listAlbum_all[i], &qobuz::ItemAlbum_qobuz::signal_clicked, this, &QobuzSearchAlbumAll::slot_clickedItemAlbum);
        }
     ...
     * @param list_data
     */
    void QobuzSearchAlbumAll::slot_applyResult_albums(const QList<qobuz::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void QobuzSearchAlbumAll::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void QobuzSearchAlbumAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
