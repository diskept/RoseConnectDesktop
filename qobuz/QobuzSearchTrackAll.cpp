...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzSearchTrackAll::QobuzSearchTrackAll(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll_rosefilter, parent) {
     ...
     * @brief 소멸자.
     */
    QobuzSearchTrackAll::~QobuzSearchTrackAll(){
     ...
     * @param jsonObj
     */
    void QobuzSearchTrackAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void QobuzSearchTrackAll::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(btn_playAll, &QPushButton::clicked, this, &QobuzSearchTrackAll::slot_btnClicked_playAll);
            ...
            connect(btn_shuffleAll, &QPushButton::clicked, this, &QobuzSearchTrackAll::slot_btnClicked_playShuffle);
     ...
     */
    void QobuzSearchTrackAll::proc_wheelEvent_to_getMoreData(){
    ...
    void QobuzSearchTrackAll::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->track_listAll[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &QobuzSearchTrackAll::slot_clickedItemTrack_inList);
        ...
        connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &QobuzSearchTrackAll::slot_applyResult_getRating_track);
     ...
     * @param page
     */
    void QobuzSearchTrackAll::request_more_trackData(){
        ...
        if(!this->flagReqMore_track && !this->flag_lastPage_track){
            ...
            connect(proc, &ProcCommon::completeReq_list_tracks, this, &QobuzSearchTrackAll::slot_applyResult_tracks);
            proc->request_qobuz_searchAllItems(this->data_search.search_keyword, GET_ITEM_SIZE___ONCE, next_offset, ProcCommon::QobuzSearch_ContentType::Tracks);
        }
    }
     ...
     * @param list_data
     */
    void QobuzSearchTrackAll::slot_applyResult_tracks(const QList<qobuz::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
...
//        }
    ...
    void QobuzSearchTrackAll::slot_applyResult_checkRating_track(const QJsonObject &jsonObj){
        ...
        if(id <= 0){
            ...
            roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
            connect(proc_fav_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &QobuzSearchTrackAll::slot_applyResult_checkComplete_track);
    ...
    void QobuzSearchTrackAll::slot_applyResult_checkComplete_track(const QJsonObject &jsonObj){
    ...
    void QobuzSearchTrackAll::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void QobuzSearchTrackAll::slot_btnClicked_playAll(){
    ...
    void QobuzSearchTrackAll::slot_btnClicked_playShuffle(){
     ...
     * @param clickMode
     */
    void QobuzSearchTrackAll::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
     ...
     * @param section
     */
    void QobuzSearchTrackAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
