...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzHistoryDetail::QobuzHistoryDetail(QWidget *parent) : AbstractQobuzSubWidget(VerticalScroll_rosefilter, parent) {
     ...
     * @brief 소멸자.
     */
    QobuzHistoryDetail::~QobuzHistoryDetail(){

        this->deleteLater();
    }


    void QobuzHistoryDetail::setJsonObject_forData(const QJsonObject& jsonObj){
    ...
    void QobuzHistoryDetail::setActivePage(){
        ...
        if(this->flagNeedReload == true){
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_playlist[i], &roseHome::ItemPlaylist_rosehome::signal_clicked, this, &QobuzHistoryDetail::slot_clickedItemPlaylist);
            }
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_album[i], &roseHome::ItemAlbum_rosehome::signal_clicked, this, &QobuzHistoryDetail::slot_clickedItemAlbum);
            }

            for (int i = 0; i < 5; i++) {
                this->home_history_track[i] = new PlaylistTrackDetailInfo_RHV;
                connect(this->home_history_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &QobuzHistoryDetail::slot_clickedItemTrack_inList);
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_artist[i], &roseHome::ItemArtist_rosehome::signal_clicked, this, &QobuzHistoryDetail::slot_clickedItemArtist);
            }

            roseHome::ProcCommon *proc_playlist = new roseHome::ProcCommon(this);
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_playlists, this, &QobuzHistoryDetail::slot_applyResult_historyPlaylist);
            ...
            connect(proc_album, &roseHome::ProcCommon::completeReq_list_albums, this, &QobuzHistoryDetail::slot_applyResult_historyAlbum);
            ...
            connect(proc_track, &roseHome::ProcCommon::completeReq_list_tracks, this, &QobuzHistoryDetail::slot_applyResult_historyTrack);
            ...
            connect(proc_artist, &roseHome::ProcCommon::completeReq_list_artists, this, &QobuzHistoryDetail::slot_applyResult_historyArtist);
            proc_artist->request_rose_getList_historyArtists(this->historyData.yearMonth, this->historyData.filter_type, 0, 10);
        }
    }


    QWidget* QobuzHistoryDetail::setUIControl_subTitle_withSideBtn(const QString subTitle, const QString btnText, const int btnId, QLayout *p_layout){
    ...
    void QobuzHistoryDetail::setUIControl_appendWidget_hitsory(){
    ...
    void QobuzHistoryDetail::slot_applyResult_historyPlaylist(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void QobuzHistoryDetail::slot_applyResult_historyAlbum(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void QobuzHistoryDetail::slot_applyResult_historyTrack(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void QobuzHistoryDetail::slot_applyResult_historyArtist(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void QobuzHistoryDetail::slot_qobuz_completeReq_listAll_myFavoritesIds(const QJsonObject& contents){
...
//                    connect(proc, &qobuz::ProcCommon::completeReq_listAll_myFavoritesIds, this, &QobuzHistoryDetail::slot_qobuz_completeReq_listAll_myFavoritesIds);
...
//        }
    ...
    void QobuzHistoryDetail::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void QobuzHistoryDetail::slot_clickBtn_subTitle_viewAll(){
        ...
        if(btnId == BTN_IDX_SUBTITLE_HistoryPlaylist){
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_Q_HISTORY_PLAYLIST_VIEW);
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_Q_HISTORY_ALBUM_VIEW);
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_Q_HISTORY_TRACK_VIEW);
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_Q_HISTORY_ARTIST_VIEW);
    ...
    /**
         ...
         * @param clickMode
         */
    void QobuzHistoryDetail::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
    ...
    /**
         ...
         * @param clickMode
         */
    void QobuzHistoryDetail::slot_clickedItemPlaylist(const tidal::AbstractItem::ClickMode clickMode){
    ...
    /**
         ...
         * @param clickMode
         */
    void QobuzHistoryDetail::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &QobuzHistoryDetail::slot_applyResult_getRating_track);
    ...
    /**
         ...
         * @param clickMode
         */
    void QobuzHistoryDetail::slot_clickedItemArtist(const tidal::AbstractItem::ClickMode clickMode){
    ...
    /**
         ...
         * @param section
         */
    void QobuzHistoryDetail::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
        ...
        if(section == SECTION_FOR_MORE_POPUP___HistoryPlaylist){
            ...
            {
                if(this->list_historyPlaylist->at(index).type == "QOBUZ" && this->list_historyPlaylist->at(index).isRose == false){
                    qobuz::PlaylistItemData tmpPlaylist;
                    tmpPlaylist.id = this->list_historyPlaylist->at(index).clientKey;
                    tmpPlaylist.tracks_count = 100;
                    qobuz::ProcRosePlay_withQobuz *procRosePlay = new qobuz::ProcRosePlay_withQobuz(this);
            ...
            )
            {
                // Rose Play 요청
                qobuz::ProcRosePlay_withQobuz *procRosePlay = new qobuz::ProcRosePlay_withQobuz(this);
                procRosePlay->requestPlayRose_byAlbumID(this->list_historyAlbum->at(index).clientKey, clickMode);
            }
        }
