...
namespace qobuz {
    ...
    /**
     * @brief QobuzHistoryListAll::QobuzHistoryListAll
     * @param parent
     */
    QobuzHistoryListAll::QobuzHistoryListAll(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll_roseviewAll, parent) {
     ...
     * @brief 소멸자.
     */
    QobuzHistoryListAll::~QobuzHistoryListAll(){
     ...
     * @param jsonObj
     */
    void QobuzHistoryListAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void QobuzHistoryListAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void QobuzHistoryListAll::setUIControl_history(){
     ...
     * @param list_data
     */
    void QobuzHistoryListAll::slot_applyResult_history(const QList<roseHome::HistoryItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            if(start_index == 0){
                ...
                for(int i = start_index; i < max_cnt; i++){
                    connect(this->listHistory_all[i], &roseHome::ItemHistory_rosehome::signal_clicked, this, &QobuzHistoryListAll::slot_clickedItemAlbum);
     ...
     * @param clickMode
     */
    void QobuzHistoryListAll::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param event
     */
    void QobuzHistoryListAll::resizeEvent(QResizeEvent *event){//c230223
