...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzMyPlaylistEdit::QobuzMyPlaylistEdit(QWidget *parent)
        : AbstractQobuzSubWidget(MainUIType::VerticalScroll, parent)
    {
     ...
     * @brief 소멸자.
     */
    QobuzMyPlaylistEdit::~QobuzMyPlaylistEdit(){
    ...
    /**
     * @brief QobuzMyPlaylistEdit::setJsonObject_forData
     * @param jsonObj
     */
    void QobuzMyPlaylistEdit::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void QobuzMyPlaylistEdit::setActivePage(){
    ...
    /**
     * @brief QobuzMyPlaylistEdit::setUIControl_playlist_info
     */
    void QobuzMyPlaylistEdit::setUIControl_basic(){
        ...
        //QObject::connect(this->playlistImageDetailInfo, &PlaylistImageDetailInfo::signal_clicked, this, &QobuzMyPlaylistEdit::slot_detailInfo_btnClicked);
        QObject::connect(this->playlistImageDetailInfo, &PlaylistImageDetailInfo_forQobuz::signal_clicked, this, &QobuzMyPlaylistEdit::slot_detailInfo_btnClicked);
        ...
        // Playlist의 트랙정보
        this->delegate_edit = new QobuzEditTrackDelegate(AbstractQobuzSubWidget::parent());
        QObject::connect(this->delegate_edit, &QobuzEditTrackDelegate::clicked, this, &QobuzMyPlaylistEdit::slot_editDelegate_clickedItemTrack_inList);
    ...
    /**
     * @brief QobuzMyPlaylistEdit::setUIControl_topBtns
     */
    void QobuzMyPlaylistEdit::setUIControl_topBtns(){
        ...
        QObject::connect(checkbox_allSelected, &QCheckBox::clicked, this, &QobuzMyPlaylistEdit::slot_clickedAllSelected);
        ...
        QObject::connect(btn_delete, &QPushButton::clicked, this, &QobuzMyPlaylistEdit::slot_clickedDelete);
    ...
    /**
     * @brief QobuzMyPlaylistEdit::slot_clickedAllSelected [SLOT] 전체선택 체크박스 클릭시
     */
    void QobuzMyPlaylistEdit::slot_clickedAllSelected(){
    ...
    /**
     * @brief QobuzMyPlaylistEdit::slot_clickedDelete
     */
    void QobuzMyPlaylistEdit::slot_clickedDelete(){
        ...
        if(list_index.count() > 0){
            ...
            connect(proc, &ProcCommon::completeReq_delete_items_in_myPlaylist, this, &QobuzMyPlaylistEdit::slot_completeReq_delete_items_in_myPlaylist);
            proc->request_qobuz_delete_items_in_myPlaylist(this->data_playlist.id, list_index);
        }
    ...
    /**
     * @brief QobuzMyPlaylistEdit::slot_editDelegate_clickedItemTrack_inList
     * @param index
     * @param clickMode
     */
    void QobuzMyPlaylistEdit::slot_editDelegate_clickedItemTrack_inList(const int index, const AbstractEditListDelegate::ClickMode clickMode){
    ...
    /**
     * @brief QobuzMyPlaylistEdit::slot_completeReq_delete_items_in_myPlaylist
     */
    void QobuzMyPlaylistEdit::slot_completeReq_delete_items_in_myPlaylist(){
     ...
     * @param page
     */
    void QobuzMyPlaylistEdit::request_more_trackData(){
        if(!this->flagReqMore_track && !this->flag_lastPage_track){
            ...
            // request HTTP API
            ProcCommon *proc = new ProcCommon(this);
            QObject::connect(proc, &ProcCommon::completeReq_list_items_of_playlist, this, &QobuzMyPlaylistEdit::slot_applyResult_items_of_playlist);
            proc->request_qobuz_getList_items_of_playlist(this->data_playlist.id, this->data_playlist.tracks_count, next_offset);
     ...
     */
    void QobuzMyPlaylistEdit::slot_applyResult_items_of_playlist(const QList<qobuz::TrackItemData> &list_track, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     */
    void QobuzMyPlaylistEdit::slot_editDelegate_thumbnailDownloaded_fotListWidget(){
     ...
     * @param clickMode
     */
    //void QobuzMyPlaylistEdit::slot_detailInfo_btnClicked(const AbstractImageDetailInfo::BtnClickMode clickMode){
    void QobuzMyPlaylistEdit::slot_detailInfo_btnClicked(const AbstractImageDetailInfo_forQobuz::BtnClickMode clickMode){
