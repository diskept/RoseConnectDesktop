#ifndef QOBUZRECENTLYLISTDELETE_H
#define QOBUZRECENTLYLISTDELETE_H
...
namespace qobuz {
     ...
     */
    class QobuzRecentlyListDelete: public AbstractQobuzSubWidget
    {
        Q_OBJECT
    public:
        explicit QobuzRecentlyListDelete(QWidget *parent = nullptr);
        ~QobuzRecentlyListDelete();
...
#endif // QOBUZRECENTLYLISTDELETE_H
