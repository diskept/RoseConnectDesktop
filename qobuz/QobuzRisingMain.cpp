...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzRisingMain::QobuzRisingMain(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll, parent){
     ...
     * @brief 소멸자.
     */
    QobuzRisingMain::~QobuzRisingMain(){
    }
     ...
     * HTTP API 호출한다.
     */
    void QobuzRisingMain::setActivePage(){
        ...
        if(this->flagInitDraw){
            ...
            connect(proc, &ProcCommon::completeReq_list_albums, this, &QobuzRisingMain::slot_applyResult_albums);
            connect(proc, &ProcCommon::completeReq_list_tracks, this, &QobuzRisingMain::slot_applyResult_tracks);
            proc->request_qobuz_getList_albums(TIDAL_API_PATH_ALBUM, "", 0, 10, 0);
            proc->request_qobuz_getList_tracks(TIDAL_API_PATH_TRACK, 5, 0);
        }
    }
     ...
     */
    void QobuzRisingMain::setUIControl_track(){
        ...
        connect(delegate, &QobuzTrackDelegate::clicked, this, &QobuzRisingMain::slot_clickedItemTrack_inList);
     ...
     */
    void QobuzRisingMain::setUIControl_album(){
     ...
     * @param list_data
     */
    void QobuzRisingMain::slot_applyResult_albums(const QList<qobuz::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     */
    void QobuzRisingMain::slot_applyResult_tracks(const QList<qobuz::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        Q_UNUSED(flag_lastPage);
     ...
     */
    void QobuzRisingMain::slot_thumbnailDownloaded_fotListWidget_track(){
     ...
     * @param btnId
     */
    void QobuzRisingMain::slot_clickBtn_subTitle_side(const int btnId){
     ...
     * @param clickMode
     */
    void QobuzRisingMain::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param clickMode
     */
    void QobuzRisingMain::slot_clickedItemTrack_inList(const int idx, const tidal::AbstractTidalTrackDelegate::ClickMode clickMode){
     ...
     * @param section
     */
    void QobuzRisingMain::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
