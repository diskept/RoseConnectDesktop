...
#include "qobuz/ItemImage_Artist_forQobuz.h"
...
namespace qobuz {
     ...
     * @param parent
     */
    ItemArtist_qobuz::ItemArtist_qobuz(int index, int section, ImageSizeMode imageSizeMode, QWidget *parent)
     ...
     */
    void ItemArtist_qobuz::setUIControl(){

        int base_height = 0;
        int img_width = 0;

        this->itemImage = new ItemImage_Artist_qobuz(this->get_imageWidth(this->m_imageSizeMode));
        connect(this->itemImage, &ItemImage_Artist_qobuz::signal_clickedBtn, this, &ItemArtist_qobuz::slot_itemImage_clickedBtn);
     ...
     */
    void ItemArtist_qobuz::setData(const qobuz::ArtistItemData &p_data_artist){
     ...
     * @return
     */
    int ItemArtist_qobuz::get_fixedHeight(){
     ...
     * @param event
     */
    void ItemArtist_qobuz::paintEvent(QPaintEvent *event){
        ...
        if(this->flagInitDraw == false){
            ...
            this->itemImage->setImage(this->data_artist.image_large);

            int all_width = this->itemImage->sizeHint().width();

            QString artist = this->data_artist.name;
