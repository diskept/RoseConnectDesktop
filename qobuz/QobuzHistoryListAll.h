#ifndef QOBUZHISTORYLISTALL_H
#define QOBUZHISTORYLISTALL_H
...
namespace qobuz {
     ...
     */
    class QobuzHistoryListAll : public AbstractQobuzSubWidget
    {
        Q_OBJECT
    public:
        explicit QobuzHistoryListAll(QWidget *parent = nullptr);
        ~QobuzHistoryListAll();
