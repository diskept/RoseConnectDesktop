...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzArtistListAll::QobuzArtistListAll(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll_viewAll, parent) {
     ...
     * @brief 소멸자.
     */
    QobuzArtistListAll::~QobuzArtistListAll(){
     ...
     * @param jsonObj
     */
    void QobuzArtistListAll::setJsonObject_forData(const QJsonObject &jsonObj){

        qobuz::PageInfo_ArtistAllView data_pageInfo = ConvertData::convertData_pageInfo_artistAllView(jsonObj);
        this->flagNeedReload = false;

        if((this->api_subPath != data_pageInfo.api_subPath) || (this->artist_id != data_pageInfo.artist_id)){
     ...
     * HTTP API 호출한다.
     */
    void QobuzArtistListAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void QobuzArtistListAll::setUIControl_artists(){
     ...
     */
    void QobuzArtistListAll::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void QobuzArtistListAll::request_more_artistData(){
        ...
        if(!this->flagReqMore_artist && !this->flag_lastPage_artist){
            ...
            connect(proc, &ProcCommon::completeReq_list_artists, this, &QobuzArtistListAll::slot_applyResult_artists);
            proc->request_qobuz_getList_artists(this->api_subPath, this->artist_id, this->artist_draw_cnt, this->next_offset);
    ...
    void QobuzArtistListAll::request_more_artistDraw(){
        ...
        for(int i = start_index; i < this->artist_draw_cnt; i++){
            ...
            connect(this->listArtist_all[i], &qobuz::ItemArtist_qobuz::signal_clicked, this, &QobuzArtistListAll::slot_clickedItemArtist);
        }
     ...
     * @param list_data
     */
    void QobuzArtistListAll::slot_applyResult_artists(const QList<qobuz::ArtistItemData> &list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void QobuzArtistListAll::slot_clickedItemArtist(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void QobuzArtistListAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
