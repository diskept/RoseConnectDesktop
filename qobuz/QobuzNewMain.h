#ifndef QOBUZNEWMAIN_H
#define QOBUZNEWMAIN_H
...
namespace qobuz {
    ...
    /**
     * @brief Qobuz > 탐색 > New 선택한 화면
     */
    class QobuzNewMain : public AbstractQobuzSubWidget
    {
        Q_OBJECT
    public:
        explicit QobuzNewMain(QWidget *parent = nullptr);
        ~QobuzNewMain();
