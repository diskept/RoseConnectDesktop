...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzNewMain::QobuzNewMain(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll, parent){
     ...
     * HTTP API 호출한다.
     */
    void QobuzNewMain::setActivePage(){
        ...
        if(this->flagInitDraw){
            ...
            connect(proc, &ProcCommon::completeReq_list_albums, this, &QobuzNewMain::slot_applyResult_albums);
            connect(proc, &ProcCommon::completeReq_list_tracks, this, &QobuzNewMain::slot_applyResult_tracks);
     ...
     */
    void QobuzNewMain::setUIControl_track(){
        ...
        connect(delegate, &QobuzTrackDelegate::clicked, this, &QobuzNewMain::slot_clickedItemTrack_inList);
     ...
     */
    void QobuzNewMain::setUIControl_album(){
     ...
     * @param list_data
     */
    void QobuzNewMain::slot_applyResult_albums(const QList<qobuz::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    /**
     * @brief QobuzNewMain::slot_applyResult_tracks
     * @param list_data
     * @param jsonArr_dataToPlay
     */
    void QobuzNewMain::slot_applyResult_tracks(const QList<qobuz::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        Q_UNUSED(flag_lastPage);
     ...
     */
    void QobuzNewMain::slot_thumbnailDownloaded_fotListWidget_track(){
     ...
     * @param btnId
     */
    void QobuzNewMain::slot_clickBtn_subTitle_side(const int btnId){
     ...
     * @param clickMode
     */
    void QobuzNewMain::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param clickMode
     */
    void QobuzNewMain::slot_clickedItemTrack_inList(const int idx, const tidal::AbstractTidalTrackDelegate::ClickMode clickMode){
     ...
     * @param section
     */
    void QobuzNewMain::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
