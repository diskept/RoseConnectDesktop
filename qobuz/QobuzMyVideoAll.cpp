...
namespace qobuz {
     ...
     * @param parent
     */
    QobuzMyVideoAll::QobuzMyVideoAll(QWidget *parent) : AbstractQobuzSubWidget(MainUIType::VerticalScroll, parent) {
     ...
     * @brief 소멸자.
     */
    QobuzMyVideoAll::~QobuzMyVideoAll(){
    }
     ...
     * @brief 화면 활성화
     */
    void QobuzMyVideoAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void QobuzMyVideoAll::setUIControl_video(){
        ...
        connect(this->chooseFilterOpt, &bugs::BugsChooseFilterOpt::signal_clicked_filterOpt, this, &QobuzMyVideoAll::slot_chooseFilterOption);
        this->chooseFilterOpt->hideFilterBox();
    }
    ...
    void QobuzMyVideoAll::setUiControl_filter(){
        ...
        QString def_name = this->list_filterOpt_sort.first().opt_name;
        this->filterWidget->add_filter(def_code, def_name);
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &QobuzMyVideoAll::slot_filterClicked);
     ...
     */
    void QobuzMyVideoAll::proc_wheelEvent_to_getMoreData(){
        this->request_more_videoData();
    }
     ...
     * @param event
     */
    void QobuzMyVideoAll::resizeEvent(QResizeEvent *event){
     ...
     */
    void QobuzMyVideoAll::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void QobuzMyVideoAll::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
     ...
     * @param page
     */
    void QobuzMyVideoAll::request_more_videoData(){
        if(!this->flagReqMore_video && !this->flag_lastPage_video){
            ...
            connect(proc, &ProcCommon::completeReq_list_myFavoriteVideos, this, &QobuzMyVideoAll::slot_applyResult_myFavoriteVideos);
            proc->request_qobuz_getList_myFavoriteVideos(sortOpt, orderDirection, GET_ITEM_SIZE___ONCE, next_offset);       // 최대 99까지
        }
    }
    ...
    /**
     * @brief QobuzMycollection::slot_applyResult_myFavoriteVideos
     * @param list_data
     */
    void QobuzMyVideoAll::slot_applyResult_myFavoriteVideos(const QList<qobuz::VideoItemData> &list_data, const bool flag_lastPage){
     ...
     * @param clickMode
     */
    void QobuzMyVideoAll::slot_clickedItemVideo(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param section
     */
    void QobuzMyVideoAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
