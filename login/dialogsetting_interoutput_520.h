#ifndef DIALOGSETTING_INTEROUTPUT_520_H
#define DIALOGSETTING_INTEROUTPUT_520_H
 ...
 */
class dialogsetting_interoutput_520 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_interoutput_520(QWidget *parent = nullptr);
