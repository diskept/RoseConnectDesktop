 ...
 * @param parent
 */
DialogSelect_Usbdac_150::DialogSelect_Usbdac_150(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void DialogSelect_Usbdac_150::setInit(){
    this->setModal(true);
 ...
 */
void DialogSelect_Usbdac_150::setUIControl(){
 ...
 */
void DialogSelect_Usbdac_150::slot_clickedAdd(){
...
void DialogSelect_Usbdac_150::set_selectedUsbName(QString usbstr){
    selectedUsbName = usbstr;
}
QString DialogSelect_Usbdac_150::get_selectedUsbName(){
    return selectedUsbName;
}
void DialogSelect_Usbdac_150::setTextName(QString usbstr){
    radio_UsbName->setText(usbstr);
}

void DialogSelect_Usbdac_150::setPropertyName(QString usbstr){
