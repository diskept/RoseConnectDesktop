#ifndef DIALOGSETTING_RXSETTING_H
#define DIALOGSETTING_RXSETTING_H
 ...
 */
class dialogsetting_RXsetting : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_RXsetting(QWidget *parent = nullptr);
    QString getSelecteddeviceName() const{
        return selected_deviceName;
    };

private slots:
    void slot_clickedUsbChangeSet();
    ...
    void slot_modeOnOff_RX();//c220708
    void slot_print();
    ...
    void slot_clickedRXquestion();//c220708
