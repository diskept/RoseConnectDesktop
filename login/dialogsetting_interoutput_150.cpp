 ...
 * @param parent
 */
dialogsetting_interoutput_150::dialogsetting_interoutput_150(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_interoutput_150::setInit(){
    this->setModal(true);
    this->setWindowFlags(Qt::Dialog | Qt::FramelessWindowHint);
    this->setAttribute(Qt::WA_TranslucentBackground);
    this->setFixedSize(DLG_WIDTH, DLG_HEIGHT+270);
 ...
 */
void dialogsetting_interoutput_150::setUIControl(){
   ...
   // vl_total1->addWidget(this->getUIControlOption(tr("PCM Resampling Frequency"), comboBoxOpt_coaxPCM));//cheon01
    ...
    comboBoxOpt_coaxDSD->addItem(tr("Native DSD"), 0);
    comboBoxOpt_coaxDSD->addItem(tr("DSD over PCM"), 1);
    comboBoxOpt_coaxDSD->addItem(tr("DSD to PCM"), 2);
...
QWidget* dialogsetting_interoutput_150::getUIControlOption_32(QString p_title){
...
void dialogsetting_interoutput_150::slot_clickedBit32question(){//c220511
    print_debug();
...
void dialogsetting_interoutput_150::slot_clickedDSDquestion(){//c220511
    print_debug();
    dlgConfirmOpt_coax->setAlignment(Qt::AlignLeft);
...
void dialogsetting_interoutput_150::slot_clickedI2Squestion(){//c220511
    print_debug();
    dlgConfirmOpt_coax->setAlignment(Qt::AlignLeft);
    ...
    dlgConfirmOpt_coax->setTextHeight(100);
    dlgConfirmOpt_coax->setGeometry((this->geometry().left() + (DLG_WIDTH - 660) / 2), this->geometry().top() + (DLG_HEIGHT - dlgConfirmOpt_coax->sizeHint().height()) / 2, 0, 0);
    dlgConfirmOpt_coax->setAlertMode();
    dlgConfirmOpt_coax->setProperty("flagShown",false);
...
void dialogsetting_interoutput_150::slot_clickedPCMquestion(){//c220511
    print_debug();
    dlgConfirmOpt_coax->setAlignment(Qt::AlignLeft);
...
void dialogsetting_interoutput_150::slot_clickedSoftwareVolquestion(){//c220511
    print_debug();
    dlgConfirmOpt_coax->setAlignment(Qt::AlignLeft);
...
void dialogsetting_interoutput_150::slot_clickedOpt_coaxoutputGain(){
    this->dlgOpt_coaxMqa();
    QTimer::singleShot(500, this, SLOT(slot_showDlgOfOpt_coaxNotice()));
}
void dialogsetting_interoutput_150::slot_clickedOpt_coaxmqaGain(){
    this->dlgOpt_coaxOutput();
    QTimer::singleShot(500, this, SLOT(slot_showDlgOfOpt_coaxNotice()));
}
void dialogsetting_interoutput_150::slot_clickedOpt_coaxpassGain(){
    this->dlgOpt_coaxPass();
    QTimer::singleShot(500, this, SLOT(slot_showDlgOfOpt_coaxNotice()));
}

void dialogsetting_interoutput_150::dlgOpt_coaxMqa(){
...
void dialogsetting_interoutput_150::dlgOpt_coaxOutput(){
...
void dialogsetting_interoutput_150::dlgOpt_coaxPass(){
...
void dialogsetting_interoutput_150::slot_showDlgOfOpt_coaxNotice(){
...
void dialogsetting_interoutput_150::set_settingOfOpt_coaxDetail(QJsonObject tmpJson){
        this->Opt_coaxDetailData = tmpJson;
}

QJsonObject dialogsetting_interoutput_150::get_settingOfOpt_coaxDetail(){
        return this->Opt_coaxDetailData;
}

void dialogsetting_interoutput_150::slot_clickedDVIAB(){
...
void dialogsetting_interoutput_150::slot_changedIndexOpt_coax(int index){
...
QWidget* dialogsetting_interoutput_150::getUIControlOption(QString p_title){
...
QWidget* dialogsetting_interoutput_150::getPlusMinusUIControlOption(QString p_title, int i, int data){
...
void dialogsetting_interoutput_150::slot_clickedOpt_coaxaddmqaGain(){
...
void dialogsetting_interoutput_150::slot_clickedOpt_coaxsubmqaGain(){
    if( mqadBData > -20 )
        mqadBData -= 1;
    this->lb_text[0]->setText(QString("%1").arg(this->mqadBData) + tr("           ") + tr("dB"));
    this->Opt_coaxDetailData.insert( "mqaRelplayGain", this->mqadBData);
...
void dialogsetting_interoutput_150::slot_clickedOpt_coaxaddoutputGain(){
...
void dialogsetting_interoutput_150::slot_clickedOpt_coaxsuboutputGain(){
    if( outputdBData > -20 )
        outputdBData -= 1;
 ...
 * @return
 */
QWidget* dialogsetting_interoutput_150::getUIControlOption(QString p_title, QString p_content, int index){
...
void dialogsetting_interoutput_150::slot_modeOnOff(){
...
void dialogsetting_interoutput_150::slot_print(){
...
void dialogsetting_interoutput_150::getOpt_coaxSettingOfsetting(){
...
void dialogsetting_interoutput_150::getOpt_coaxInOutSettingOfsetting(){
...
void dialogsetting_interoutput_150::slot_clickedOpt_coaxChangeSet(){
   //print_debug();
...
void dialogsetting_interoutput_150::slot_modeOnOff_32(){
...
void dialogsetting_interoutput_150::setDialogOpt_coax_show(){
   // QJsonObject *Opt_coax_json = get_settingOfOpt_coaxDetail();
...
void dialogsetting_interoutput_150::setDialogOpt_coax_save(QJsonObject p_jsonObject){
    QJsonObject tmp_Json;
...
void dialogsetting_interoutput_150::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
...
void dialogsetting_interoutput_150::set_selected_deviceName(QString usbstr){
    this->selected_deviceName = usbstr;
}
QString dialogsetting_interoutput_150::get_selected_deviceName(){
    return this->selected_deviceName;
}
void dialogsetting_interoutput_150::setTextName(QString usbstr){
    this->radio_UsbName->setText(usbstr);
}

void dialogsetting_interoutput_150::setPropertyName(QString usbstr){
    this->radio_UsbName->setProperty(PROPERTY_NAME_READABLE, usbstr);
}

void dialogsetting_interoutput_150::loding_ani_init(){
...
void dialogsetting_interoutput_150::loding_ani_show(){
...
void dialogsetting_interoutput_150::loding_ani_hide(){
