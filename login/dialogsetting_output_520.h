#ifndef DIALOGSETTING_OUTPUT_520_H
#define DIALOGSETTING_OUTPUT_520_H
 ...
 */
class dialogsetting_output_520 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_output_520(QWidget *parent = nullptr);
...
private slots:
    ...
    void slot_clickedSPEAKERquestion();
