#include "dialogsetting_output_520.h"
 ...
 * @param parent
 */
dialogsetting_output_520::dialogsetting_output_520(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_output_520::setInit(){
    this->setModal(true);
 ...
 */
void dialogsetting_output_520::setUIControl(){
    ...
    QPushButton *btn_questionSPEAKER;//
    btn_questionSPEAKER =  GSCommon::getUIBtnImg("question", ":images/setting/201/tip_icon.png");
    btn_questionSPEAKER->setCursor(Qt::PointingHandCursor);
    btn_questionSPEAKER->setFixedSize(QSize(30,30));
    QPushButton *btn_questionRoon;
...
//520//c220713
    ...
    comboBoxOutputPreoutLevel->addItem(tr(" 30 mV"), 1);//cheon01_src
    comboBoxOutputPreoutLevel->addItem(tr(" 60 mV"), 2);//cheon01_src
    comboBoxOutputPreoutLevel->addItem(tr(" 95 mV"), 3);//cheon01_src
    comboBoxOutputPreoutLevel->addItem(tr(" 120 mV"), 4);//cheon01_src
    comboBoxOutputPreoutLevel->addItem(tr(" 160 mV"), 5);//cheon01_src
    comboBoxOutputPreoutLevel->addItem(tr(" 300 mV"), 6);
    comboBoxOutputPreoutLevel->addItem(tr(" 600 mV"), 7);
    comboBoxOutputPreoutLevel->addItem(tr(" 1000 mV"), 8);
    comboBoxOutputPreoutLevel->addItem(tr(" 1300 mV"), 9);
    comboBoxOutputPreoutLevel->addItem(tr(" 1600 mV"), 10);
    comboBoxOutputPreoutLevel->addItem(tr(" 1900 mV"), 11);
    comboBoxOutputPreoutLevel->addItem(tr(" 2000 mV"), 12);
    ...
    comboBoxOutputPreoutLevel->setObjectName("comboBoxOutputPreoutLevel");//cheon01
   ...
   // hl_lb_MQA->setSpacing(30);
    ...
    //--------------------------------------------------------------------------------------------------------
       ...
       // this->list_keyValue.append(1);
        ...
        comboBoxOutputDSD->setObjectName("comboBoxOutputDSD");//cheon01
...
//------------------------------------------------
        ...
        comboBoxOutputSPEAKER->setProperty("btnNo", 22);

        comboBoxOutputSPEAKER->addItem(tr(" Volume Table for Speaker Output"), 0);//cheon01_src
        comboBoxOutputSPEAKER->addItem(tr(" Volume Table for PreAmp Output"), 1);//cheon01_src


        QLabel *lb_SPEAKER = new QLabel(tr("Volume Table Setting"));
        lb_SPEAKER->setStyleSheet("color:#E5E5E4");
        lb_SPEAKER->setFixedHeight(55);//c220511
        lb_SPEAKER->setText((tr("Volume Table Setting")));
        lb_SPEAKER->setStyleSheet("Text-align:left; font-size:18px;color:#E5E5E4; ");
       ...
       // this->list_keyValue.append(1);
        ...
        //comboBox = new QComboBox();
        comboBoxOutputSPEAKER->setContentsMargins(0,0,0,0);
        comboBoxOutputSPEAKER->setFixedHeight(35);
        comboBoxOutputSPEAKER->setObjectName("comboBoxOutputSPEAKER");//cheon01
        comboBoxOutputSPEAKER->setFixedWidth(340);


        comboBoxOutputSPEAKER->setStyleSheet("QComboBox { font-size:18px;color:#FFFFFF; background-color:#333333; padding:5px;  } "
                                    "QComboBox QListView { font-size:18px;color:#FFFFFF; background-color:#333333; } "
                                    "QComboBox QAbstractItemView { selection-color:#FFFFFF; selection-background-color:#B18658; border: 1px solid #B18658;   } "
                                    );
...
//------------------------------------------------------------
   ...
   // print_debug();
    ...
    vl_total1->addWidget(widget_total_PreLevel);//cheon01
     ...
     vl_total1->addWidget(widget_total_Speaker);
   ...
   // vl_total2->addLayout(vl_total_Pass);
    ...
    connect(btn_questionSPEAKER, SIGNAL(clicked()), this, SLOT(slot_clickedSPEAKERquestion()));
    ...
    connect(comboBoxOutputSPEAKER, SIGNAL(currentIndexChanged(int)), this, SLOT(slot_changedIndexOutput(int)));
...
void dialogsetting_output_520::slot_changedIndexOutput(int index){
 ...
 //   QJsonObject Output_json = get_settingOfOutputDetail();
    ...
    case  22 :
        selectedOutput_str = comboBoxOutputSPEAKER->itemText(index);
        qDebug() << " selectedOutput_str: " << selectedOutput_str;
...
QWidget* dialogsetting_output_520::getUIControlOption_bit32(QString p_title){
...
void dialogsetting_output_520::slot_modeOnOff_32(){
...
void dialogsetting_output_520::slot_clickedbit32question(){//c220511
    print_debug();
...
void dialogsetting_output_520::slot_clickedDSDquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_520::slot_clickedSPEAKERquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_520::slot_clickedPCMquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_520::slot_clickedPreLevelquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
    dlgConfirmOutput->setTitle(tr("PCM Resampling Frequency"));
...
void dialogsetting_output_520::slot_clickedHOIquestion(){//c220708
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_520::slot_clickedSoftwareVolquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_520::slot_clickedPhaseInvertquestion(){//c220709
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
    ...
    pixmapPI_off.load(":images/setting/520/pi_01.png");
    pixmapPI_off = pixmapPI_off.scaled(300,300, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
    pixmapPI_on.load(":images/setting/520/pi_02.png");
...
void dialogsetting_output_520::slot_clickedFIRquestion(){//c220708
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_520::slot_clickedRadioVolLev(){
    int notmalMinval = -70;
    int notmalMaxval = 0;
    int lowMinval = -80;
    int lowMaxval = -5;
 ...
 * @param p_value
 */
void dialogsetting_output_520::slot_setTextVolumnMin(int p_value){
    print_debug();
    int min_volLevel = -60;
...
void dialogsetting_output_520::slot_setTextVolumnMax(int p_value){
    print_debug();
 ...
 */
QWidget* dialogsetting_output_520::getVolumeUIControlOptionMin(){
...
QWidget* dialogsetting_output_520::getVolumeUIControlOptionMax(){
...
void dialogsetting_output_520::dlgOutputMqa(){


    //dlgConfirmHdmi->setText(tr("MQA 재생시 Replay Gaon Control을 활성화합니다. \n원하는 평준화값을 설정하시오.\n해당 값은 MQA  음원에만 적용됩니다."));

}
void dialogsetting_output_520::dlgOutputCodecTrim(){
...
void dialogsetting_output_520::slot_clickedOutputcodecTrim(){
...
void dialogsetting_output_520::slot_clickedOutputmqaGain(){
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
...
void dialogsetting_output_520::slot_clickedOutputaddmqaGain(){
...
void dialogsetting_output_520::slot_clickedOutputsubmqaGain(){
    if( mqadBData > -20 )
        mqadBData -= 1;
    lb_text[0]->setText(QString("%1").arg(mqadBData) + tr("           ") + tr("dB"));
    OutputDetailData.insert( "mqaRelplayGain", mqadBData);
...
void dialogsetting_output_520::slot_clickedOutputaddcodecTrim(){
...
void dialogsetting_output_520::slot_clickedOutputsubcodecTrim(){
    if( outputdBData > -20 )
        outputdBData -= 1;
    lb_text[1]->setText(QString("%1").arg(outputdBData) + tr("           ") + tr("dB"));
    OutputDetailData.insert( "codecTrim", outputdBData);
...
QWidget* dialogsetting_output_520::getPlusMinusUIControlOption(QString p_title, int i, int data){
...
void dialogsetting_output_520::dlgOutputOutput(){
...
void dialogsetting_output_520::slot_showDlgOfOutputNotice(){


}


void dialogsetting_output_520::set_settingOfOutputDetail(QJsonObject tmpJson){
        OutputDetailData = tmpJson;
}
QJsonObject dialogsetting_output_520::get_settingOfOutputDetail(){
...
void dialogsetting_output_520::getOutputSettingOfsetting(){
...
void dialogsetting_output_520::getOutputInOutSettingOfsetting(){
...
void dialogsetting_output_520::slot_clickedOutputChangeSet(){
    print_debug();
...
void dialogsetting_output_520::setDialogOutput_show(){
    // QJsonObject *Output_json = get_settingOfOutputDetail();
    ...
    comboBoxOutputSPEAKER->setCurrentIndex( OutputDetailData["volumeTable"].toInt() );
...
void dialogsetting_output_520::setDialogOutput_save(QJsonObject p_jsonObject){
    QJsonObject tmp_Json;
   ...
   // QJsonDocument doc(tmp_Json);  QString strJson(doc.toJson(QJsonDocument::Compact));  qDebug() <<"\npre-setDialogOutput_save()-tmp_Json :"<< strJson;//cheon09_io
     ...
     int volumeTable = tmp_Json["volumeTable"].toInt();
  ...
  //   OutputDetailData.insert( "opticalApwMode", opticalApwMode);
    // OutputDetailData.insert( "opticalApwValue", opticalApwValue);
     ...
     OutputDetailData.insert( "volumeTable", volumeTable);
...
void dialogsetting_output_520::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
...
QWidget* dialogsetting_output_520::getUIControlOption(QString p_title){
...
void dialogsetting_output_520::slot_DRC_question_popup(){
...
void dialogsetting_output_520::slot_CodecTrim_question_popup(){
    dlgOutputCodecTrim();
...
void dialogsetting_output_520::slot_modeOnOff(){
...
void dialogsetting_output_520::dlgOutputDRC(){

}


void dialogsetting_output_520::set_selected_deviceName(QString usbstr){
    selected_deviceName = usbstr;
}
QString dialogsetting_output_520::get_selected_deviceName(){
    return selected_deviceName;
}
void dialogsetting_output_520::setTextName(QString usbstr){
    radio_UsbName->setText(usbstr);
}

void dialogsetting_output_520::setPropertyName(QString usbstr){
