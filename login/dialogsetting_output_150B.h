#ifndef DIALOGSETTING_OUTPUT_150B_H
#define DIALOGSETTING_OUTPUT_150B_H
 ...
 */
class dialogsetting_output_150B : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_output_150B(QWidget *parent = nullptr);
