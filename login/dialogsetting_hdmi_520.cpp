#include "dialogsetting_hdmi_520.h"
 ...
 * @param parent
 */
dialogsetting_hdmi_520::dialogsetting_hdmi_520(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_hdmi_520::setInit(){
    this->setModal(true);
 ...
 */
void dialogsetting_hdmi_520::setUIControl(){
...
void dialogsetting_hdmi_520::slot_clickedDSDquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_520::slot_clickedPassquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_520::slot_clickedbit32question(){//c220511
    print_debug();
...
void dialogsetting_hdmi_520::slot_clickedRoonquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_520::slot_clickedHdmioutputGain(){
...
void dialogsetting_hdmi_520::slot_clickedHdmimqaGain(){
...
void dialogsetting_hdmi_520::slot_clickedHdmipassGain(){
...
void dialogsetting_hdmi_520::dlgHdmiMqa(){
...
void dialogsetting_hdmi_520::dlgHdmiOutput(){
...
void dialogsetting_hdmi_520::dlgHdmiPass(){
...
void dialogsetting_hdmi_520::slot_showDlgOfHdmiNotice(){
...
void dialogsetting_hdmi_520::set_settingOfHdmiDetail(QJsonObject tmpJson){
        this->HdmiDetailData = tmpJson;
}
QJsonObject dialogsetting_hdmi_520::get_settingOfHdmiDetail(){
        return this->HdmiDetailData;
}

void dialogsetting_hdmi_520::slot_changedIndexHdmi(int index){
    print_debug();
...
QWidget* dialogsetting_hdmi_520::getUIControlOption_Pass(QString p_title){
...
QWidget* dialogsetting_hdmi_520::getUIControlOption_bit32(QString p_title){
...
QWidget* dialogsetting_hdmi_520::getUIControlOption(QString p_title){
...
QWidget* dialogsetting_hdmi_520::getPlusMinusUIControlOption(QString p_title, int i, int data){
...
void dialogsetting_hdmi_520::slot_clickedHdmiaddmqaGain(){
...
void dialogsetting_hdmi_520::slot_clickedHdmisubmqaGain(){
    if( mqadBData > -20 )
        mqadBData -= 1;
    this->lb_text[0]->setText(QString("%1").arg(this->mqadBData) + tr("           ") + tr("dB"));
    this->HdmiDetailData.insert( "mqaRelplayGain", this->mqadBData);
...
void dialogsetting_hdmi_520::slot_clickedHdmiaddoutputGain(){
...
void dialogsetting_hdmi_520::slot_clickedHdmisuboutputGain(){
    if( outputdBData > -20 )
        outputdBData -= 1;
 ...
 * @return
 */
QWidget* dialogsetting_hdmi_520::getUIControlOption(QString p_title, QString p_content, int index){
...
void dialogsetting_hdmi_520::slot_modeOnOff_Pass(){
...
void dialogsetting_hdmi_520::slot_modeOnOff_32(){
...
void dialogsetting_hdmi_520::slot_print(){
...
void dialogsetting_hdmi_520::getHdmiSettingOfsetting(){
...
void dialogsetting_hdmi_520::getHdmiInOutSettingOfsetting(){
...
void dialogsetting_hdmi_520::slot_clickedHdmiChangeSet(){
    print_debug();
...
void dialogsetting_hdmi_520::setDialogHdmi_show(){
...
void dialogsetting_hdmi_520::setDialogHdmi_save(QJsonObject p_jsonObject){
    QJsonObject tmp_Json;
...
void dialogsetting_hdmi_520::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
...
void dialogsetting_hdmi_520::set_selected_deviceName(QString usbstr){
    this->selected_deviceName = usbstr;
}
QString dialogsetting_hdmi_520::get_selected_deviceName(){
    return this->selected_deviceName;
}
void dialogsetting_hdmi_520::setTextName(QString usbstr){
    this->radio_UsbName->setText(usbstr);
}

void dialogsetting_hdmi_520::setPropertyName(QString usbstr){
