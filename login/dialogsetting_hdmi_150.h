#ifndef DIALOGSETTING_HDMI_150_H
#define DIALOGSETTING_HDMI_150_H
 ...
 */
class dialogsetting_hdmi_150 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_hdmi_150(QWidget *parent = nullptr);
