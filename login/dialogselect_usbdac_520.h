#ifndef DIALOGSELECT_USBDAC_520_H
#define DIALOGSELECT_USBDAC_520_H
 ...
 */
class DialogSelect_Usbdac_520 : public QDialog
{
    Q_OBJECT
public:
    explicit DialogSelect_Usbdac_520(QWidget *parent = nullptr);
