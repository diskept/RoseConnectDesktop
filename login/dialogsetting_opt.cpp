 ...
 * @param parent
 */
dialogsetting_opt::dialogsetting_opt(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_opt::setInit(){
    this->setModal(true);
...
void dialogsetting_opt::setUIControl(){
    ...
    comboBoxOptopticalMsb->setFixedWidth(100);
   ...
   // hl_lb_MQA->setSpacing(30);
    ...
    lb_PCM->setFixedSize(200,70);
    lb_PCM->setText((tr("  Sampling Frequency")));
    ...
    comboBoxOptopticalLsb->setFixedWidth(110);//c220511
...
void dialogsetting_opt::dlgOptMSB(){
...
void dialogsetting_opt::dlgOptLSB(){
...
void dialogsetting_opt::slot_showDlgOfOptNotice(){
...
void dialogsetting_opt::set_settingOfOptDetail(QJsonObject tmpJson){
        OptDetailData = tmpJson;
}
QJsonObject dialogsetting_opt::get_settingOfOptDetail(){
        return OptDetailData;
}

void dialogsetting_opt::slot_changedIndexOpt(int index){
...
void dialogsetting_opt::getOptSettingOfsetting(){
...
void dialogsetting_opt::getOptInOutSettingOfsetting(){
...
void dialogsetting_opt::setDialogOpt_show(){
   // QJsonObject *Opt_json = get_settingOfOptDetail();
...
void dialogsetting_opt::setDialogOpt_save(QJsonObject p_jsonObject){
    QJsonObject tmp_Json;
...
void dialogsetting_opt::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
    ...
    case HTTP_OPT_SET_MODE :
        ...
        if( deviceType == "RS150" || deviceType == "RS150B"){
            ...
            if(p_jsonObject.contains(jsonKey_flagOk) && p_jsonObject[jsonKey_flagOk].toBool()){
                ...
                ToastMsg::show(this, "", tr("Setting modification was successful."), 100);
                 setResult(QDialog::Accepted);
                 this->hide();

            }else{
                ToastMsg::show(this, "", tr("Failed to modify settings."),100);
...
void dialogsetting_opt::set_selected_deviceName(QString usbstr){
    selected_deviceName = usbstr;
}
QString dialogsetting_opt::get_selected_deviceName(){
    return selected_deviceName;
}
void dialogsetting_opt::setTextName(QString usbstr){
