 ...
 * @param parent
 */
DialogSelect_Usbdac::DialogSelect_Usbdac(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void DialogSelect_Usbdac::setInit(){
    this->setModal(true);
 ...
 */
void DialogSelect_Usbdac::setUIControl(){
...
void DialogSelect_Usbdac::set_selectedUsbName(QString usbstr){
    selectedUsbName = usbstr;
}
QString DialogSelect_Usbdac::get_selectedUsbName(){
    return selectedUsbName;
}
void DialogSelect_Usbdac::setTextName(QString usbstr){
    radio_UsbName->setText(usbstr);
}

void DialogSelect_Usbdac::setPropertyName(QString usbstr){
