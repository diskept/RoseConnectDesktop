#ifndef DIALOGSETTING_INTERNAL_150_H
#define DIALOGSETTING_INTERNAL_150_H
 ...
 */
class dialogsetting_internal_150 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_internal_150(QWidget *parent = nullptr);
