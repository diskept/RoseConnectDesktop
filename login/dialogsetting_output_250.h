#ifndef DIALOGSETTING_OUTPUT_250_H
#define DIALOGSETTING_OUTPUT_250_H
 ...
 */
class dialogsetting_output_250 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_output_250(QWidget *parent = nullptr);
...
private slots:
    ...
    void slot_clickedPhaseInvertquestion();
...
private:
    ...
    int outputdBData;
    int mqadBData;
    QComboBox *comboBoxHOI, *comboBoxSofwareVol, *comboBoxPhaseInvert;
