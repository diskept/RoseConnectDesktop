#ifndef DIALOGSETTING_HDMI_520_H
#define DIALOGSETTING_HDMI_520_H
 ...
 */
class dialogsetting_hdmi_520 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_hdmi_520(QWidget *parent = nullptr);
