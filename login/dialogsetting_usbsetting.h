#ifndef DIALOGSETTING_USBSETTING_H
#define DIALOGSETTING_USBSETTING_H
 ...
 */
class dialogsetting_usbsetting : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_usbsetting(QWidget *parent = nullptr);
