#ifndef DIALOGSETTING_INTEROUTPUT_150_H
#define DIALOGSETTING_INTEROUTPUT_150_H
 ...
 */
class dialogsetting_interoutput_150 : public QDialog
{
    Q_OBJECT
public:
    explicit dialogsetting_interoutput_150(QWidget *parent = nullptr);
