#include "dialoglogin_forqobuz.h"
...
namespace qobuz {
     ...
     * @param parent
     */
    DialogLogin_forQobuz::DialogLogin_forQobuz(QWidget *parent) : QDialog(parent) {
        setInit();
        setUIControl();
     ...
     * @brief 다이얼로그 관련 초기설정
     */
    void DialogLogin_forQobuz::setInit(){
        this->setModal(true);
     ...
     */
    void DialogLogin_forQobuz::setUIControl(){
     ...
     */
    void DialogLogin_forQobuz::setUIControl_topTitle(){
     ...
     */
    void DialogLogin_forQobuz::setUIControl_body(){
     ...
     * @return
     */
    bool DialogLogin_forQobuz::checkUserInput(){
        bool flagOk = true;

        if(lineEdit_email->text().trimmed().isEmpty()){
            flagOk = false;
            ToastMsg::show(this, "",QString(tr("Please enter your Qobuz account email.")));
        }
     ...
     */
    void DialogLogin_forQobuz::slot_clickedLogin(){
        ...
        if(checkUserInput()){
            ...
            proc->request_qobuzLogin(userLoginInfo);
     ...
     * @param errorMsg
     */
    void DialogLogin_forQobuz::slot_failedLogin(const QString& errorMsg){
     ...
     */
    void DialogLogin_forQobuz::slot_successLogin(){
        //emit successLogin();
        //this->close();
        ...
        if(data_length == 0){
            ...
            connect(procQobuz, SIGNAL(successLogin()), this, SLOT(slot_dialogClose()));
    ...
    void DialogLogin_forQobuz::slot_dialogClose(){
        emit successLogin();
        this->close();
    }
