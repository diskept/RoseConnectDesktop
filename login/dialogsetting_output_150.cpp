#include "dialogsetting_output_150.h"
 ...
 * @param parent
 */
dialogsetting_output_150::dialogsetting_output_150(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_output_150::setInit(){
    this->setModal(true);
 ...
 */
void dialogsetting_output_150::setUIControl(){
...
//150//c220713
    ...
    comboBoxOutputPreoutLevel->addItem(tr(" 7000 mV"), 11);
    comboBoxOutputPreoutLevel->addItem(tr(" 8000 mV"), 12);
    comboBoxOutputPreoutLevel->addItem(tr(" 9000 mV"), 13);
   ...
   // hl_lb_MQA->setSpacing(30);
    ...
    lb_PCM->setFixedHeight(70);//c220511
    ...
    //--------------------------------------------------------------------------------------------------------
        ...
        comboBoxOutputDSD->addItem(tr(" DSD to PCM(upto DSD512)"), 2);//cheon01_src
...
//------------------------------------------------
   ...
   // this->list_keyValue.append(1);
    ...
    QLabel *lb_FIR = new QLabel(tr("FIR interpoation phase Filter"));
    lb_FIR->setStyleSheet("color:#E5E5E4");
    lb_FIR->setFixedHeight(70);//c220511
    lb_FIR->setText((tr("FIR interpoation phase Filter")));
...
void dialogsetting_output_150::slot_changedIndexOutput(int index){
...
QWidget* dialogsetting_output_150::getUIControlOption_bit32(QString p_title){
...
void dialogsetting_output_150::slot_modeOnOff_32(){
...
void dialogsetting_output_150::slot_clickedbit32question(){//c220511
    print_debug();
...
void dialogsetting_output_150::slot_clickedDSDquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_150::slot_clickedPCMquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_150::slot_clickedPreLevelquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_150::slot_clickedHOIquestion(){//c220708
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_150::slot_clickedSoftwareVolquestion(){//c220511
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_150::slot_clickedPhaseInvertquestion(){//c220709
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
   ...
   // dlgConfirmOutput->setLayoutMy(lh_PI_Info);
    ...
    dlgConfirmOutput->setTextHeight(100);
    dlgConfirmOutput->setGeometry((this->geometry().left() + (DLG_WIDTH - 660) / 2), this->geometry().top() + (DLG_HEIGHT - dlgConfirmOutput->sizeHint().height()) / 2, 0, 0);
    dlgConfirmOutput->setAlertMode();
...
void dialogsetting_output_150::slot_clickedFIRquestion(){//c220708
    print_debug();
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
    dlgConfirmOutput->setAlignment(Qt::AlignLeft);
...
void dialogsetting_output_150::slot_clickedRadioVolLev(){
    int notmalMinval = -70;
    int notmalMaxval = 0;
    int lowMinval = -80;
    int lowMaxval = -5;
 ...
 * @param p_value
 */
void dialogsetting_output_150::slot_setTextVolumnMin(int p_value){
    print_debug();
    int min_volLevel = -60;
...
void dialogsetting_output_150::slot_setTextVolumnMax(int p_value){
    print_debug();
 ...
 */
QWidget* dialogsetting_output_150::getVolumeUIControlOptionMin(){
...
QWidget* dialogsetting_output_150::getVolumeUIControlOptionMax(){
...
void dialogsetting_output_150::dlgOutputMqa(){


    //dlgConfirmHdmi->setText(tr("MQA 재생시 Replay Gaon Control을 활성화합니다. \n원하는 평준화값을 설정하시오.\n해당 값은 MQA  음원에만 적용됩니다."));

}
void dialogsetting_output_150::dlgOutputCodecTrim(){
...
void dialogsetting_output_150::slot_clickedOutputcodecTrim(){
...
void dialogsetting_output_150::slot_clickedOutputmqaGain(){
    DialogConfirm *dlgConfirmOutput = new DialogConfirm(this);
...
void dialogsetting_output_150::slot_clickedOutputaddmqaGain(){
...
void dialogsetting_output_150::slot_clickedOutputsubmqaGain(){
    if( mqadBData > -20 )
        mqadBData -= 1;
    lb_text[0]->setText(QString("%1").arg(mqadBData) + tr("           ") + tr("dB"));
    OutputDetailData.insert( "mqaRelplayGain", mqadBData);
...
void dialogsetting_output_150::slot_clickedOutputaddcodecTrim(){
...
void dialogsetting_output_150::slot_clickedOutputsubcodecTrim(){
    if( outputdBData > -20 )
        outputdBData -= 1;
    lb_text[1]->setText(QString("%1").arg(outputdBData) + tr("           ") + tr("dB"));
    OutputDetailData.insert( "codecTrim", outputdBData);
...
QWidget* dialogsetting_output_150::getPlusMinusUIControlOption(QString p_title, int i, int data){
...
void dialogsetting_output_150::dlgOutputOutput(){
...
void dialogsetting_output_150::slot_showDlgOfOutputNotice(){


}


void dialogsetting_output_150::set_settingOfOutputDetail(QJsonObject tmpJson){
        OutputDetailData = tmpJson;
}
QJsonObject dialogsetting_output_150::get_settingOfOutputDetail(){
...
void dialogsetting_output_150::getOutputSettingOfsetting(){
...
void dialogsetting_output_150::getOutputInOutSettingOfsetting(){
...
void dialogsetting_output_150::slot_clickedOutputChangeSet(){
    print_debug();
...
void dialogsetting_output_150::setDialogOutput_show(){
    // QJsonObject *Output_json = get_settingOfOutputDetail();
...
void dialogsetting_output_150::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
...
QWidget* dialogsetting_output_150::getUIControlOption(QString p_title){
...
void dialogsetting_output_150::slot_DRC_question_popup(){
...
void dialogsetting_output_150::slot_CodecTrim_question_popup(){
    dlgOutputCodecTrim();
...
void dialogsetting_output_150::slot_modeOnOff(){
...
void dialogsetting_output_150::dlgOutputDRC(){

}


void dialogsetting_output_150::set_selected_deviceName(QString usbstr){
    selected_deviceName = usbstr;
}
QString dialogsetting_output_150::get_selected_deviceName(){
    return selected_deviceName;
}
void dialogsetting_output_150::setTextName(QString usbstr){
    radio_UsbName->setText(usbstr);
}

void dialogsetting_output_150::setPropertyName(QString usbstr){
    radio_UsbName->setProperty(PROPERTY_NAME_READABLE, usbstr);
}

void dialogsetting_output_150::loding_ani_init(){
...
void dialogsetting_output_150::loding_ani_show(){
...
void dialogsetting_output_150::loding_ani_hide(){
