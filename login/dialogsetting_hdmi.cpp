 ...
 * @param parent
 */
dialogsetting_hdmi::dialogsetting_hdmi(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_hdmi::setInit(){
    this->setModal(true);
 ...
 */
void dialogsetting_hdmi::setUIControl(){
...
void dialogsetting_hdmi::slot_clickedDSDquestion(){//c220511
    print_debug();
    ...
    dlgConfirmHdmi->setTextHeight(180);
...
void dialogsetting_hdmi::slot_clickedPassquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi::slot_clickedbit32question(){//c220511
    print_debug();
...
void dialogsetting_hdmi::slot_clickedRoonquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi::slot_clickedHdmioutputGain(){
    dlgHdmiMqa();
    QTimer::singleShot(500, this, SLOT(slot_showDlgOfHdmiNotice()));
}


void dialogsetting_hdmi::slot_clickedHdmimqaGain(){
    dlgHdmiOutput();
    QTimer::singleShot(500, this, SLOT(slot_showDlgOfHdmiNotice()));
}


void dialogsetting_hdmi::slot_clickedHdmipassGain(){
    dlgHdmiPass();
    QTimer::singleShot(500, this, SLOT(slot_showDlgOfHdmiNotice()));
}


void dialogsetting_hdmi::dlgHdmiMqa(){
...
void dialogsetting_hdmi::dlgHdmiOutput(){
...
void dialogsetting_hdmi::dlgHdmiPass(){
...
void dialogsetting_hdmi::set_settingOfHdmiDetail(QJsonObject tmpJson){
        HdmiDetailData = tmpJson;
}
QJsonObject dialogsetting_hdmi::get_settingOfHdmiDetail(){
        return HdmiDetailData;
}

void dialogsetting_hdmi::slot_changedIndexHdmi(int index){
...
QWidget* dialogsetting_hdmi::getUIControlOption_Pass(QString p_title){
    ...
    connect(btn_onOffHover, SIGNAL(clicked()), this, SLOT(slot_modeOnOff_Pass()));
    return widget_total;

}

QWidget* dialogsetting_hdmi::getUIControlOption_bit32(QString p_title){
...
QWidget* dialogsetting_hdmi::getUIControlOption(QString p_title, int index){//c220511
...
QWidget* dialogsetting_hdmi::getPlusMinusUIControlOption(QString p_title, int i, int data){
...
void dialogsetting_hdmi::slot_clickedHdmiaddmqaGain(){
//btn_gain_add[i]
    print_debug();
    if( mqadBData < 0 )
        mqadBData += 1;
...
void dialogsetting_hdmi::slot_clickedHdmisubmqaGain(){
    print_debug();
    if( mqadBData > -20 ){
        mqadBData -= 1;
    }
...
void dialogsetting_hdmi::slot_clickedHdmiaddoutputGain(){
...
void dialogsetting_hdmi::slot_clickedHdmisuboutputGain(){
    print_debug();
    if( outputdBData > -20 ){
        print_debug();
        outputdBData -= 1;
 ...
 * @return
 */
QWidget* dialogsetting_hdmi::getUIControlOption(QString p_title, QString p_content, int index){
...
void dialogsetting_hdmi::slot_modeOnOff_Pass(){
...
void dialogsetting_hdmi::slot_modeOnOff_32(){
...
void dialogsetting_hdmi::slot_print(){
...
void dialogsetting_hdmi::getHdmiSettingOfsetting(){
...
void dialogsetting_hdmi::getHdmiInOutSettingOfsetting(){
...
void dialogsetting_hdmi::slot_clickedHdmiChangeSet(){
    print_debug();
...
void dialogsetting_hdmi::setDialogHdmi_show(){
   // QJsonObject *Hdmi_json = get_settingOfHdmiDetail();
...
void dialogsetting_hdmi::setDialogHdmi_save(QJsonObject p_jsonObject){
    print_debug();
    QJsonObject tmp_Json;
...
void dialogsetting_hdmi::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
...
void dialogsetting_hdmi::set_selected_deviceName(QString usbstr){
    selected_deviceName = usbstr;
}
QString dialogsetting_hdmi::get_selected_deviceName(){
    return selected_deviceName;
}
void dialogsetting_hdmi::setTextName(QString usbstr){
    radio_UsbName->setText(usbstr);
}

void dialogsetting_hdmi::setPropertyName(QString usbstr){
    radio_UsbName->setProperty(PROPERTY_NAME_READABLE, usbstr);
}

void dialogsetting_hdmi::loding_ani_init(){
...
void dialogsetting_hdmi::loding_ani_show(){
...
void dialogsetting_hdmi::loding_ani_hide(){
