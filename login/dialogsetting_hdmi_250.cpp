...
#include "dialogsetting_hdmi_250.h"
 ...
 * @param parent
 */
dialogsetting_hdmi_250::dialogsetting_hdmi_250(QWidget *parent)
    : QDialog(parent)
{
    setInit();
    setUIControl();
 ...
 */
void dialogsetting_hdmi_250::setInit(){
    this->setModal(true);
 ...
 */
void dialogsetting_hdmi_250::setUIControl(){
...
void dialogsetting_hdmi_250::slot_clickedDSDquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_250::slot_clickedPCMquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_250::slot_clickedPassquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_250::slot_clickedbit32question(){//c220511
    print_debug();
...
void dialogsetting_hdmi_250::slot_clickedRoonquestion(){//c220511
    print_debug();
...
void dialogsetting_hdmi_250::slot_clickedHdmioutputGain(){
...
void dialogsetting_hdmi_250::slot_clickedHdmimqaGain(){
...
void dialogsetting_hdmi_250::slot_clickedHdmipassGain(){
...
void dialogsetting_hdmi_250::dlgHdmiMqa(){
...
void dialogsetting_hdmi_250::dlgHdmiOutput(){
...
void dialogsetting_hdmi_250::dlgHdmiPass(){
...
void dialogsetting_hdmi_250::slot_showDlgOfHdmiNotice(){
...
void dialogsetting_hdmi_250::set_settingOfHdmiDetail(QJsonObject tmpJson){

    this->HdmiDetailData = tmpJson;
}


QJsonObject dialogsetting_hdmi_250::get_settingOfHdmiDetail(){

    return this->HdmiDetailData;
}


void dialogsetting_hdmi_250::slot_changedIndexHdmi(int index){
    print_debug();
...
QWidget* dialogsetting_hdmi_250::getUIControlOption_Pass(QString p_title){
...
QWidget* dialogsetting_hdmi_250::getUIControlOption_bit32(QString p_title){
...
QWidget* dialogsetting_hdmi_250::getUIControlOption(QString p_title){
...
QWidget* dialogsetting_hdmi_250::getPlusMinusUIControlOption(QString p_title, int i, int data){
...
void dialogsetting_hdmi_250::slot_clickedHdmiaddmqaGain(){
...
void dialogsetting_hdmi_250::slot_clickedHdmisubmqaGain(){
    if( mqadBData > -20 )
        mqadBData -= 1;
    this->lb_text[0]->setText(QString("%1").arg(this->mqadBData) + tr("           ") + tr("dB"));
    this->HdmiDetailData.insert( "mqaRelplayGain", this->mqadBData);
...
void dialogsetting_hdmi_250::slot_clickedHdmiaddoutputGain(){

    if( outputdBData < 0 )
        outputdBData += 1;
    else this->btn_gain_add[1]->setCursor(Qt::ArrowCursor);
...
void dialogsetting_hdmi_250::slot_clickedHdmisuboutputGain(){
    if( outputdBData > -20 )
        outputdBData -= 1;
    else this->btn_gain_add[1]->setCursor(Qt::ArrowCursor);
 ...
 * @return
 */
QWidget* dialogsetting_hdmi_250::getUIControlOption(QString p_title, QString p_content, int index){
...
void dialogsetting_hdmi_250::slot_modeOnOff_Pass(){
   ...
   // if(result==QDialog::Accepted){
    ...
    if(ispass) {
        HdmiDetailData.insert("isHdmiPassThrough", true);
        this->onOff_Pass->setValue(true);

    }else{
        HdmiDetailData.insert("isHdmiPassThrough", false);
...
void dialogsetting_hdmi_250::slot_modeOnOff_32(){
...
void dialogsetting_hdmi_250::slot_print(){
...
void dialogsetting_hdmi_250::getHdmiSettingOfsetting(){
...
void dialogsetting_hdmi_250::getHdmiInOutSettingOfsetting(){
...
void dialogsetting_hdmi_250::slot_clickedHdmiChangeSet(){
    print_debug();
...
void dialogsetting_hdmi_250::setDialogHdmi_show(){
    print_debug();
...
void dialogsetting_hdmi_250::setDialogHdmi_save(QJsonObject p_jsonObject){
    QJsonObject tmp_Json;
...
void dialogsetting_hdmi_250::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObject){
...
void dialogsetting_hdmi_250::set_selected_deviceName(QString usbstr){
    this->selected_deviceName = usbstr;
}
QString dialogsetting_hdmi_250::get_selected_deviceName(){
    return this->selected_deviceName;
}
void dialogsetting_hdmi_250::setTextName(QString usbstr){
    this->radio_UsbName->setText(usbstr);
}

void dialogsetting_hdmi_250::setPropertyName(QString usbstr){
    this->radio_UsbName->setProperty(PROPERTY_NAME_READABLE, usbstr);
}
void dialogsetting_hdmi_250::loding_ani_init(){
...
void dialogsetting_hdmi_250::loding_ani_show(){
...
void dialogsetting_hdmi_250::loding_ani_hide(){
