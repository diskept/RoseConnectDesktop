#ifndef MUSICPLAYLISTDETAIL_ROSE_H
#define MUSICPLAYLISTDETAIL_ROSE_H
 ...
 */
class PlaylistDetail_Rose : public roseHome::AbstractRoseHomeSubWidget
{
    Q_OBJECT
public:
    explicit PlaylistDetail_Rose(QWidget *parent = nullptr);
    ~PlaylistDetail_Rose();
...
#endif // MUSICPLAYLISTDETAIL_ROSE_H
