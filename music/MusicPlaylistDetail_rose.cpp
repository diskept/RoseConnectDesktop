...
namespace music {
     ...
     * @param parent
     */
    PlaylistDetail_Rose::PlaylistDetail_Rose(QWidget *parent) : AbstractRoseHomeSubWidget(MainUIType::VerticalScroll_filter, parent) {
     ...
     * @brief 소멸자.
     */
    PlaylistDetail_Rose::~PlaylistDetail_Rose(){
    ...
    /**
     * @brief PlaylistDetail_Rose::setJsonObject_forData
     * @param jsonObj
     */
    void PlaylistDetail_Rose::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(tmp_data_playlist.id != this->data_playlist.id){
            ...
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_tracks, this, &PlaylistDetail_Rose::slot_applyResult_playlist_tracks);
    ...
    /**
     * @brief PlaylistDetail_Rose 선택이 되었을 때, 페이지 활성화를 처리하는 함수임.
     * HTTP API 호출한다.
     */
    void PlaylistDetail_Rose::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(this->playlist_detail_info, &AbstractImageDetailContents_RHV::signal_clicked, this, &PlaylistDetail_Rose::slot_detailInfo_btnClicked);
     ...
     */
    void PlaylistDetail_Rose::proc_wheelEvent_to_getMoreData(){
    ...
    void PlaylistDetail_Rose::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->playlist_track_info[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &PlaylistDetail_Rose::slot_clickedItemTrack_inList);
    ...
    void PlaylistDetail_Rose::request_more_trackData(){
    ...
    void PlaylistDetail_Rose::slot_applyResult_playlist(const roseHome::PlaylistItemData &playlist_data){
     ...
     */
    void PlaylistDetail_Rose::slot_applyResult_playlist_tracks(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void PlaylistDetail_Rose::slot_applyResult_getRating_playlist(const QJsonArray &contents){
    ...
    void PlaylistDetail_Rose::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void PlaylistDetail_Rose::slot_applyResult_getRating_thumbup(const QJsonObject &jsonObj){
     ...
     * @param clickMode
     */
    void PlaylistDetail_Rose::slot_detailInfo_btnClicked(const AbstractImageDetailContents_RHV::BtnClickMode clickMode){
        ...
        if(clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAdd || clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAddx2 ||
            ...
            if(this->flag_check_playlist == false){
                ...
                connect(proc_fav_playlist, &roseHome::ProcCommon::completeReq_rating_playlist, this, &PlaylistDetail_Rose::slot_applyResult_getRating_playlist);
     ...
     * @param clickMode
     */
    void PlaylistDetail_Rose::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &PlaylistDetail_Rose::slot_applyResult_getRating_track);
     ...
     * @param section
     */
    void PlaylistDetail_Rose::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
