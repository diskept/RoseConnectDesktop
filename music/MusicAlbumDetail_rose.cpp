...
namespace music {
     ...
     * @param parent
     */
    AlbumDetail_Rose::AlbumDetail_Rose(QWidget *parent) : roseHome::AbstractRoseHomeSubWidget(MainUIType::VerticalScroll_filter, parent) {
     ...
     * @brief 소멸자.
     */
    AlbumDetail_Rose::~AlbumDetail_Rose(){
    ...
    /**
     * @brief RoseHomeAlbumDetail_Rose::setJsonObject_forData
     * @param jsonObj
     */
    void AlbumDetail_Rose::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void AlbumDetail_Rose::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(this->album_detail_info, &AbstractImageDetailContents_RHV::signal_clicked, this, &AlbumDetail_Rose::slot_detailInfo_btnClicked);
     ...
     */
    void AlbumDetail_Rose::proc_wheelEvent_to_getMoreData(){
    ...
    void AlbumDetail_Rose::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->album_track_info[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &AlbumDetail_Rose::slot_clickedItemTrack_inList);
    ...
    void AlbumDetail_Rose::request_more_trackData(){
        ...
        if((this->track_totalCount > this->list_track->count()) && (this->track_beforeOffset == this->track_currentOffset)){
            ...
            connect(proc_tracks, &roseHome::ProcCommon::completeReq_list_tracks, this, &AlbumDetail_Rose::slot_applyResult_album_tracks);
    ...
    void AlbumDetail_Rose::slot_applyResult_album(const roseHome::AlbumItemData &dataAlbum){
        ...
        playlistObj.insert("image", this->data_album.thumbnail);
        playlistObj.insert("title", this->data_album.title);
        playlistObj.insert("owner", "");
        playlistObj.insert("track_count", this->data_album.totalCount);
        playlistObj.insert("type", this->data_album.type);
        playlistObj.insert("id", this->data_album.id);

        this->album_detail_info->setData_fromRoseData(playlistObj);
     ...
     */
    void AlbumDetail_Rose::slot_applyResult_album_tracks(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void AlbumDetail_Rose::slot_applyResult_getRating_album(const QJsonArray &contents){
    ...
    void AlbumDetail_Rose::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void AlbumDetail_Rose::slot_applyResult_getRating_thumbup(const QJsonObject &jsonObj){
     ...
     * @param clickMode
     */
    void AlbumDetail_Rose::slot_detailInfo_btnClicked(const AbstractImageDetailContents_RHV::BtnClickMode clickMode){
        ...
        if(clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAdd || clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAddx2 ||
            ...
            if(this->flag_check_album == false){
                ...
                connect(proc_fav_album, &roseHome::ProcCommon::completeReq_rating_album, this, &AlbumDetail_Rose::slot_applyResult_getRating_album);
     ...
     * @param clickMode
     */
    void AlbumDetail_Rose::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &AlbumDetail_Rose::slot_applyResult_getRating_track);
     ...
     * @param section
     */
    void AlbumDetail_Rose::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
