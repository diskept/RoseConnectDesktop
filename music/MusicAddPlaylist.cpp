...
namespace music {
    ...
    MusicAddPlaylist::MusicAddPlaylist(QWidget *parent) : roseHome::AbstractRoseHomeSubWidget(VerticalScroll_filter, parent) {

    }


    MusicAddPlaylist::~MusicAddPlaylist(){

        this->deleteLater();
    }


    void MusicAddPlaylist::setJsonObject_forData(const QJsonObject& jsonObj){
        ...
        if(this->streamType == "ROSE"){
            ...
            if(jsonObj.contains("playlistInfo") == false){
                ...
                this->abstractAddPlaylist_RHV = new AbstractAddPlaylist_RHV(AbstractAddPlaylist_RHV::Music, AbstractAddPlaylist_RHV::Creating);
                ...
                if(!tmpclientKey.isEmpty() && (tmpclientKey != this->clientKey)){
                    ...
                    this->abstractAddPlaylist_RHV = new AbstractAddPlaylist_RHV(AbstractAddPlaylist_RHV::Music, AbstractAddPlaylist_RHV::Adding);
                    this->abstractAddPlaylist_RHV->setData_fromJsonObject(jsonObj);
                    this->abstractAddPlaylist_RHV->setActivePage();
    ...
    void MusicAddPlaylist::setUIControl_basic(){
