...
namespace music {
    ...
    */
    ...
    void TrackListAll::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        roseHome::PageInfo_TrackAllView tmpPageInfo = roseHome::ConvertData::convertData_pageInfo_trackAllView(jsonObj);
        this->flagNeedReload = false;

        if(tmpPageInfo.type != data_pageInfo.type || tmpPageInfo.pathTitle != data_pageInfo.pathTitle){
            this->flagNeedReload = true;

            this->data_pageInfo = tmpPageInfo;
            ...
            connect(proc, &roseHome::ProcCommon::completeReq_list_tracks, this, &TrackListAll::slot_applyResult_tracklistCheck);
            proc->request_rose_getList_recentlyTracks(this->data_pageInfo.api_subPath, "MUSIC", 0, 10);
        }
    }
    ...
    void TrackListAll::setUIControl_tracks(){
        ...
        connect(this->btn_mainTitle, &QPushButton::clicked, this, &TrackListAll::slot_btnClicked_Delete);
    ...
    void TrackListAll::request_more_trackData(){
        ...
        if(!this->flagReqMore_track && !this->flag_lastPage_track){
            ...
            proc->request_rose_getList_recentlyTracks(this->data_pageInfo.api_subPath, "MUSIC", this->next_offset, 100);
    ...
    void TrackListAll::slot_applyResult_tracklistCheck(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TrackListAll::slot_btnClicked_Delete(){

        QStringList tmpTitle = this->data_pageInfo.pathTitle.split("(");

        QJsonObject tmpObj;
        tmpObj.insert("contents_type", tmpTitle.at(0));
        tmpObj.insert("list_type", "TRACK");
        tmpObj.insert("api_subPath", this->data_pageInfo.api_subPath);
    ...
    /**
     * @brief TrackListAll::resizeEvent
     * @param event
     */
    void TrackListAll::resizeEvent(QResizeEvent *event){
        Q_UNUSED(event);
    ...
    */
     ...
     * @param parent
     */
    TrackHistoryAll::TrackHistoryAll(QWidget *parent) : AbstractRoseHomeSubWidget(VerticalScroll_rosefilter, parent) {
    ...
    * @brief 소멸자.
    */
    TrackHistoryAll::~TrackHistoryAll(){
     ...
     * @param jsonObj
     */
    void TrackHistoryAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     */
    void TrackHistoryAll::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            width = btn_playAll->sizeHint().width();
            btn_playAll->setGeometry(left, 0, width, 50);
            connect(btn_playAll, &QPushButton::clicked, this, &TrackHistoryAll::slot_btnClicked_playAll);
            ...
            width = btn_shuffleAll->sizeHint().width();
            btn_shuffleAll->setGeometry(left, 0, width, 50);
            connect(btn_shuffleAll, &QPushButton::clicked, this, &TrackHistoryAll::slot_btnClicked_playShuffle);
     ...
     * @brief 기본 UI 구성함
     */
    void TrackHistoryAll::setUIControl_tracks(){
     ...
     * @brief 스크롤링에 대해서, get more data 처리
     */
    void TrackHistoryAll::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void TrackHistoryAll::request_more_trackData(){
        ...
        if(!this->flagReqMore_track && !this->flag_lastPage_track){
            ...
            connect(proc_track, &roseHome::ProcCommon::completeReq_list_tracks, this, &TrackHistoryAll::slot_applyResult_historyTrack);
    ...
    void TrackHistoryAll::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            this->track_listAll[i] = new PlaylistTrackDetailInfo_RHV;
            connect(this->track_listAll[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &TrackHistoryAll::slot_clickedItemTrack_inList);
            this->track_listAll[i]->setProperty("index", i);
     ...
     * @param list_data
     */
    void TrackHistoryAll::slot_applyResult_historyTrack(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void TrackHistoryAll::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void TrackHistoryAll::slot_btnClicked_playAll(){
    ...
    void TrackHistoryAll::slot_btnClicked_playShuffle(){
     ...
     * @param clickMode
     */
    void TrackHistoryAll::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                // request HTTP API - get favorite for Rose Server
                roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &TrackHistoryAll::slot_applyResult_getRating_track);
                proc_fav_track->request_rose_setRating_Track(json, this->flag_track_fav, this->track_star_fav);
     ...
     * @param section
     */
    void TrackHistoryAll::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
