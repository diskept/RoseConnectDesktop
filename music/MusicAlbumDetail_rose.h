#ifndef MUSICALBUMDETAIL_ROSE_H
#define MUSICALBUMDETAIL_ROSE_H
...
namespace music {
     ...
     */
    class AlbumDetail_Rose : public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit AlbumDetail_Rose(QWidget *parent = nullptr);
        ~AlbumDetail_Rose();
