...
namespace music {
     ...
     * @param parent
     */
    MusicFavorite::MusicFavorite(QWidget *parent) : AbstractRoseHomeSubWidget(VerticalScroll_rosefilter, parent) {
    ...
    */
    ...
    void MusicFavorite::setJsonObject_forData(const QJsonObject &jsonObj){
    ...
    void MusicFavorite::setActivePage(){
     ...
     */
    void MusicFavorite::setUIControl_chooseFilter(){
    ...
    void MusicFavorite::setUIControl_chooseFilter_fromData(){
    ...
    void MusicFavorite::setUIControl_chooseStep(QString type){
    ...
    void MusicFavorite::request_more_Data(QString type){
    ...
    void MusicFavorite::proc_wheelEvent_to_getMoreData(){
    ...
    void MusicFavorite::slot_changedSubTabUI(const QJsonObject &p_data){

        Q_UNUSED(p_data);
    }


    void MusicFavorite::slot_changedSubTabUI(){
    ...
    void MusicFavorite::slot_clickBtn_Filter(){
    ...
    void MusicFavorite::slot_clickBtn_Filter_close(){

        this->widget_filter->setVisible(false);
    }


    void MusicFavorite::slot_clickBtn_chooseDetailMedia(){
    ...
    void MusicFavorite::slot_applyResult_favoriteTracks(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            for(int i = start_index; i < max_cnt; i++){
                ...
                connect(this->favorite_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &MusicFavorite::slot_clickedItemTrack_inList);
    ...
    void MusicFavorite::slot_applyResult_favoriteAlbums(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            for(int i = start_index; i < max_cnt; i++){
                ...
                connect(this->favorite_album[i], &roseHome::ItemAlbum_rosehome::signal_clicked, this, &MusicFavorite::slot_clickedItemAlbum);
            }
    ...
    void MusicFavorite::slot_applyResult_favoritePlaylists(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            for(int i = start_index; i < max_cnt; i++){
                ...
                connect(this->favorite_playlist[i], &roseHome::ItemAlbum_rosehome::signal_clicked, this, &MusicFavorite::slot_clickedItemPlaylist);
            }
    ...
    void MusicFavorite::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void MusicFavorite::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            if(this->flag_check_track == false){
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &MusicFavorite::slot_applyResult_getRating_track);
    ...
    void MusicFavorite::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
    ...
    void MusicFavorite::slot_clickedItemPlaylist(const tidal::AbstractItem::ClickMode clickMode){
        ...
        if(section == SECTION_FOR_MORE_POPUP___FavoritePLAYLIST){
            ...
            if(clickMode == tidal::AbstractItem::ClickMode::MoreBtn){
                // OptMorePopup 띄우기
                this->makeObj_optMorePopup(OptMorePopup::Rosehome_Playlist, roseHome::ConvertData::getConvertOptHeaderData(data_playlist), index, SECTION_FOR_MORE_POPUP___FavoritePLAYLIST, true);
            }
            else if(clickMode == tidal::AbstractItem::ClickMode::PlayBtn){
                // Playlist 바로 재생
                roseHome::ProcRosePlay_withRosehome *procRosePlay = new roseHome::ProcRosePlay_withRosehome(this);
    ...
    void MusicFavorite::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
