#ifndef MUSICRECENTLYLISTDELETE_H
#define MUSICRECENTLYLISTDELETE_H
...
namespace music {
     ...
     */
    class MusicRecentlyListDelete: public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit MusicRecentlyListDelete(QWidget *parent = nullptr);
        ~MusicRecentlyListDelete();
...
#endif // MUSICRECENTLYLISTDELETE_H
