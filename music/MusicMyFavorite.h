#ifndef MUSICMYFAVORITE_H
#define MUSICMYFAVORITE_H
...
namespace music {
    ...
    class MusicFavorite : public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:

        explicit MusicFavorite(QWidget *parent = nullptr);
        ~MusicFavorite();
