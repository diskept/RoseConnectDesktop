...
namespace roseHome {
     ...
     * @param parent
     */
    RoseHomePlaylistDetail_Rose::RoseHomePlaylistDetail_Rose(QWidget *parent) : AbstractRoseHomeSubWidget(MainUIType::VerticalScroll_filter, parent) {
     ...
     * @brief 소멸자.
     */
    RoseHomePlaylistDetail_Rose::~RoseHomePlaylistDetail_Rose(){
    ...
    /**
     * @brief RoseHomePlaylistDetail_Rose::setJsonObject_forData
     * @param jsonObj
     */
    void RoseHomePlaylistDetail_Rose::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(tmp_data_playlist.id != this->data_playlist.id){
            ...
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_tracks, this, &RoseHomePlaylistDetail_Rose::slot_applyResult_playlist_tracks);
     ...
     * HTTP API 호출한다.
     */
    void RoseHomePlaylistDetail_Rose::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(this->playlist_detail_info, &AbstractImageDetailContents_RHV::signal_clicked, this, &RoseHomePlaylistDetail_Rose::slot_detailInfo_btnClicked);
     ...
     */
    void RoseHomePlaylistDetail_Rose::proc_wheelEvent_to_getMoreData(){
    ...
    void RoseHomePlaylistDetail_Rose::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->playlist_track_info[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &RoseHomePlaylistDetail_Rose::slot_clickedItemTrack_inList);
    ...
    void RoseHomePlaylistDetail_Rose::request_more_trackData(){
    ...
    void RoseHomePlaylistDetail_Rose::slot_applyResult_playlist(const roseHome::PlaylistItemData &playlist_data){
     ...
     */
    void RoseHomePlaylistDetail_Rose::slot_applyResult_playlist_tracks(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseHomePlaylistDetail_Rose::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void RoseHomePlaylistDetail_Rose::slot_applyResult_getRating_thumbup(const QJsonObject &jsonObj){
     ...
     * @param clickMode
     */
    void RoseHomePlaylistDetail_Rose::slot_detailInfo_btnClicked(const AbstractImageDetailContents_RHV::BtnClickMode clickMode){
print_debug();
        if(clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAdd || clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAddx2 ||
            ...
            if(this->flag_check_playlist == false){
                ...
                connect(proc_fav_playlist, &roseHome::ProcCommon::completeReq_rating_playlist, this, &RoseHomePlaylistDetail_Rose::slot_applyResult_getRating_playlist);
     ...
     * @param clickMode
     */
    void RoseHomePlaylistDetail_Rose::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
