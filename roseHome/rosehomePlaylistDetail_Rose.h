#ifndef ROSEHOMEPLAYLISTDETAIL_ROSE_H
#define ROSEHOMEPLAYLISTDETAIL_ROSE_H
...
namespace roseHome {
     ...
     */
    class RoseHomePlaylistDetail_Rose : public AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RoseHomePlaylistDetail_Rose(QWidget *parent = nullptr);
        ~RoseHomePlaylistDetail_Rose();
...
#endif // ROSEHOMEPLAYLISTDETAIL_ROSE_H
