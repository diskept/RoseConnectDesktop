#ifndef ROSEHOMEHISTORYDETAIL_H
#define ROSEHOMEHISTORYDETAIL_H
...
namespace roseHome {
     ...
     */
    class RoseHomeHisotryDetail : public AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RoseHomeHisotryDetail(QWidget *parent = nullptr);
        ~RoseHomeHisotryDetail();
