...
namespace roseHome {
    ...
    /**
     * @brief RoseHomeHisotryListAll::RoseHomeHisotryListAll
     * @param parent
     */
    RoseHomeHisotryListAll::RoseHomeHisotryListAll(QWidget *parent) : AbstractRoseHomeSubWidget(MainUIType::VerticalScroll_roseviewAll, parent) {
     ...
     * @brief 소멸자.
     */
    RoseHomeHisotryListAll::~RoseHomeHisotryListAll(){
     ...
     * @param jsonObj
     */
    void RoseHomeHisotryListAll::setJsonObject_forData(const QJsonObject &jsonObj){

        PageInfo_HistoryAllView tmp_pageInfo = ConvertData::convertData_pageInfo_historyAllView(jsonObj);
     ...
     * HTTP API 호출한다.
     */
    void RoseHomeHisotryListAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void RoseHomeHisotryListAll::setUIControl_history(){
     ...
     * @param list_data
     */
    void RoseHomeHisotryListAll::slot_applyResult_history(const QList<roseHome::HistoryItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            if(start_index == 0){
                ...
                for(int i = start_index; i < max_cnt; i++){
                    this->listHistory_all[i] = new roseHome::ItemHistory_rosehome(0, SECTION_FOR_MORE_POPUP___history, tidal::AbstractItem::ImageSizeMode::Square_200x200, false);
                ...
                for(int i = start_index; i < max_cnt; i++){
                    connect(this->listHistory_all[i], &roseHome::ItemHistory_rosehome::signal_clicked, this, &RoseHomeHisotryListAll::slot_clickedItemAlbum);
     ...
     * @param clickMode
     */
    void RoseHomeHisotryListAll::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param event
     */
    void RoseHomeHisotryListAll::resizeEvent(QResizeEvent *event){//c230223
