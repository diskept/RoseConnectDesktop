#ifndef ROSEHOMERECENTLYLISTDELETE_H
#define ROSEHOMERECENTLYLISTDELETE_H
...
namespace roseHome {
     ...
     */
    class RoseHomeRecentlyListDelete: public AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RoseHomeRecentlyListDelete(QWidget *parent = nullptr);
        ~RoseHomeRecentlyListDelete();
...
#endif // ROSEHOMERECENTLYLISTDELETE_H
