...
namespace roseHome {
     ...
     * @param parent
     */
    RoseHomeHisotryDetail::RoseHomeHisotryDetail(QWidget *parent) : AbstractRoseHomeSubWidget(VerticalScroll_rosefilter, parent) {
     ...
     * @brief 소멸자.
     */
    RoseHomeHisotryDetail::~RoseHomeHisotryDetail(){

        this->deleteLater();
    }


    void RoseHomeHisotryDetail::setJsonObject_forData(const QJsonObject& jsonObj){

        roseHome::HistoryItemData tmphistory = ConvertData::converData_historyItemData(jsonObj);
    ...
    void RoseHomeHisotryDetail::setActivePage(){
        ...
        if(this->flagNeedReload == true){
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_playlist[i], &roseHome::ItemPlaylist_rosehome::signal_clicked, this, &RoseHomeHisotryDetail::slot_clickedItemPlaylist);
            }
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_album[i], &roseHome::ItemAlbum_rosehome::signal_clicked, this, &RoseHomeHisotryDetail::slot_clickedItemAlbum);
            }

            for (int i = 0; i < 5; i++) {
                this->home_history_track[i] = new PlaylistTrackDetailInfo_RHV;
                connect(this->home_history_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &RoseHomeHisotryDetail::slot_clickedItemTrack_inList);
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_artist[i], &roseHome::ItemArtist_rosehome::signal_clicked, this, &RoseHomeHisotryDetail::slot_clickedItemArtist);
            }

            roseHome::ProcCommon *proc_playlist = new roseHome::ProcCommon(this);
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_playlists, this, &RoseHomeHisotryDetail::slot_applyResult_historyPlaylist);
            ...
            connect(proc_album, &roseHome::ProcCommon::completeReq_list_albums, this, &RoseHomeHisotryDetail::slot_applyResult_historyAlbum);
            ...
            connect(proc_track, &roseHome::ProcCommon::completeReq_list_tracks, this, &RoseHomeHisotryDetail::slot_applyResult_historyTrack);
            ...
            connect(proc_artist, &roseHome::ProcCommon::completeReq_list_artists, this, &RoseHomeHisotryDetail::slot_applyResult_historyArtist);
            proc_artist->request_rose_getList_historyArtists(this->historyData.yearMonth, this->historyData.filter_type, 0, 10);
        }
    }


    QWidget* RoseHomeHisotryDetail::setUIControl_subTitle_withSideBtn(const QString subTitle, const QString btnText, const int btnId, QLayout *p_layout){
    ...
    void RoseHomeHisotryDetail::setUIControl_appendWidget_hitsory(){
    ...
    void RoseHomeHisotryDetail::slot_applyResult_historyPlaylist(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseHomeHisotryDetail::slot_applyResult_historyAlbum(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseHomeHisotryDetail::slot_applyResult_historyTrack(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseHomeHisotryDetail::slot_applyResult_historyArtist(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseHomeHisotryDetail::slot_bugs_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
    ...
    void RoseHomeHisotryDetail::slot_tidal_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        ...
        if(p_jsonObj.contains("flagOk") && ProcJsonEasy::get_flagOk(p_jsonObj)){
            ...
            if(this->flag_send_track == true){
                ...
                if(status == true && this->flag_track_fav == false){
                    ...
                    connect(proc, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &RoseHomeHisotryDetail::slot_tidal_completeReq_listAll_myFavoritesIds);
    ...
    void RoseHomeHisotryDetail::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void RoseHomeHisotryDetail::slot_clickBtn_subTitle_viewAll(){
    ...
    /**
         ...
         * @param clickMode
         */
    void RoseHomeHisotryDetail::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
    ...
    /**
         ...
         * @param clickMode
         */
    void RoseHomeHisotryDetail::slot_clickedItemPlaylist(const tidal::AbstractItem::ClickMode clickMode){
    ...
    /**
         ...
         * @param clickMode
         */
    void RoseHomeHisotryDetail::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                QString type = this->list_historyTrack->at(idx).type;
                ...
                if(this->track_star_fav == 0 || this->track_star_fav == 1){
                    if(type == "BUGS"){
                        ...
                        connect(proc, &bugs::ProcBugsAPI::completeReq_favarite_track, this, &RoseHomeHisotryDetail::slot_bugs_completeReq_listAll_myFavoritesIds);

                        if(this->track_star_fav == 0){
                            itemPosData.likes_yn = false;

                            proc->request_bugs_deleteFavorite_track(this->list_historyTrack->at(idx).clientKey.toInt(), bugs::ConvertData_forBugs::getObjectJson_itemPositionData(itemPosData));
                        }
                        else if(this->track_star_fav == 1){
                            itemPosData.likes_yn = true;

                            proc->request_bugs_addFavorite_track(this->list_historyTrack->at(idx).clientKey.toInt(), bugs::ConvertData_forBugs::getObjectJson_itemPositionData(itemPosData));
                        }
                        ...
                        connect(proc, &qobuz::ProcCommon::completeReq_listAll_myFavoritesIds, this, &RoseHomeHisotryDetail::slot_bugs_completeReq_listAll_myFavoritesIds);
                        ...
                        connect(proc_fav, &tidal::ProcCommon::completeReq_listAll_myFavoritesIds, this, &RoseHomeHisotryDetail::slot_tidal_completeReq_listAll_myFavoritesIds);
                ...
                connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &RoseHomeHisotryDetail::slot_applyResult_getRating_track);
    ...
    /**
         ...
         * @param clickMode
         */
    void RoseHomeHisotryDetail::slot_clickedItemArtist(const tidal::AbstractItem::ClickMode clickMode){
        ...
        if(section == SECTION_FOR_MORE_POPUP___HistoryArtist){
            if(this->list_historyArtist->at(index).type == "APPLE_MUSIC"){
    ...
    /**
         ...
         * @param section
         */
    void RoseHomeHisotryDetail::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
