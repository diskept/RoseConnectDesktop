...
namespace roseHome {
     ...
     * @param parent
     */
    RoseHomeRecentlyListDelete::RoseHomeRecentlyListDelete(QWidget *parent) : AbstractRoseHomeSubWidget(VerticalScroll_rosefilter, parent) {
    ...
    * @brief 소멸자.
    */
    RoseHomeRecentlyListDelete::~RoseHomeRecentlyListDelete(){
     ...
     * @param jsonObj
     */
    void RoseHomeRecentlyListDelete::setJsonObject_forData(const QJsonObject &jsonObj){
    ...
    /**
     * @brief RoseHomeRecentlyListDelete::setActivePage
     */
    void RoseHomeRecentlyListDelete::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void RoseHomeRecentlyListDelete::setUIControl_lists(){
        ...
        connect(this->btn_deleteAll, &QPushButton::clicked, this, &RoseHomeRecentlyListDelete::slot_clicked_DeleteAll);
        ...
        connect(this->btn_delete, &QPushButton::clicked, this, &RoseHomeRecentlyListDelete::slot_clicked_Delete);
        ...
        connect(this->btn_selectAll, &QPushButton::clicked, this, &RoseHomeRecentlyListDelete::slot_clicked_btnSelectAll);
        ...
        connect(this->checkbox_selectAll, &QCheckBox::stateChanged, this, &RoseHomeRecentlyListDelete::slot_clickedSelected);
     ...
     */
    void RoseHomeRecentlyListDelete::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void RoseHomeRecentlyListDelete::request_more_listData(){
        ...
        if(!this->flagReqMore_data && !this->flag_lastPage_data){
            ...
            if(this->list_type == "ALBUM"){
                ...
                connect(proc, &roseHome::ProcCommon::completeReq_list_albums, this, &RoseHomeRecentlyListDelete::slot_applyResult_albumlists);
                ...
                connect(proc_recently, &roseHome::ProcCommon::completeReq_list_playlists, this, &RoseHomeRecentlyListDelete::slot_applyResult_playlistLists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_rosetubes, this, &RoseHomeRecentlyListDelete::slot_applyResult_rosetubelists);
                proc->request_rose_getList_recentlyRosetube("member/track/recent", "YOUTUBE", this->next_offset, 50);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_tracks, this, &RoseHomeRecentlyListDelete::slot_applyResult_tracklists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_artists, this, &RoseHomeRecentlyListDelete::slot_applyResult_artistlists);
    ...
    void RoseHomeRecentlyListDelete::request_more_listDraw(){
    ...
    void RoseHomeRecentlyListDelete::setDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
        ...
        *pixmap_icon = pixmap_icon->scaled(40, 40, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
        ...
        lb_title->setGeometry(180, 10, 720, 49);
        ...
        lb_resolution->setGeometry(900, 10, 20, 49);
        lb_resolution->hide();
        ...
        if(this->list_type == "ALBUM"){
            ...
            if(album_title_width > 300){
                ...
                if(tmpAlbum_width > 300){
                    lb_album->setText(GSCommon::getTextCutFromLabelWidth(artist, album_title_width, lb_album->font()));
                    if(lb_album->text().contains("…")){
                        lb_album->setToolTip(artist);
                        lb_album->setToolTipDuration(2000);
                    }
                }
                else{
                    lb_album->setText(artist);
                }
                lb_album->setGeometry(997, 14, 300, 40);
            }
            else{
                lb_album->setText(artist);
                lb_album->setGeometry(997, 24, 300, 20);
            }
        }
        else if(this->list_type == "TRACK"){
            ...
            if(explicit_flag == true){
                ...
                if(hires == true){
                    ...
                    if(type == "TIDAL"){
                        ...
                        left = lb_title->geometry().left() + title_width_resize + 15;
                        ...
                        if(sampling > 0){
                            ...
                            left = lb_title->geometry().left() + lb_title->sizeHint().width() + 15 + 20 + 15;
            ...
            lb_title->setText(GSCommon::getTextCutFromLabelWidth(artist, 720, lb_title->font()));
            if(lb_title->text().contains("…")){
                lb_title->setToolTip(artist);
                lb_title->setToolTipDuration(2000);
            }
            lb_title->setGeometry(180, 10, 720, 49);
        }
     ...
     * @param list_data
     */
    void RoseHomeRecentlyListDelete::slot_applyResult_albumlists(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseHomeRecentlyListDelete::slot_applyResult_playlistLists(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseHomeRecentlyListDelete::slot_applyResult_rosetubelists(const QJsonArray &jsonArr_dataToPlay, const int &totalCnt, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseHomeRecentlyListDelete::slot_applyResult_tracklists(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void RoseHomeRecentlyListDelete::slot_applyResult_artistlists(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void RoseHomeRecentlyListDelete::slot_thumbnailDownload_list(){
    ...
    void RoseHomeRecentlyListDelete::slot_clickedSelected(int state){
    ...
    void RoseHomeRecentlyListDelete::slot_clicked_btnSelectAll(){
    ...
    void RoseHomeRecentlyListDelete::slot_clicked_Delete(){
        ...
        if(this->selectIds.count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "album", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "playlist", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "track", "YOUTUBE", "Ids", this->selectIds);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "track", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "artist", "", "Ids", this->selectIds);
            }
        }
    }


    void RoseHomeRecentlyListDelete::slot_clicked_DeleteAll(){
        ...
        if(this->listWidget_recentlyList->count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "album", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "playlist", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "track", "YOUTUBE", "All", this->selectIds);
            }
            else if(this->list_type == "TRACK"){
                QString filter_change = "";
                if(this->filter_type == "YOUTUBE"){
                    filter_change = "";
                }
                else{
                    filter_change = this->filter_type;
                }

                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "track", filter_change, "All", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("ROSEHOME", "artist", this->filter_type, "All", this->selectIds);
            }
        }
    }


    bool RoseHomeRecentlyListDelete::selectDelete_DialogConfirm(const QString type){
    ...
    void RoseHomeRecentlyListDelete::slot_applyResult_getDeleteList(const bool flag){
    ...
    /**
     * @brief RoseHomeRecentlyListDelete::resizeEvent
     * @param event
     */
    void RoseHomeRecentlyListDelete::resizeEvent(QResizeEvent *event){
        Q_UNUSED(event);
