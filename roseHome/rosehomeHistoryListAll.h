#ifndef ROSEHOMEHISTORYLISTALL_H
#define ROSEHOMEHISTORYLISTALL_H
...
namespace roseHome {
     ...
     */
    class RoseHomeHisotryListAll : public AbstractRoseHomeSubWidget
    {
        Q_OBJECT
    public:
        explicit RoseHomeHisotryListAll(QWidget *parent = nullptr);
        ~RoseHomeHisotryListAll();
    ...
    private:
        ...
        PageInfo_HistoryAllView data_pageInfo;

        int history_widget_width = 0;
        int history_widget_margin = 0;
    };
};
#endif // ROSEHOMEHISTORYLISTALL_H
