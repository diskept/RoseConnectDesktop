#ifndef BUGSHISTORYLISTALL_H
#define BUGSHISTORYLISTALL_H
...
namespace bugs {
     ...
     */
    class BugsHistoryListAll : public AbstractBugsSubWidget
    {
        Q_OBJECT
    public:
        explicit BugsHistoryListAll(QWidget *parent = nullptr);
        ~BugsHistoryListAll();
