...
namespace bugs {
     ...
     * @param parent
     */
    BugsHistoryDetail::BugsHistoryDetail(QWidget *parent) : AbstractBugsSubWidget(VerticalScroll_rosefilter, parent) {
     ...
     * @brief 소멸자.
     */
    BugsHistoryDetail::~BugsHistoryDetail(){

        this->deleteLater();
    }


    void BugsHistoryDetail::setJsonObject_forData(const QJsonObject& jsonObj){
    ...
    void BugsHistoryDetail::setActivePage(){
        ...
        if(this->flagNeedReload == true){
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_playlist[i], &roseHome::ItemPlaylist_rosehome::signal_clicked, this, &BugsHistoryDetail::slot_clickedItemPlaylist);
            }
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_album[i], &roseHome::ItemAlbum_rosehome::signal_clicked, this, &BugsHistoryDetail::slot_clickedItemAlbum);
            }

            for (int i = 0; i < 5; i++) {
                this->home_history_track[i] = new PlaylistTrackDetailInfo_RHV;
                connect(this->home_history_track[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &BugsHistoryDetail::slot_clickedItemTrack_inList);
            ...
            for(int i = 0; i < 15; i++){
                ...
                connect(this->home_history_artist[i], &roseHome::ItemArtist_rosehome::signal_clicked, this, &BugsHistoryDetail::slot_clickedItemArtist);
            }

            roseHome::ProcCommon *proc_playlist = new roseHome::ProcCommon(this);
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_playlists, this, &BugsHistoryDetail::slot_applyResult_historyPlaylist);
            ...
            connect(proc_album, &roseHome::ProcCommon::completeReq_list_albums, this, &BugsHistoryDetail::slot_applyResult_historyAlbum);
            ...
            connect(proc_track, &roseHome::ProcCommon::completeReq_list_tracks, this, &BugsHistoryDetail::slot_applyResult_historyTrack);
            ...
            connect(proc_artist, &roseHome::ProcCommon::completeReq_list_artists, this, &BugsHistoryDetail::slot_applyResult_historyArtist);
            proc_artist->request_rose_getList_historyArtists(this->historyData.yearMonth, this->historyData.filter_type, 0, 10);
        }
    }


    QWidget* BugsHistoryDetail::setUIControl_subTitle_withSideBtn(const QString subTitle, const QString btnText, const int btnId, QLayout *p_layout){
    ...
    void BugsHistoryDetail::setUIControl_appendWidget_hitsory(){
    ...
    void BugsHistoryDetail::slot_applyResult_historyPlaylist(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void BugsHistoryDetail::slot_applyResult_historyAlbum(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void BugsHistoryDetail::slot_applyResult_historyTrack(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void BugsHistoryDetail::slot_applyResult_historyArtist(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void BugsHistoryDetail::slot_bugs_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
    ...
    void BugsHistoryDetail::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void BugsHistoryDetail::slot_clickBtn_subTitle_viewAll(){
        ...
        if(btnId == BTN_IDX_SUBTITLE_HistoryPlaylist){
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_BUGS___HISTORY_PLAYLIST_VIEW);
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_BUGS___HISTORY_ALBUM_VIEW);
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_BUGS___HISTORY_TRACK_VIEW);
            ...
            tmp_data.insert(KEY_PAGE_CODE, PAGECODE_BUGS___HISTORY_ARTIST_VIEW);
    ...
    /**
         ...
         * @param clickMode
         */
    void BugsHistoryDetail::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
    ...
    /**
         ...
         * @param clickMode
         */
    void BugsHistoryDetail::slot_clickedItemPlaylist(const tidal::AbstractItem::ClickMode clickMode){
        ...
        if(section == SECTION_FOR_MORE_POPUP___HistoryPlaylist){
            ...
            if(clickMode == tidal::AbstractItem::ClickMode::PlayBtn){
                if(this->list_historyPlaylist->at(index).type == "BUGS" && this->list_historyPlaylist->at(index).isRose == false){
                    // PD Album 바로 재생
                    bugs::ProcRoseAPI_withBugs *procRosePlay = new bugs::ProcRoseAPI_withBugs(this);
                    procRosePlay->requestPlayRose_byPD_AlbumID(this->list_historyPlaylist->at(index).clientKey.toInt(), OptMorePopup::ClickMode::Play_RightNow);
                }
                else{
    ...
    /**
         ...
         * @param clickMode
         */
    void BugsHistoryDetail::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
        ...
        if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::FavBtn){
            ...
            if(this->flag_check_track == false){
                ...
                if(this->track_star_fav == 0 || this->track_star_fav == 1){
                    ...
                    itemPosData.data_id = QString("%1").arg(this->list_historyTrack->at(idx).id);

                    ProcBugsAPI *proc = new ProcBugsAPI(this);
                    connect(proc, &bugs::ProcBugsAPI::completeReq_favarite_track, this, &BugsHistoryDetail::slot_bugs_completeReq_listAll_myFavoritesIds);

                    if(this->track_star_fav == 0){
                        itemPosData.likes_yn = false;

                        proc->request_bugs_deleteFavorite_track(this->list_historyTrack->at(idx).clientKey.toInt(), ConvertData_forBugs::getObjectJson_itemPositionData(itemPosData));
                    }
                    else if(this->track_star_fav == 1){
                        itemPosData.likes_yn = true;

                        proc->request_bugs_addFavorite_track(this->list_historyTrack->at(idx).clientKey.toInt(), ConvertData_forBugs::getObjectJson_itemPositionData(itemPosData));
                    }
                ...
                connect(proc_favCheck_track, &roseHome::ProcCommon::completeReq_rating_track, this, &BugsHistoryDetail::slot_applyResult_getRating_track);
            ...
            if(clickMode == PlaylistTrackDetailInfo_RHV::ClickMode::AllBox){
                ...
                roseHome::ProcRosePlay_withRosehome *procRosePlay = new roseHome::ProcRosePlay_withRosehome(this);
                procRosePlay->requestPlayRose_byTracks(this->list_historyTrack->at(idx), this->jsonArr_tracks_toPlay, idx, playType);
            }
                ...
                // OptMorePopup 띄우기 필요
                this->makeObj_optMorePopup(OptMorePopup::Rosehome_Track, roseHome::ConvertData::getConvertOptHeaderData(data), idx, SECTION_FOR_MORE_POPUP___HistoryTrack);
            }
        }
    }
    ...
    /**
         ...
         * @param clickMode
         */
    void BugsHistoryDetail::slot_clickedItemArtist(const tidal::AbstractItem::ClickMode clickMode){
        ...
        if(section == SECTION_FOR_MORE_POPUP___HistoryArtist){
            ...
            if(clickMode == tidal::AbstractItem::ClickMode::AllBox){
                ...
                jsonObj_move.insert("artist_nm", this->list_historyArtist->at(index).name);
                jsonObj_move.insert("artist_id", this->list_historyArtist->at(index).clientKey.toInt());
    ...
    /**
         ...
         * @param section
         */
    void BugsHistoryDetail::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
        ...
        if(section == SECTION_FOR_MORE_POPUP___HistoryPlaylist){
            ...
            )
            {
                if(this->list_historyPlaylist->at(index).type == "BUGS" && this->list_historyPlaylist->at(index).isRose == false){
                    bugs::ProcRoseAPI_withBugs *procRosePlay = new bugs::ProcRoseAPI_withBugs(this);
                    procRosePlay->requestPlayRose_byPD_AlbumID(this->list_historyPlaylist->at(index).clientKey.toInt(), clickMode);
                }
                else{
                    roseHome::ProcRosePlay_withRosehome *procRosePlay = new roseHome::ProcRosePlay_withRosehome(this);
                ...
                data.insert("playlist_id", this->list_historyPlaylist->at(index).id);
