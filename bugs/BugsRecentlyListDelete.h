#ifndef BUGSRECENTLYLISTDELETE_H
#define BUGSRECENTLYLISTDELETE_H
...
namespace bugs {
     ...
     */
    class BugsRecentlyListDelete: public AbstractBugsSubWidget
    {
        Q_OBJECT
    public:
        explicit BugsRecentlyListDelete(QWidget *parent = nullptr);
        ~BugsRecentlyListDelete();
...
#endif // BUGSRECENTLYLISTDELETE_H
