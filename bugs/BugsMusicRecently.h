#ifndef BUGSMUSICRECENTLY_H
#define BUGSMUSICRECENTLY_H
...
namespace bugs {
    ...
    /**
     * @brief  벅스 > Home > 최신음악에 대한 클래스
     */
    class BugsMusicRecently : public AbstractBugsSubWidget
    {
        Q_OBJECT
    public:
        explicit BugsMusicRecently(QWidget *parent = nullptr);
