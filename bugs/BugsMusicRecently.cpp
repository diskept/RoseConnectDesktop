...
namespace bugs {
     ...
     * @param parent
     */
    BugsMusicRecently::BugsMusicRecently(QWidget *parent) : AbstractBugsSubWidget(NoneScroll, parent) {
     ...
     */
    void BugsMusicRecently::setActivePage(){
     ...
     */
    void BugsMusicRecently::applyLoginSuccessState(){
...
//                this->chose_filterCode_track = this->selected_filterCode;
//                this->chose_filterCode_album = this->selected_filterCode;
//                this->chose_filterCode_video = this->selected_filterCode;

//                // 0번째 track 으로 화면을 체우기 위함
...
//                this->scrollArea_main->verticalScrollBar()->setValue(0);
     ...
     * @brief 데이터 , UI 초기화
     */
    void BugsMusicRecently::initAll(){
     ...
     */
    void BugsMusicRecently::setUIControl_logined(){

        // Title 영역 ------------------------------------------ START
        this->addUIControl_mainTitle("New Music");
        ...
        connect(this->chooseFilterOpt, &BugsChooseFilterOpt::signal_clicked_filterOpt, this, &BugsMusicRecently::slot_chooseFilterOption);
        this->chooseFilterOpt->hideFilterBox();
     ...
     */
    void BugsMusicRecently::setUIControl_filterAndTab(){

        // 필터링 부분
        this->filterWidget = new FilterWidget();
        this->filterWidget->add_filter("all", "전체 장르");
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &BugsMusicRecently::slot_filterClicked);
        ...
        connect(this->segmentTabWidget, &SegmentTabWidget::signal_clicked, this, &BugsMusicRecently::slot_segmentTag_clicked);
    ...
    /**
     * @brief BugsMusicRecently::setUIControl_body_Track
     */
    void BugsMusicRecently::setUIControl_body_Track(){
        ...
        connect(delegate, &BugsTrackDelegate::clicked, this, &BugsMusicRecently::slot_clickedItemTrack_inList);
    ...
    /**
     * @brief BugsMusicRecently::setUIControl_body_Album
     */
    void BugsMusicRecently::setUIControl_body_Album(){
    ...
    /**
     * @brief BugsMusicRecently::setUIControl_body_Video
     */
    void BugsMusicRecently::setUIControl_body_Video(){
     ...
     * @param event
     */
    void BugsMusicRecently::resizeEvent(QResizeEvent *event){
     ...
     * @param page
     */
    void BugsMusicRecently::request_more_trackData(){
        if(!this->flagReqMore_track && !this->flag_lastPage_track){
            ...
            QString api_subPath = ConvertGenreCode_BugsAPI::convert_api_subPath_musicRecently(ConvertGenreCode_BugsAPI::ContentType::track, this->selected_filterCode);
            ...
            connect(proc_track, &ProcBugsAPI::completeReq_list_tracks, this, &BugsMusicRecently::slot_applyResult_tracks);
     ...
     */
    void BugsMusicRecently::request_more_albumData(){
        if(!this->flagReqMore_album && !this->flag_lastPage_album){
            ...
            // genre code 에 따라서 Bugs API path 정보 필요함
            QString api_subPath = ConvertGenreCode_BugsAPI::convert_api_subPath_musicRecently(ConvertGenreCode_BugsAPI::ContentType::album, this->selected_filterCode);
            ...
            connect(proc_album, &ProcBugsAPI::completeReq_list_albums, this, &BugsMusicRecently::slot_applyResult_albums);
     ...
     */
    void BugsMusicRecently::request_more_videoData(){
        if(!this->flagReqMore_video && !this->flag_lastPage_video){
            ...
            // genre code 에 따라서 Bugs API path 정보 필요함
            QString api_subPath = ConvertGenreCode_BugsAPI::convert_api_subPath_musicRecently(ConvertGenreCode_BugsAPI::ContentType::mv, this->selected_filterCode);
            ...
            connect(proc_video, &ProcBugsAPI::completeReq_list_videos, this, &BugsMusicRecently::slot_applyResult_videos);
     ...
     */
    void BugsMusicRecently::proc_wheelEvent_to_getMoreData(){
     ...
     */
    void BugsMusicRecently::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void BugsMusicRecently::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
     ...
     * @param clickedIndex
     */
    void BugsMusicRecently::slot_segmentTag_clicked(int clickedIndex){
     ...
     * @brief "전체재생"  버튼 클릭
     */
    void BugsMusicRecently::slot_btnClicked_playAll(){
        if(this->selected_tabIndex == 0){
     ...
     * @brief "셔플재생" 버튼 클릭
     */
    void BugsMusicRecently::slot_btnClicked_playShuffle(){
        if(this->selected_tabIndex == 0){
     ...
     * @param jsonObj_track
     */
    void BugsMusicRecently::slot_applyResult_tracks(const QList<bugs::TrackItemData>& list_data, const QJsonArray& jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void BugsMusicRecently::slot_applyResult_albums(const QList<bugs::AlbumItemData>& list_data, const bool flag_lastPage){
     ...
     */
    void BugsMusicRecently::slot_applyResult_videos(const QList<bugs::VideoItemData>& list_data, const QJsonArray& jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     */
    void BugsMusicRecently::slot_thumbnailDownloaded_fotListWidget_delegate(){
     ...
     * @param clickMode
     */
    void BugsMusicRecently::slot_clickedItemTrack_inList(const int idx, const tidal::AbstractTidalTrackDelegate::ClickMode clickMode){
     ...
     */
    void BugsMusicRecently::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param clickMode
     */
    void BugsMusicRecently::slot_clickedItemVideo(const tidal::AbstractItem::ClickMode clickMode){
        int index = ((tidal::AbstractItem*)sender())->index();
        int section = ((tidal::AbstractItem*)sender())->section();
    ...
    /**
     * @brief BugsMusicRecently::proc_preUpdate_favorite_track
     * @param data_itemPos
     */
    void BugsMusicRecently::proc_preUpdate_favorite_track(const ItemPositionData& data_itemPos){
     ...
     * @param data_itemPos
     */
    void BugsMusicRecently::proc_preUpdate_favorite_album(const ItemPositionData& data_itemPos){
     ...
     * @param section
     */
    void BugsMusicRecently::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
