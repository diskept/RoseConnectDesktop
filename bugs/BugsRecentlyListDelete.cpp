...
namespace bugs {
     ...
     * @param parent
     */
    BugsRecentlyListDelete::BugsRecentlyListDelete(QWidget *parent) : AbstractBugsSubWidget(VerticalScroll_rosefilter, parent) {
    ...
    * @brief 소멸자.
    */
    BugsRecentlyListDelete::~BugsRecentlyListDelete(){
     ...
     * @param jsonObj
     */
    void BugsRecentlyListDelete::setJsonObject_forData(const QJsonObject &jsonObj){
    ...
    /**
     * @brief BugsRecentlyListDelete::setActivePage
     */
    void BugsRecentlyListDelete::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void BugsRecentlyListDelete::setUIControl_lists(){
        ...
        connect(this->btn_deleteAll, &QPushButton::clicked, this, &BugsRecentlyListDelete::slot_clicked_DeleteAll);
        ...
        connect(this->btn_delete, &QPushButton::clicked, this, &BugsRecentlyListDelete::slot_clicked_Delete);
        ...
        connect(this->btn_selectAll, &QPushButton::clicked, this, &BugsRecentlyListDelete::slot_clicked_btnSelectAll);
        ...
        connect(this->checkbox_selectAll, &QCheckBox::stateChanged, this, &BugsRecentlyListDelete::slot_clickedSelected);
     ...
     */
    void BugsRecentlyListDelete::proc_wheelEvent_to_getMoreData(){
     ...
     * @param page
     */
    void BugsRecentlyListDelete::request_more_listData(){
        ...
        if(!this->flagReqMore_data && !this->flag_lastPage_data){
            ...
            if(this->list_type == "ALBUM"){
                ...
                connect(proc, &roseHome::ProcCommon::completeReq_list_albums, this, &BugsRecentlyListDelete::slot_applyResult_albumlists);
                ...
                connect(proc_recently, &roseHome::ProcCommon::completeReq_list_playlists, this, &BugsRecentlyListDelete::slot_applyResult_playlistLists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_rosetubes, this, &BugsRecentlyListDelete::slot_applyResult_rosetubelists);
                proc->request_rose_getList_recentlyRosetube("member/track/recent", "YOUTUBE", this->next_offset, 50);
            }
            else if(this->list_type == "TRACK"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_tracks, this, &BugsRecentlyListDelete::slot_applyResult_tracklists);
                ...
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeReq_list_artists, this, &BugsRecentlyListDelete::slot_applyResult_artistlists);
    ...
    void BugsRecentlyListDelete::request_more_listDraw(){
    ...
    inline void BugsRecentlyListDelete::iniDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
    ...
    inline void BugsRecentlyListDelete::setDataInfo_RoseList_Item(const QJsonObject &trackInfo, const int &p_index){
     ...
     * @param list_data
     */
    void BugsRecentlyListDelete::slot_applyResult_albumlists(const QList<roseHome::AlbumItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void BugsRecentlyListDelete::slot_applyResult_playlistLists(const QList<roseHome::PlaylistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void BugsRecentlyListDelete::slot_applyResult_rosetubelists(const QJsonArray &jsonArr_dataToPlay, const int &totalCnt, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void BugsRecentlyListDelete::slot_applyResult_tracklists(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
     ...
     * @param list_data
     */
    void BugsRecentlyListDelete::slot_applyResult_artistlists(const QList<roseHome::ArtistItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void BugsRecentlyListDelete::slot_thumbnailDownload_list(){
    ...
    void BugsRecentlyListDelete::slot_clickedSelected(int state){
    ...
    void BugsRecentlyListDelete::slot_clicked_btnSelectAll(){
    ...
    void BugsRecentlyListDelete::slot_clicked_Delete(){
        ...
        if(this->selectIds.count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "album", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "playlist", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "track", "", "Ids", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "artist", "", "Ids", this->selectIds);
            }
        }
    }


    void BugsRecentlyListDelete::slot_clicked_DeleteAll(){
        ...
        if(this->listWidget_recentlyList->count() == 0){
            ...
            if(this->list_type == "ALBUM"){
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "album", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "PLAYLIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "playlist", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "YOUTUBE"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                ...
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "track", this->filter_type, "All", this->selectIds);
            }
            else if(this->list_type == "ARTIST"){
                // request HTTP API
                roseHome::ProcCommon *proc = new roseHome::ProcCommon(this);
                connect(proc, &roseHome::ProcCommon::completeDel_recently_list, this, &BugsRecentlyListDelete::slot_applyResult_getDeleteList);
                proc->request_rose_recently_delete("BUGS", "artist", this->filter_type, "All", this->selectIds);
            }
        }
    }


    bool BugsRecentlyListDelete::selectDelete_DialogConfirm(const QString type){
    ...
    void BugsRecentlyListDelete::slot_applyResult_getDeleteList(const bool flag){
    ...
    /**
     * @brief BugsRecentlyListDelete::resizeEvent
     * @param event
     */
    void BugsRecentlyListDelete::resizeEvent(QResizeEvent *event){
        Q_UNUSED(event);
