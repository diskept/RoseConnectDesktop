#include "ItemImage_PDAlbum_bugs.h"
...
namespace bugs {
     ...
     */
    ItemImage_PDAlbum_bugs::ItemImage_PDAlbum_bugs(int imageSize, QWidget *parent)
     ...
     * @return
     */
    QString ItemImage_PDAlbum_bugs::getImagePath_default(){
