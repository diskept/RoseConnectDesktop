#include "ItemImage_TrackSquare.h"
...
namespace bugs {
     ...
     */
    ItemImage_TrackSquare::ItemImage_TrackSquare(int imageSize, QWidget *parent)
     ...
     * @return
     */
    QString ItemImage_TrackSquare::getImagePath_default(){
