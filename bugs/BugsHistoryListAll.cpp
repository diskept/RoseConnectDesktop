...
namespace bugs {
    ...
    /**
     * @brief BugsHistoryListAll::BugsHistoryListAll
     * @param parent
     */
    BugsHistoryListAll::BugsHistoryListAll(QWidget *parent) : AbstractBugsSubWidget(MainUIType::VerticalScroll_roseviewAll, parent) {
     ...
     * @brief 소멸자.
     */
    BugsHistoryListAll::~BugsHistoryListAll(){
     ...
     * @param jsonObj
     */
    void BugsHistoryListAll::setJsonObject_forData(const QJsonObject &jsonObj){
     ...
     * HTTP API 호출한다.
     */
    void BugsHistoryListAll::setActivePage(){
     ...
     * @brief 기본 UI 구성함
     */
    void BugsHistoryListAll::setUIControl_history(){
     ...
     * @param list_data
     */
    void BugsHistoryListAll::slot_applyResult_history(const QList<roseHome::HistoryItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            ...
            if(start_index == 0){
                ...
                for(int i = start_index; i < max_cnt; i++){
                    connect(this->listHistory_all[i], &roseHome::ItemHistory_rosehome::signal_clicked, this, &BugsHistoryListAll::slot_clickedItemAlbum);
     ...
     * @param clickMode
     */
    void BugsHistoryListAll::slot_clickedItemAlbum(const tidal::AbstractItem::ClickMode clickMode){
     ...
     * @param event
     */
    void BugsHistoryListAll::resizeEvent(QResizeEvent *event){//c230223
