...
namespace bugs {
     ...
     * @param parent
     */
    BugsPlaylistDetail::BugsPlaylistDetail(QWidget *parent) : AbstractBugsSubWidget(MainUIType::VerticalScroll_filter, parent) {
     ...
     * @brief 소멸자.
     */
    BugsPlaylistDetail::~BugsPlaylistDetail(){
    ...
    /**
     * @brief BugsPlaylistDetail::setJsonObject_forData
     * @param jsonObj
     */
    void BugsPlaylistDetail::setJsonObject_forData(const QJsonObject &jsonObj){
        ...
        if(tmp_data_playlist.id != this->data_playlist.id){
            ...
            connect(proc_playlist, &roseHome::ProcCommon::completeReq_list_tracks, this, &BugsPlaylistDetail::slot_applyResult_playlist_tracks);
    ...
    /**
     * @brief BugsPlaylistDetail 선택이 되었을 때, 페이지 활성화를 처리하는 함수임.
     * HTTP API 호출한다.
     */
    void BugsPlaylistDetail::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(this->playlist_detail_info, &AbstractImageDetailContents_RHV::signal_clicked, this, &BugsPlaylistDetail::slot_detailInfo_btnClicked);
     ...
     */
    void BugsPlaylistDetail::proc_wheelEvent_to_getMoreData(){
    ...
    void BugsPlaylistDetail::request_more_trackDraw(){
        ...
        for(int i = start_index; i < this->track_drawCount; i++){
            ...
            connect(this->playlist_track_info[i], &PlaylistTrackDetailInfo_RHV::clicked, this, &BugsPlaylistDetail::slot_clickedItemTrack_inList);
    ...
    void BugsPlaylistDetail::request_more_trackData(){
    ...
    void BugsPlaylistDetail::slot_applyResult_playlist(const roseHome::PlaylistItemData &playlist_data){
    ...
    //c220818 share link
    void BugsPlaylistDetail::slot_applyResult_getShareLink(const QString &link){
     ...
     */
    void BugsPlaylistDetail::slot_applyResult_playlist_tracks(const QList<roseHome::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
    ...
    void BugsPlaylistDetail::slot_applyResult_getRating_playlist(const QJsonArray &contents){
    ...
    void BugsPlaylistDetail::slot_applyResult_getRating_thumbup(const QJsonObject &jsonObj){
     ...
     * @param clickMode
     */
    void BugsPlaylistDetail::slot_detailInfo_btnClicked(const AbstractImageDetailContents_RHV::BtnClickMode clickMode){
        ...
        if(clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAdd || clickMode == AbstractImageDetailContents_RHV::BtnClickMode::Favorite_toAddx2 ||
            ...
            if(this->flag_check_playlist == false){
                ...
                connect(proc_fav_playlist, &roseHome::ProcCommon::completeReq_rating_playlist, this, &BugsPlaylistDetail::slot_applyResult_getRating_playlist);
     ...
     * @param clickMode
     */
    void BugsPlaylistDetail::slot_clickedItemTrack_inList(const int idx, const PlaylistTrackDetailInfo_RHV::ClickMode clickMode){
     ...
     * @param section
     */
    void BugsPlaylistDetail::slot_optMorePopup_menuClicked(const OptMorePopup::ClickMode clickMode, const int index, const int section){
