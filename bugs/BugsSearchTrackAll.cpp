...
const int GET_ITEM_SIZE___ONCE = 100;
     ...
     * @param parent
     */
    BugsSearchTrackAll::BugsSearchTrackAll(QWidget *parent) : AbstractBugsSubWidget(MainUIType::VerticalScroll_rosefilter, parent) {
        // data
     ...
     * @brief 소멸자.
     */
    BugsSearchTrackAll::~BugsSearchTrackAll(){
    ...
    void BugsSearchTrackAll::setJsonObject_forData(const QJsonObject &jsonObj){
        common::SearchData data_param = common::ConvertData_common::convertData_searchData(jsonObj);
        QString tmp_search_word = this->search_word;
        QString tmp_search_keyword = this->search_keyword;

        this->flagNeedReload = false;

        if((tmp_search_word != data_param.search_word) || (tmp_search_keyword != data_param.search_keyword)){
            ...
            this->search_word = data_param.search_word;
            this->search_keyword = data_param.search_keyword;

            this->label_mainTitle->setText(QString("'%1' ").arg(this->search_word) + "검색 결과 - 곡");
     ...
     * HTTP API 호출한다.
    */
    void BugsSearchTrackAll::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            connect(btn_playAll, &QPushButton::clicked, this, &BugsSearchTrackAll::slot_btnClicked_playAll);
            ...
            connect(btn_shuffleAll, &QPushButton::clicked, this, &BugsSearchTrackAll::slot_btnClicked_playShuffle);
     ...
     * @brief 기본 UI 구성함
     */
    void BugsSearchTrackAll::setUIControl_tracks(){
        ...
        connect(this->chooseFilterOpt, &bugs::BugsChooseFilterOpt::signal_clicked_filterOpt, this, &BugsSearchTrackAll::slot_chooseFilterOption);
        this->chooseFilterOpt->hideFilterBox();
    }
     ...
     */
    void BugsSearchTrackAll::setUiControl_filter(){
        ...
        QString def_name = this->list_filterOpt_sort.first().opt_name;
        this->filterWidget->add_filter(def_code, def_name);
        connect(this->filterWidget, &FilterWidget::signal_clickedFilter, this, &BugsSearchTrackAll::slot_filterClicked);
     ...
     * @brief 데이터 , UI 초기화
     */
    void BugsSearchTrackAll::initAll(){
     ...
     * @param event
     */
    void BugsSearchTrackAll::resizeEvent(QResizeEvent *event){
     ...
     */
    void BugsSearchTrackAll::slot_filterClicked(){
     ...
     * @param selectedCode
     */
    void BugsSearchTrackAll::slot_chooseFilterOption(QVariant selected_filterCode, QString selected_filterName){
    ...
    void BugsSearchTrackAll::request_more_trackData(){
        if(!this->flagReqMore_track && !this->flag_lastPage_track){
            ...
            proc->request_bugs_search_track(this->search_word, page_reqNext, GET_ITEM_SIZE___ONCE, ProcBugsAPI::BugsSearch_Sort::exact);
            proc->setProperty("search_keyword", this->search_keyword);
        }
    }



    void BugsSearchTrackAll::request_more_trackDraw(){
        ...
        connect(proc_fav_track, &roseHome::ProcCommon::completeReq_rating_track, this, &BugsSearchTrackAll::slot_applyResult_getRating_track);
    ...
    void BugsSearchTrackAll::slot_applyResult_tracks(const QList<bugs::TrackItemData> &list_data, const QJsonArray &jsonArr_dataToPlay, const bool flag_lastPage){
        ...
        if(list_data.size() > 0){
            QString search_keyword = sender()->property("search_keyword").toString();

            if(search_keyword != this->search_keyword){
                return;
            }
    ...
    inline void BugsSearchTrackAll::iniDataInfo_RoseList_Item(const bugs::TrackItemData &data_track, const int &p_index){
        ...
        connect(btn_video_list, &QPushButton::clicked, this, &BugsSearchTrackAll::slot_clicked_btnVideolist);
        ...
        connect(this->btn_list_fav[p_index], &QPushButton::clicked, this, &BugsSearchTrackAll::slot_clicked_btnFavorite);
        ...
        connect(btn_menu, &QPushButton::clicked, this, &BugsSearchTrackAll::slot_clicked_btnMenu);
    ...
    void BugsSearchTrackAll::setDataInfo_RoseList_Item(const bugs::TrackItemData &data_track, const int &p_index){
    ...
    void BugsSearchTrackAll::slot_listwidgetItemPressed(QListWidgetItem *item){
    ...
    void BugsSearchTrackAll::slot_clicked_btnVideolist(){
    ...
    void BugsSearchTrackAll::slot_clicked_btnFavorite(){
        ...
        if(this->flag_check_track == false){
            ...
            if(this->track_star_fav[idx] == 0 || this->track_star_fav[idx] == 1){
                ...
                ProcBugsAPI *proc = new ProcBugsAPI(this);
                connect(proc, &bugs::ProcBugsAPI::completeReq_favarite_track, this, &BugsSearchTrackAll::slot_bugs_completeReq_listAll_myFavoritesIds);
            ...
            connect(proc_favCheck_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &BugsSearchTrackAll::slot_applyResult_checkRating_track);
    ...
    void BugsSearchTrackAll::slot_clicked_btnMenu(){
    ...
    void BugsSearchTrackAll::slot_thumbnailDownload_list(){
    ...
    void BugsSearchTrackAll::slot_bugs_completeReq_listAll_myFavoritesIds(const QJsonObject& p_jsonObj){
        // Favorite 정보를 전달해줌.
    ...
    void BugsSearchTrackAll::slot_applyResult_checkRating_track(const QJsonObject &jsonObj){
        ...
        if(jsonObj.contains("id")){
            ...
            if(id > 0){
                ...
                // request HTTP API - get favorite for Rose Server
                roseHome::ProcCommon *proc_fav_track = new roseHome::ProcCommon(this);
                connect(proc_fav_track, &roseHome::ProcCommon::completeCheck_rating_track, this, &BugsSearchTrackAll::slot_applyResult_addRating_track);
    ...
    void BugsSearchTrackAll::slot_applyResult_getRating_track(const QJsonArray &contents){
    ...
    void BugsSearchTrackAll::slot_applyResult_addRating_track(const QJsonObject &jsonObj){
    ...
    void BugsSearchTrackAll::slot_btnClicked_playShuffle(){
