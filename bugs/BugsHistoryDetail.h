#ifndef BUGSHISTORYDETAIL_H
#define BUGSHISTORYDETAIL_H
...
namespace bugs {
     ...
     */
    class BugsHistoryDetail : public AbstractBugsSubWidget
    {
        Q_OBJECT
    public:
        explicit BugsHistoryDetail(QWidget *parent = nullptr);
        ~BugsHistoryDetail();
