...
namespace roseRadio {
    ...
    RoseRadioGenreViewAll::RoseRadioGenreViewAll(QWidget *parent) : roseHome::AbstractRoseHomeSubWidget(MainUIType::VerticalScroll_viewAll, parent) {

        this->setUIControl_RoseRadio();
    }


    RoseRadioGenreViewAll::~RoseRadioGenreViewAll(){

        this->deleteLater();
    }


    void RoseRadioGenreViewAll::setJsonObject_forData(const QJsonObject& jsonObj){
    ...
    void RoseRadioGenreViewAll::setActivePage(){
        ...
        if(this->flagNeedReload){
            ...
            this->widget_roseRadio->setContentsMargins(0, 35, 0, 0);
    ...
    void RoseRadioGenreViewAll::setUIControl_RoseRadio(){
    ...
    void RoseRadioGenreViewAll::proc_wheelEvent_to_getMoreData(){
    ...
    void RoseRadioGenreViewAll::request_more_roseData(){
    ...
    void RoseRadioGenreViewAll::request_more_roseDraw(){
        ...
        for(int i = start_index; i < this->roseRadio_draw_cnt; i++){
            this->viewAll_roseRadio[i] = new roseRadio::ItemRectangle(i, SECTION_FOR_MORE_POPUP___GENRE, tidal::AbstractItem::ImageSizeMode::Ractangle_480x120);
            connect(this->viewAll_roseRadio[i], &roseRadio::ItemRectangle::rectangle_clicked, this, &RoseRadioGenreViewAll::slot_clickedItemRoseRadio);
        }
    ...
    void RoseRadioGenreViewAll::slot_responseHttp(const int &p_id, const QJsonObject &p_jsonObj){
    ...
    void RoseRadioGenreViewAll::slot_applyResult_Channel(const QJsonArray &jsonArr, const int totalCount, const bool flag_lastPage){
    ...
    void RoseRadioGenreViewAll::slot_applyResult_Favorite_state(const QJsonObject &jsonObj){
    ...
    void RoseRadioGenreViewAll::slot_clickedItemRoseRadio(const int section, const int index, const roseRadio::ItemImageRoseRadio::ClickMode_RoseRadio clickMode){
        ...
        if(section == SECTION_FOR_MORE_POPUP___GENRE){
            ...
            if(clickMode == roseRadio::ItemImageRoseRadio::ClickMode_RoseRadio::AllBox || clickMode == roseRadio::ItemImageRoseRadio::ClickMode_RoseRadio::PlayBtn){
                ...
                connect(proc_fav, &roseHome::ProcCommon::completeReq_favorite_radio, this, &RoseRadioGenreViewAll::slot_applyResult_Favorite_state);
