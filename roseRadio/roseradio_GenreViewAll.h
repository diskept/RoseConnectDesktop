#ifndef ROSERADIO_GENREVIEWALL_H
#define ROSERADIO_GENREVIEWALL_H
...
namespace roseRadio {
    ...
    class RoseRadioGenreViewAll : public roseHome::AbstractRoseHomeSubWidget
    {
        Q_OBJECT

    public:
        explicit RoseRadioGenreViewAll(QWidget * parent = nullptr);
        ~RoseRadioGenreViewAll();
...
#endif // ROSERADIO_GENREVIEWALL_H
